...
description: Fragment zur Erkennung von Barcodes.
type: docs
weight: 14
url: /de/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment zur Erkennung von Barcodes. Dieses Fragment kann in einer benutzerdefinierten Activity oder in einem FragmentContainerView platziert werden und wird zum Scannen und Erkennen von Barcodes verwendet.

Beispiel

Beispiel für Fragment-Layout

Java-Code

// Initialisierung von BarcodeScannerFragment // Es kann mittels Ressourcen-Datei oder programmgesteuert erfolgen/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Anbinden von BarcodeScannerFragment an benutzerdefiniertes Layout // Es wird die Größe des übergeordneten Containers übernehmen requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings Präferenzen sollten nach dem Anbinden von BarcodeScannerFragment an die übergeordnete Aktivität initialisiert werden. // BarcodeScannerFragmentPreferencesHandler wird nach der Methode BarcodeScannerFragment.onCreate() aufgerufen barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | Beschreibung |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Standardkonstruktor |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Setzt den BarcodeScannerFragmentPreferencesHandler, der nach der Methode BarcodeScannerFragment.onViewCreated() aufgerufen werden kann |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Intern? Ist die Schaltfläche zum Anzeigen von Einstellungen für BarcodeScanner immer false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Setzt eine benutzerdefinierte Implementierung von PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Setzt die Schaltfläche zum Anzeigen von Einstellungen, für BarcodeScanner immer false |
...
Setzt den BarcodeScannerFragmentPreferencesHandler, der nach der Methode BarcodeScannerFragment.onViewCreated() aufgerufen werden kann
...
TODO Intern? Ist die Schaltfläche zum Anzeigen von Einstellungen für BarcodeScanner immer false
...
Setzt eine benutzerdefinierte Implementierung von PreferencesFragment.

**Parameters:**
| Parameter | Type | Beschreibung |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Kann vor dem Start des Erkennungsprozesses in BarcodeScannerFragment aufgerufen werden. |
...
### setShowPreferencesButton(boolean showPreferencesButton) {#setShowPreferencesButton-boolean-}
```
public void setShowPreferencesButton(boolean showPreferencesButton)
```


Setzt die Schaltfläche zum Anzeigen von Einstellungen, für BarcodeScanner immer false
