...
description: Stellt den Bildhintergrund dar, der von der Kamera erhalten wird und während des Erkennungsprozesses gerendert wird.
type: docs
weight: 24
url: /de/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentcameraphotobackground/
---
**Inheritance:**
...
Stellt den Bildhintergrund dar, der von der Kamera erhalten wird und während des Erkennungsprozesses gerendert wird.
## Constructors
...
| Parameter | Type | Beschreibung |
| --- | --- | --- |
| Farbfilter | android.graphics.LightingColorFilter |  |
