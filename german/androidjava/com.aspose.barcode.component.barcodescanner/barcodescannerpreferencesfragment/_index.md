...
description: PreferencesFragment kann zur Anpassung des Barcode‑Erkennungsprozesses mit einer benutzerdefinierten GUI verwendet werden.
type: docs
weight: 17
url: /de/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment kann verwendet werden, um den Barcode-Erkennungsprozess mit einer benutzerdefinierten GUI anzupassen. PreferencesFragment kann als benutzerdefinierte Klasse implementiert werden und kann an BarcodeScannerFragment angehängt werden, indem die Methode BarcodeRecognitionSettings.setPreferencesFragment() verwendet wird.
## Constructors
