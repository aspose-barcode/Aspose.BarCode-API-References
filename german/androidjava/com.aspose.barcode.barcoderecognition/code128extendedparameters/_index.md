...
description: Speichert spezielle Daten des erkannten Code128‑Strichcodes
type: docs
weight: 28
url: /de/androidjava/com.aspose.barcode.barcoderecognition/code128extendedparameters/
---
**Inheritance:**
...
Speichert spezielle Daten des erkannten Code128‑Strichcodes
...
| Method | Beschreibung |
| --- | --- |
| [equals(Object obj)](#equals-java.lang.Object-) | Gibt einen Wert zurück, der angibt, ob diese Instanz einem angegebenen Code128ExtendedParameters‑Wert entspricht. |
| [getClass()](#getClass--) |  |
| [getCode128DataPortions()](#getCode128DataPortions--) | Liefert das Code128DataPortion‑Array der erkannten Code128‑Barcodes. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) | Gibt eine menschenlesbare Zeichenkettenrepräsentation dieses Code128ExtendedParameters zurück. |
| [wait()](#wait--) |  |
...
Gibt einen Wert zurück, der angibt, ob diese Instanz einem angegebenen Code128ExtendedParameters‑Wert entspricht.
...
Liefert das Code128DataPortion‑Array der erkannten Code128‑Barcodes.

Wert: Array des Code128DataPortion.
...
Gibt eine menschenlesbare Zeichenkettenrepräsentation dieses Code128ExtendedParameters zurück.

**Returns:**
java.lang.String - Eine Zeichenkette, die dieses  Code128ExtendedParameters  darstellt.
### wait() {#wait--}
```
