...
type: docs
weight: 52
url: /de/androidjava/com.aspose.barcode.barcoderecognition/checksumvalidation/
---
**Inheritance:**
...
Aktiviert die Prüfsummenvalidierung während der Erkennung für 1D‑ und Post‑Barcodes.
...
Prüfsumme wird nie verwendet: Codabar, PatchCode, Pharmacode, DataLogic2of5

Prüfsumme ist möglich: Code39 Standard/Extended, Standard2of5, Interleaved2of5, ItalianPost25, Matrix2of5, MSI, ItalianPost25, DeutschePostIdentcode, DeutschePostLeitcode, VIN
...
| Feld | Beschreibung |
| --- | --- |
| [DEFAULT](#DEFAULT) | Wenn die Prüfsumme laut Spezifikation erforderlich ist – sie wird validiert. |
| [OFF](#OFF) | Prüfsumme nicht validieren. |
| [ON](#ON) | Prüfsumme immer validieren, wenn möglich. |
## Methods
...
Wenn die Prüfsumme laut Spezifikation erforderlich ist – sie wird validiert.
...
Prüfsumme immer validieren, wenn möglich.
