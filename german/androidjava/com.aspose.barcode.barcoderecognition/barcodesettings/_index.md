...
description: Die wichtigsten BarCode-Dekodierungsparameter.
type: docs
weight: 20
url: /de/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | Aktiviert die Prüfsummenvalidierung während der Erkennung für 1D‑ und Post‑Barcodes. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | Aktiviert die Prüfsummenvalidierung während der Erkennung für 1D‑ und Post‑Barcodes. |
...
| Parameter | Type | Beschreibung |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | Aktiviert die Prüfsummenvalidierung während der Erkennung für 1D‑ und Post‑Barcodes. |
...
| Parameter | Type | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
