...
description: Gibt das Start- oder Stoppsymbol der Codabar-Barcode-Spezifikation an.
type: docs
weight: 23
url: /de/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
Gibt das Start- oder Stoppsymbol der Codabar-Barcode-Spezifikation an.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [A](#A) | Gibt das Zeichen A als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an. |
| [B](#B) | Gibt das Zeichen B als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an. |
| [C](#C) | Gibt das Zeichen C als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an. |
| [D](#D) | Gibt das Zeichen D als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an. |
...
Gibt das Zeichen A als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an.
...
Gibt das Zeichen B als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an.
...
Gibt das Zeichen C als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an.
...
Gibt das Zeichen D als Start‑ oder Stoppsymbol der Codabar‑Barcode‑Spezifikation an.
