...
description: Fragmen untuk pengenalan barcode.
type: docs
weight: 14
url: /id/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment untuk pengenalan kode batang. Fragment ini dapat ditempatkan di dalam Activity khusus atau di dalam FragmentContainerView dan digunakan untuk pemindaian serta pengenalan Barcodes.

Contoh

Contoh tata letak fragment

Kode Java

// Inisialisasi BarcodeScannerFragment // Dapat dibuat menggunakan file sumber daya atau secara programatik/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Menyematkan BarcodeScannerFragment ke tata letak khusus // Ini akan mengambil ukuran kontainer induk requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings preferensi harus diinisialisasi setelah menyematkan BarcodeScannerFragment ke aktivitas induk. // BarcodeScannerFragmentPreferencesHandler akan dipanggil setelah metode BarcodeScannerFragment.onCreate() barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | Deskripsi |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Konstruktor default |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Menetapkan BarcodeScannerFragmentPreferencesHandler yang dapat dipanggil setelah metode BarcodeScannerFragment.onViewCreated() |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Internal? Tombol tampilkan preferensi, untuk BarcodeScanner selalu false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Menetapkan implementasi khusus dari PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Menetapkan tombol tampilkan preferensi, untuk BarcodeScanner selalu false |
...
Menetapkan BarcodeScannerFragmentPreferencesHandler yang dapat dipanggil setelah metode BarcodeScannerFragment.onViewCreated()
...
TODO Internal? Tombol tampilkan preferensi, untuk BarcodeScanner selalu false
...
Menetapkan implementasi khusus dari PreferencesFragment.

**Parameters:**
| Parameter | Type | Deskripsi |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Dapat dipanggil sebelum memulai proses pengenalan di BarcodeScannerFragment. |
...
Menetapkan tombol tampilkan preferensi, untuk BarcodeScanner selalu false
