...
description: BarcodeScanner berisi fungsionalitas terkait pengenalan barcode dari kamera perangkat Android.
type: docs
weight: 12
url: /id/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanner/
---
**Inheritance:**
java.lang.Object
```
...
BarcodeScanner berisi fungsionalitas terkait pengenalan barcode dari kamera perangkat Android.
...
| --- | --- |
| [BarcodeScanner(ComponentActivity parentActivity)](#BarcodeScanner-androidx.activity.ComponentActivity-) | Menginisialisasi sebuah instance baru dari kelas BarcodeScanner. |
## Methods
...
| [hashCode()](#hashCode--) |  |
| [launchBarcodeScanner(BarcodeRecognitionResultsHandlerParcelable barcodeRecognitionResultsHandler)](#launchBarcodeScanner-com.aspose.barcode.component.barcodescanner.BarcodeRecognitionResultsHandlerParcelable-) | Luncurkan tampilan kamera dan kelola proses pengenalan |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setOnBarcodeScannerCompletedCallback(OnBarcodeScannerCompletedCallback onBarcodeScannerCompletedCallback)](#setOnBarcodeScannerCompletedCallback-com.aspose.barcode.component.barcodescanner.OnBarcodeScannerCompletedCallback-) | Listener selesai pengenalan |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Menginisialisasi sebuah instance baru dari kelas BarcodeScanner.

**Parameters:**
| Parameter | Type | Deskripsi |
| --- | --- | --- |
| parentActivity | androidx.activity.ComponentActivity | aktivitas yang memanggil BarcodeScanner. Harus diinisialisasi sebelum tampilan aktivitas induk dibuat |
...
**Returns:**
com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferences - preferensi pemindai kode batang
### hashCode() {#hashCode--}
```
...
Luncurkan tampilan kamera dan kelola proses pengenalan

**Parameters:**
| Parameter | Type | Deskripsi |
| --- | --- | --- |
| barcodeRecognitionResultsHandler | com.aspose.barcode.component.barcodescanner.BarcodeRecognitionResultsHandlerParcelable | Instansi khusus dari kelas abstrak OnScannerRecognitionFinishedListener yang memproses hasil pengenalan |
