...
description: Interfaz pública para la decodificación del Campo de Información del Cliente que se utiliza en la simbología AustraliaPost.
type: docs
weight: 50
url: /es/androidjava/com.aspose.barcode.barcoderecognition/australiapostcustomerinformationdecoder/
---```
