...
description: Define un formato particular para el texto que incluye atributos de tamaño y estilo de la fuente donde el tamaño está en la propiedad Unit value.
type: docs
weight: 44
url: /es/androidjava/com.aspose.barcode.generation/fontunit/
---
**Inheritance:**
java.lang.Object
```
...
Define un formato particular para el texto, incluyendo la familia de fuentes, el tamaño y los atributos de estilo donde el tamaño está en la propiedad Unit value.
...
| [getClass()](#getClass--) |  |
| [getFamilyName()](#getFamilyName--) | Obtiene el nombre de la fuente de este Font. |
| [getSize()](#getSize--) | Obtiene el tamaño de este FontUnit en Unit value. |
| [getStateHash()](#getStateHash--) |  |
| [getStyle()](#getStyle--) | Obtiene la información de estilo para este FontUnit. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setFamilyName(Typeface value)](#setFamilyName-android.graphics.Typeface-) | Establece el nombre de la fuente de este Font. |
| [setStyle(int value)](#setStyle-int-) | Establece la información de estilo para este FontUnit. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Obtiene el nombre de la fuente de este Font.
...
Obtiene el tamaño de este FontUnit en Unit value.
...
Obtiene la información de estilo para este FontUnit.
...
Establece el nombre de la fuente de este Font.

**Parameters:**
| Parameter | Type | Descripción |
| --- | --- | --- |
| valor | android.graphics.Typeface |  |
...
Establece la información de estilo para este FontUnit.
