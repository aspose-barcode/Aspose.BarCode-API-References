...
description: Modo de compactación de códigos de barras Pdf417
type: docs
weight: 98
url: /es/androidjava/com.aspose.barcode.generation/pdf417compactionmode/
---
**Inheritance:**
...
Modo de compresión del código de barras Pdf417
## Campos

| Campo | Descripción |
| --- | --- |
| [AUTO](#AUTO) | modo de detección automática de compactación |
| [BINARY](#BINARY) | modo de compactación binaria |
| [NUMERIC](#NUMERIC) | modo de compactación numérica |
| [TEXT](#TEXT) | compactación de texto |
## Methods
...
modo de detección automática de compactación
