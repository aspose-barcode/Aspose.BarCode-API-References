...
description: Generador de codetext extendido para códigos de barras MaxiCode en modo ExtendedCodetext de MaxiCodeEncodeMode. Use la propiedad TwoDDisplayText de BarcodeGenerator para establecer el texto visible eliminando caracteres de gestión.
type: docs
weight: 55
url: /es/androidjava/com.aspose.barcode.generation/maxicodeextcodetextbuilder/
---
**Inheritance:**
...
Generador de texto extendido para códigos de barras MaxiCode en el modo ExtendedCodetext de MaxiCodeEncodeMode. Use la propiedad TwoDDisplayText de BarcodeGenerator para establecer el texto visible al eliminar caracteres de gestión. Este ejemplo muestra cómo usar MaxiCodeExtCodetextBuilder en modo extendido.
