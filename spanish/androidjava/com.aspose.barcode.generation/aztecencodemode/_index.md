...
description: Modo de codificación para códigos de barras Aztec.
type: docs
weight: 73
url: /es/androidjava/com.aspose.barcode.generation/aztecencodemode/
---
**Inheritance:**
...
| [BYTES](#BYTES) | Codifique el texto del código como bytes simples. |
...
Codifique el texto del código como bytes simples. Si detecta algún carácter Unicode, el carácter se codificará como dos bytes, primero el byte inferior.
...
Modo extendido que admite varios modos ECI.

Es mejor usar AztecExtCodetextBuilder para la generación de texto de código extendido.
