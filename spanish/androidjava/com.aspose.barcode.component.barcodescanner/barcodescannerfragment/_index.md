...
description: Fragmento para el reconocimiento de códigos de barras.
type: docs
weight: 14
url: /es/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragmento para el reconocimiento de códigos de barras. Este fragmento puede colocarse dentro de una Activity personalizada o dentro de FragmentContainerView y usarse para escanear y reconocer códigos de barras.

Ejemplo

Ejemplo de diseño de fragmento

Código Java

// Inicialización de BarcodeScannerFragment // Puede hacerse usando archivo de recursos o programáticamente/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Adjuntando BarcodeScannerFragment al diseño personalizado // Tomará el tamaño del contenedor padre requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // Las preferencias de BarcodeRecognitionSettings deben inicializarse después de adjuntar BarcodeScannerFragment a la actividad padre. // BarcodeScannerFragmentPreferencesHandler será llamado después del método BarcodeScannerFragment.onCreate() barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \{
## Constructors

| Constructor | Descripción |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Constructor predeterminado |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Establece el BarcodeScannerFragmentPreferencesHandler que puede ser llamado después del método BarcodeScannerFragment.onViewCreated() |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Interno? El botón de mostrar preferencias, para BarcodeScanner siempre es falso |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Establece una implementación personalizada de PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Establece el botón de mostrar preferencias, para BarcodeScanner siempre es falso |
...
Establece el BarcodeScannerFragmentPreferencesHandler que puede ser llamado después del método BarcodeScannerFragment.onViewCreated()
...
TODO Interno? El botón de mostrar preferencias, para BarcodeScanner siempre es falso
...
Establece una implementación personalizada de PreferencesFragment.

**Parameters:**
| Parameter | Type | Descripción |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Puede llamarse antes de iniciar el proceso de reconocimiento en BarcodeScannerFragment. |
...
Establece el botón de mostrar preferencias, para BarcodeScanner siempre es falso
