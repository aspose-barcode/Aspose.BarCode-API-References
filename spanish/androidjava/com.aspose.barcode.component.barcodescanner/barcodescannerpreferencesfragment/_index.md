...
description: PreferencesFragment puede usarse para personalizar el proceso de reconocimiento de códigos de barras utilizando una interfaz gráfica personalizada.
type: docs
weight: 17
url: /es/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment puede usarse para personalizar el proceso de reconocimiento de códigos de barras utilizando una GUI personalizada. PreferencesFragment puede implementarse como una clase personalizada y puede adjuntarse a BarcodeScannerFragment usando el método BarcodeRecognitionSettings.setPreferencesFragment().
## Constructors
