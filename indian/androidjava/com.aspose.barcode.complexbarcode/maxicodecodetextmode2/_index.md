...
description: MaxiCode कोड में मोड 2 के लिए एम्बेडेड टेक्स्ट को एन्कोड और डिकोड करने के लिए क्लास।
type: docs
weight: 26
url: /hi/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode2/
---
**Inheritance:**
...
मोड 2 के लिए MaxiCode कोड में एम्बेडेड टेक्स्ट को एन्कोड और डिकोड करने के लिए क्लास।  यह उदाहरण दिखाता है कि मोड 2 के लिए MaxiCode कोडटेक्स्ट को कैसे एन्कोड और डिकोड किया जाए।
