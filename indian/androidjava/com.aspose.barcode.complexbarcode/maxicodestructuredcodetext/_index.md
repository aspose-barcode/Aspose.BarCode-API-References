...
description: MaxiCode कोड में मोड 2 और 3 के लिए एम्बेडेड टेक्स्ट को एन्कोड और डिकोड करने के लिए बेस क्लास।
type: docs
weight: 32
url: /hi/androidjava/com.aspose.barcode.complexbarcode/maxicodestructuredcodetext/
---
**Inheritance:**
...
मोड 2 और 3 के लिए MaxiCode कोड में एम्बेडेड टेक्स्ट को एन्कोड और डिकोड करने के लिए बेस क्लास। यह उदाहरण दिखाता है कि कैसे रॉ MaxiCode कोडटेक्स्ट को MaxiCodeStructuredCodetext इंस्टेंस में डिकोड किया जाए।
