...
description: HIBC PAS डेटा लोकेशन प्रकार।
type: docs
weight: 19
url: /hi/androidjava/com.aspose.barcode.complexbarcode/hibcpasdatalocation/
---
**Inheritance:**
...
HIBC PAS डेटा लोकेशन प्रकार।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [ASSET](#ASSET) | K - एसेट डेटा प्रकार |
| [BUSINESS_RECORD](#BUSINESS-RECORD) | E - बिजनेस रिकॉर्ड |
| [DEVICES_AND_MATERIALS](#DEVICES-AND-MATERIALS) | H - डिवाइस और सामग्री |
| [DIRECT_PATIENT_IMAGE_ITEM](#DIRECT-PATIENT-IMAGE-ITEM) | D - डायरेक्ट पेशेंट इमेज आइटम |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IDENTIFICATION_CARD](#IDENTIFICATION-CARD) | I - पहचान पत्र |
| [LIBRARY_REFERENCE_MATERIAL](#LIBRARY-REFERENCE-MATERIAL) | G - लाइब्रेरी रेफ़रेंस मैटेरियल |
| [MEDICAL_ADMINISTRATION_RECORD](#MEDICAL-ADMINISTRATION-RECORD) | F - मेडिकल एडमिनिस्ट्रेशन रिकॉर्ड |
| [PATIENT](#PATIENT) | A - रोगी |
| [PATIENT_CARE_RECORD](#PATIENT-CARE-RECORD) | B - रोगी देखभाल रिकॉर्ड |
| [PRODUCT_CONTAINER](#PRODUCT-CONTAINER) | J - प्रोडक्ट कंटेनर |
| [SPECIMEN_CONTAINER](#SPECIMEN-CONTAINER) | C - स्पेसिमेन कंटेनर |
| [SURGICAL_INSTRUMENT](#SURGICAL-INSTRUMENT) | L - सर्जिकल इंस्ट्रूमेंट |
...
F - मेडिकल एडमिनिस्ट्रेशन रिकॉर्ड
