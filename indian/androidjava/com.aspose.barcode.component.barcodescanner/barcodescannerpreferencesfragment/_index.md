...
description: PreferencesFragment को कस्टम GUI का उपयोग करके बारकोड पहचान प्रक्रिया को कस्टमाइज़ करने के लिए उपयोग किया जा सकता है।
type: docs
weight: 17
url: /hi/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment को कस्टम GUI का उपयोग करके बारकोड पहचान प्रक्रिया को अनुकूलित करने के लिए उपयोग किया जा सकता है। PreferencesFragment को कस्टम क्लास के रूप में लागू किया जा सकता है और BarcodeScannerFragment से BarcodeRecognitionSettings.setPreferencesFragment() मेथड का उपयोग करके जोड़ा जा सकता है।
## Constructors
