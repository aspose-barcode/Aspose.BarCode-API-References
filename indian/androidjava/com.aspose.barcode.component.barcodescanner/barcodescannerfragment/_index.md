...
description: बारकोड पहचान के लिए फ्रैगमेंट।
type: docs
weight: 14
url: /hi/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
बारकोड पहचान के लिए फ्रैगमेंट। यह फ्रैगमेंट कस्टम एक्टिविटी या FragmentContainerView के अंदर रखा जा सकता है और बारकोड स्कैनिंग और पहचान के लिए उपयोग किया जाता है।

उदाहरण

फ्रैगमेंट लेआउट उदाहरण

Java कोड

// BarcodeScannerFragment का आरंभ // यह संसाधन फ़ाइल का उपयोग करके या प्रोग्रामेटिक रूप से बनाया जा सकता है/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// कस्टम लेआउट में BarcodeScannerFragment को संलग्न करना // यह पैरेंट कंटेनर का आकार लेगा requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings preferences को पैरेंट एक्टिविटी में BarcodeScannerFragment को संलग्न करने के बाद प्रारंभ किया जाना चाहिए. // BarcodeScannerFragmentPreferencesHandler को BarcodeScannerFragment.onCreate() मेथड के बाद कॉल किया जाएगा barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | विवरण |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | डिफ़ॉल्ट कन्स्ट्रक्टर |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | BarcodeScannerFragmentPreferencesHandler को सेट करता है जिसे BarcodeScannerFragment.onViewCreated() मेथड के बाद कॉल किया जा सकता है |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO आंतरिक? शो प्रेफ़रेंसेज़ बटन, BarcodeScanner के लिए हमेशा false है |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | PreferencesFragment की एक कस्टम इम्प्लीमेंटेशन सेट करता है। |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | शो प्रेफ़रेंसेज़ बटन सेट करता है, BarcodeScanner के लिए हमेशा false |
...
| आर्ग2 | androidx.activity.result.ActivityResultCallback<O> |  |
...
| आर्ग2 | java.io.PrintWriter |  |
| आर्ग3 | java.lang.String[] |  |
...
BarcodeScannerFragmentPreferencesHandler को सेट करता है जिसे BarcodeScannerFragment.onViewCreated() मेथड के बाद कॉल किया जा सकता है
...
TODO आंतरिक? शो प्रेफ़रेंसेज़ बटन, BarcodeScanner के लिए हमेशा false है
...
| आर्ग2 | android.view.ContextMenu.ContextMenuInfo |  |
...
PreferencesFragment की एक कस्टम इम्प्लीमेंटेशन सेट करता है।

**Parameters:**
| Parameter | Type | विवरण |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | BarcodeScannerFragment में पहचान प्रक्रिया शुरू करने से पहले कॉल किया जा सकता है। |
...
शो प्रेफ़रेंसेज़ बटन सेट करता है, BarcodeScanner के लिए हमेशा false
