...
description: लइब्रेर क लइसेंस देत है
type: docs
weight: 20
url: /hi/net/aspose.barcode/license/setlicense/
---
## SetLicense(string) {#setlicense_1}

लाइब्रेरी को लाइसेंस देता है।
...
इस उदाहरण में, MyLicense.lic नामक लाइसेंस फ़ाइल को उस फ़ोल्डर में खोजने का प्रयास किया जाएगा जिसमें घटक शामिल है, उस फ़ोल्डर में जिसमें कॉलिंग असेंबली, प्रविष्टि असेंबली के फ़ोल्डर में और फिर एम्बेडेड में है कॉलिंग असेंबली के संसाधन। एक पूर्ण या छोटा फ़ाइल नाम या एम्बेडेड संसाधन का नाम हो सकता है।
