...
description: मड 2. के लए मैक्सकड कड में एम्बेड कए गए टेक्स्ट क एन्कडंग और डकड करने के लए क्लस
type: docs
weight: 510
url: /hi/net/aspose.barcode.complexbarcode/maxicodecodetextmode2/
---
...
| नाम | विवरण |
| --- | --- |
| [MaxiCodeCodetextMode2](maxicodecodetextmode2/)() | डिफ़ॉल्ट कंस्ट्रक्टर। |
...
| override [GetMode](../../aspose.barcode.complexbarcode/maxicodecodetextmode2/getmode/)() | मैक्सीकोड मोड प्राप्त करता है। |
