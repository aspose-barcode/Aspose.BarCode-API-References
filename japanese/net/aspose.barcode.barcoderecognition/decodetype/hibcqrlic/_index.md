...
description: でデータをデコードする必要があることを指定します HIBC LIC QRブランク仕様
type: docs
weight: 450
url: /ja/net/aspose.barcode.barcoderecognition/decodetype/hibcqrlic/
---
## DecodeType.HIBCQRLIC field

でデータをデコードする必要があることを指定します **HIBC LIC QR**ブランク仕様
