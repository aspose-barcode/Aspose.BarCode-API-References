...
description: でデータをデコードする必要があることを指定します MicroPdf417バーコード仕様
type: docs
weight: 600
url: /ja/net/aspose.barcode.barcoderecognition/decodetype/micropdf417/
---
## DecodeType.MicroPdf417 field

でデータをデコードする必要があることを指定します **MicroPdf417**バーコード仕様
