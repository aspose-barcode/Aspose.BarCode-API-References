...
description: でデータをデコードする必要があることを指定します HIBC PAS データマトリックスブランク仕様
type: docs
weight: 440
url: /ja/net/aspose.barcode.barcoderecognition/decodetype/hibcdatamatrixpas/
---
## DecodeType.HIBCDataMatrixPAS field

でデータをデコードする必要があることを指定します **HIBC PAS データマトリックス**ブランク仕様
