...
type: docs
weight: 17
url: /ja/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment はカスタム GUI を使用してバーコード認識プロセスをカスタマイズするために使用できます。PreferencesFragment はカスタムクラスとして実装でき、BarcodeRecognitionSettings.setPreferencesFragment() メソッドを使用して BarcodeScannerFragment に添付できます。
## Constructors
