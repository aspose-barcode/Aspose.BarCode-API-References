...
type: docs
weight: 14
url: /ja/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
バーコード認識用のフラグメントです。このフラグメントはカスタム Activity 内または FragmentContainerView 内に配置でき、バーコードのスキャンと認識に使用します。
...
// BarcodeScannerFragment の初期化 // リソースファイルまたはプログラムで使用できます/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// カスタムレイアウトへの BarcodeScannerFragment のアタッチ // 親コンテナのサイズを取得します requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings の設定は、BarcodeScannerFragment を親アクティビティにアタッチした後に初期化する必要があります。 // BarcodeScannerFragmentPreferencesHandler は BarcodeScannerFragment.onCreate() メソッドの後に呼び出されます barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \{
## Constructors

| Constructor | Description |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | デフォルトコンストラクタ |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | BarcodeScannerFragmentPreferencesHandler を設定します。このハンドラは BarcodeScannerFragment.onViewCreated() メソッドの後に呼び出すことができます。 |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO 内部？ show preferences ボタンは、BarcodeScanner では常に false です。 |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | PreferencesFragment のカスタム実装を設定します。 |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | show preferences ボタンを設定します。BarcodeScanner では常に false です。 |
...
BarcodeScannerFragmentPreferencesHandler を設定します。このハンドラは BarcodeScannerFragment.onViewCreated() メソッドの後に呼び出すことができます。
...
TODO 内部？ show preferences ボタンは、BarcodeScanner では常に false です。
...
PreferencesFragment のカスタム実装を設定します。

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | BarcodeScannerFragment の認識プロセス開始前に呼び出すことができます。 |
...
show preferences ボタンを設定します。BarcodeScanner では常に false です。
