...
description: BarcodeScannerFragment を含む Activity です。これは内部クラスであり、クライアントはこのクラスを呼び出すべきではありませんが、クライアントは AndroidManifest.xml に BarcodeScannerActivity を登録すべきです。
type: docs
weight: 13
url: /ja/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
