...
type: docs
weight: 13
url: /ja/androidjava/com.aspose.barcode.complexbarcode/complexcodetextreader/
---
**Inheritance:**
java.lang.Object
```
...
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
| [tryDecodeHIBCLIC(String encodedCodetext)](#tryDecodeHIBCLIC-java.lang.String-) | HIBC LIC コードテキストをデコードします。 |
| [tryDecodeHIBCPAS(String encodedCodetext)](#tryDecodeHIBCPAS-java.lang.String-) | HIBC PAS コードテキストをデコードします。 |
| [tryDecodeMailmark(String encodedCodetext)](#tryDecodeMailmark-java.lang.String-) | Mailmark バーコード C と L のコードテキストをデコードします。 |
| [tryDecodeMailmark2D(String encodedCodetext)](#tryDecodeMailmark2D-java.lang.String-) | Royal Mail Mailmark 2D コードテキストをデコードします。 |
| [tryDecodeMaxiCode(int maxiCodeMode, String encodedCodetext)](#tryDecodeMaxiCode-int-java.lang.String-) | MaxiCode コードテキストをデコードします。 |
| [tryDecodeSwissQR(String encodedCodetext)](#tryDecodeSwissQR-java.lang.String-) | SwissQR コードテキストをデコードします。 |
| [tryDecodeUSADriveId(String encodedCodetext)](#tryDecodeUSADriveId-java.lang.String-) | USADriveId コードテキストをデコードします。 |
| [wait()](#wait--) |  |
...
| Parameter | Type | Description |
| --- | --- | --- |
| encodedCodetext | java.lang.String | エンコードされたコードテキスト |
...
Mailmark バーコード C と L のコードテキストをデコードします。
