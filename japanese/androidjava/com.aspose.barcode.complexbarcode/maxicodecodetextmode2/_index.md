...
description: モード2用の MaxiCode コードに埋め込まれたテキストをエンコードおよびデコードするクラス。
type: docs
weight: 26
url: /ja/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode2/
---
**Inheritance:**
...
モード2の MaxiCode コードに埋め込まれたテキストをエンコードおよびデコードするためのクラス。 このサンプルは、モード2の MaxiCode コードテキストをエンコードおよびデコードする方法を示しています。
