...
description: モード3用の MaxiCode コードに埋め込まれたテキストをエンコードおよびデコードするクラス。
type: docs
weight: 27
url: /ja/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode3/
---
**Inheritance:**
...
モード 3 の MaxiCode コードに埋め込まれたテキストをエンコードおよびデコードするためのクラスです。このサンプルは、モード 3 の MaxiCode コードテキストをエンコードおよびデコードする方法を示しています。
