...
description: 4ステート Mailmark バーコードのタイプ
type: docs
weight: 22
url: /ja/androidjava/com.aspose.barcode.complexbarcode/mailmark1dtype/
---
**Inheritance:**
...
4ステート Mailmark バーコードのタイプ
## フィールド

| フィールド | Description |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Type_C](#Type-C) | 4 状態 Mailmark バーコード C |
| [Type_L](#Type-L) | 4 状態 Mailmark バーコード L |
## Methods
