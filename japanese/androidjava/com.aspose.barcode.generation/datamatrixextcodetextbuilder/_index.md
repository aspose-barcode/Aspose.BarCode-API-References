...
type: docs
weight: 33
url: /ja/androidjava/com.aspose.barcode.generation/datamatrixextcodetextbuilder/
---
**Inheritance:**
...
EncodeMode の ExtendedCodetext モード用の 2D DataMatrix バーコード向け拡張 codetext ジェネレータ。
...
| Method | Description |
| --- | --- |
| [addCodetextWithEncodeMode(DataMatrixEncodeMode encodeMode, String codetext)](#addCodetextWithEncodeMode-com.aspose.barcode.generation.DataMatrixEncodeMode-java.lang.String-) | 定義されたエンコードモードで codetext を拡張 codetext アイテムに追加します。 |
| [addECICodetext(int ECIEncoding, String codetext)](#addECICodetext-int-java.lang.String-) | 拡張チャネル識別子を使用してコードテキストを追加します。 |
| [addECICodetextWithEncodeMode(int ECIEncoding, DataMatrixEncodeMode encodeMode, String codetext)](#addECICodetextWithEncodeMode-int-com.aspose.barcode.generation.DataMatrixEncodeMode-java.lang.String-) | 定義されたエンコードモードで拡張チャンネル識別子を使用して codetext を追加します。 |
...
定義されたエンコードモードで codetext を拡張 codetext アイテムに追加します。

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| encodeMode | [DataMatrixEncodeMode](../../com.aspose.barcode.generation/datamatrixencodemode) | エンコードモードの値 |
...
定義されたエンコードモードで拡張チャンネル識別子を使用して codetext を追加します。
...
| ECIEncoding | int | Extended Channel Identifier |
| encodeMode | [DataMatrixEncodeMode](../../com.aspose.barcode.generation/datamatrixencodemode) | エンコードモードの値 |
| codetext | java.lang.String | 定義されたエンコードモードで拡張チャンネル識別子を使用して追加する、Unicode の codetext（拡張 codetext アイテム）。 |
