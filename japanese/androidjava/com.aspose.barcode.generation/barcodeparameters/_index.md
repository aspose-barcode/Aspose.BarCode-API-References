...
type: docs
weight: 14
url: /ja/androidjava/com.aspose.barcode.generation/barcodeparameters/
---
**Inheritance:**
java.lang.Object
```
...
| [getAustralianPost()](#getAustralianPost--) | AustralianPost バーコードパラメータ。 |
| [getAztec()](#getAztec--) | Aztec parameters. |
| [getBarColor()](#getBarColor--) | バーの色。 |
| [getBarHeight()](#getBarHeight--) | 1D バーコードのバーの高さは、[Unit](../../com.aspose.barcode.generation/unit) の値で指定します。 |
| [getBarWidthReduction()](#getBarWidthReduction--) | 印刷時のインク拡散を補正するために使用されるバーの縮小値を取得します。 |
...
| [getITF()](#getITF--) | ITF パラメータ。 |
| [getMaxiCode()](#getMaxiCode--) | MaxiCode パラメータ。 |
| [getPadding()](#getPadding--) | Barcode paddings. |
| [getPatchCode()](#getPatchCode--) | PatchCode パラメータ。 |
| [getPdf417()](#getPdf417--) | PDF417 パラメータ。 |
| [getPostal()](#getPostal--) | 郵便パラメータ。 |
| [getQR()](#getQR--) | QR, MicroQR and RectMicroQR parameters. |
| [getSupplement()](#getSupplement--) | 補足パラメータ。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBarColor(int value)](#setBarColor-int-) | バーの色。 |
| [setBarHeight(Unit value)](#setBarHeight-com.aspose.barcode.generation.Unit-) | 1D バーコードのバーの高さは、[Unit](../../com.aspose.barcode.generation/unit) の値で指定します。 |
...
郵便パラメータ。Postnet、Planet に使用されます。
...
x-dimension はバーコードのバーまたはスペースの単位の最小幅です。これを増やすと全体のバーコード画像の幅が増加します。BaseGenerationParameters.AutoSizeMode ([BaseGenerationParameters.getAutoSizeMode](../../com.aspose.barcode.generation/basegenerationparameters\#getAutoSizeMode)/[BaseGenerationParameters.setAutoSizeMode](../../com.aspose.barcode.generation/basegenerationparameters\#setAutoSizeMode)) プロパティが AutoSizeMode.Nearest または AutoSizeMode.Interpolation に設定されている場合は無視されます。
...
チェックサムが必須のシンボルではデフォルトは Yes とみなされ、チェックサムがオプションの場合は No とみなされます。

チェックサムは可能です: Code39 Standard/Extended、Standard2of5、Interleaved2of5、Matrix2of5、ItalianPost25、DeutschePostIdentcode、DeutschePostLeitcode、VIN、Codabar

チェックサムが常に使用されます: その他のシンボル
...
印刷時のインク拡散を補正するために使用されるバーの縮小値を設定します。デフォルト値: 0

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| value | [Unit](../../com.aspose.barcode.generation/unit) | 印刷時のインク拡散を補正するために使用されるバーの縮小値。 |
...
バーが塗りつぶされているかどうかを示す値を設定します。1D バーコードのみ対象です。デフォルト値: true。

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| 値 | boolean | バーが塗りつぶされているかどうかを示す値。 |
