...
type: docs
weight: 11
url: /ja/androidjava/com.aspose.barcode.generation/aztecextcodetextbuilder/
---
**Inheritance:**
...
AztecEncodeModeのExtendedCodetextモード用のAztecバーコード向け拡張コードテキストジェネレータ

BarcodeGeneratorのTwoDDisplayTextプロパティを使用して、表示テキストを設定し、管理文字を除去します。
