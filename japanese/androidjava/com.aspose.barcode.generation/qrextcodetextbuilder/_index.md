...
description: 2D QR バーコード用の拡張コードテキストジェネレータで、QrEncodeMode の ExtendedCodetext モードで使用し、BarcodeGenerator の TwoDDisplayText プロパティを使用して表示テキストを設定し、管理文字を除去します。
type: docs
weight: 63
url: /ja/androidjava/com.aspose.barcode.generation/qrextcodetextbuilder/
---
**Inheritance:**
...
| Parameter | Type | Description |
| --- | --- | --- |
| codetext | java.lang.String | 第2位置のFNC1の値 |
