...
description: DotCode バーコードのエンコーディングモード。
type: docs
weight: 85
url: /ja/androidjava/com.aspose.barcode.generation/dotcodeencodemode/
---
**Inheritance:**
...
拡張コードテキスト生成には DotCodeExtCodetextBuilder を使用した方が良いです。
