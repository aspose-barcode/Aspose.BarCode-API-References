...
type: docs
weight: 23
url: /ja/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
| フィールド | Description |
| --- | --- |
| [A](#A) | Codabar バーコード仕様の開始または停止シンボルとして文字 A を指定します。 |
| [B](#B) | Codabar バーコード仕様の開始または停止シンボルとして文字 B を指定します。 |
| [C](#C) | Codabar バーコード仕様の開始または停止シンボルとして文字 C を指定します。 |
| [D](#D) | Codabar バーコード仕様の開始または停止シンボルとして文字 D を指定します。 |
...
Codabar バーコード仕様の開始または停止シンボルとして文字 A を指定します。
...
Codabar バーコード仕様の開始または停止シンボルとして文字 B を指定します。
...
Codabar バーコード仕様の開始または停止シンボルとして文字 C を指定します。
...
Codabar バーコード仕様の開始または停止シンボルとして文字 D を指定します。
