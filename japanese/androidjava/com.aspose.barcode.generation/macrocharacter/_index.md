...
description: マクロ文字 05 と 06 の値は、特殊モードでよりコンパクトなエンコードを取得するために使用されます。
type: docs
weight: 94
url: /ja/androidjava/com.aspose.barcode.generation/macrocharacter/
---
**Inheritance:**
...
マクロ文字 05 と 06 の値は、特殊モードでよりコンパクトなエンコードを取得するために使用されます。05 マクロ文字はデコードされたデータヘッダーとして "[)>05" に、デコードされたデータトレーラーとして "" に変換されます。06 マクロ文字はデコードされたデータヘッダーとして "[)>06" に、デコードされたデータトレーラーとして "" に変換されます。
...
| フィールド | Description |
| --- | --- |
| [MACRO_05](#MACRO-05) | 05 マクロ文字はバーコードデータの最初の位置に追加されます。 |
| [MACRO_06](#MACRO-06) | 06 マクロ文字がバーコードデータの先頭に追加されます。 |
| [NONE](#NONE) | マクロ文字はバーコードデータに追加されません。 |
## Methods
...
05 マクロ文字がバーコードデータの先頭に追加されます。GS1 データ識別子 ISO 15434 文字は、デコードされたデータヘッダーとして \"[)>05\"、デコードされたデータトレーラーとして \"\" に変換されます。
...
06 マクロ文字がバーコードデータの先頭に追加されます。ASC MH10 データ識別子 ISO 15434 文字は、デコードされたデータヘッダーとして \"[)>06\"、デコードされたデータトレーラーとして \"\" に変換されます。
