...
description: MaxiCode バーコード用の拡張コードテキストジェネレータで、MaxiCodeEncodeMode の ExtendedCodetext モードで使用し、BarcodeGenerator の TwoDDisplayText プロパティを使用して表示テキストを設定し、管理文字を除去します。
type: docs
weight: 55
url: /ja/androidjava/com.aspose.barcode.generation/maxicodeextcodetextbuilder/
---
**Inheritance:**
...
MaxiCodeEncodeMode の ExtendedCodetext モード用の MaxiCode バーコード向け拡張コードテキストジェネレータです。表示テキストを設定し、管理文字を除去するには BarcodeGenerator の TwoDDisplayText プロパティを使用します。このサンプルは Extended モードで MaxiCodeExtCodetextBuilder を使用する方法を示しています。
