...
description: MaxiCode バーコードのエンコーディングモード。
type: docs
weight: 56
url: /ja/androidjava/com.aspose.barcode.generation/maxicodemode/
---
**Inheritance:**
...
MaxiCode バーコードのエンコーディングモードです。このサンプルは ComplexBarcodeGenerator を使用して MaxiCode バーコードを生成する方法を示しています。
...
| [MODE_2](#MODE-2) | モード 2 は最初のメッセージに郵便情報を、2 番目のメッセージにデータをエンコードします。 |
| [MODE_3](#MODE-3) | モード 3 は最初のメッセージに郵便情報を、2 番目のメッセージにデータをエンコードします。 |
| [MODE_4](#MODE-4) | モード 4 は最初と 2 番目のメッセージにデータをエンコードし、短い ECC 補正を行います。 |
| [MODE_5](#MODE-5) | モード 5 は最初と 2 番目のメッセージにデータをエンコードし、長い ECC 補正を行います。 |
| [MODE_6](#MODE-6) | モード 6 は最初と 2 番目のメッセージにデータをエンコードし、短い ECC 補正を行います。 |
## Methods
...
モード 2 は最初のメッセージに郵便情報を、2 番目のメッセージにデータをエンコードします。9 桁の郵便番号を持ちます（米国でのみ使用）。
...
モード 3 は最初のメッセージに郵便情報を、2 番目のメッセージにデータをエンコードします。6 文字の英数字郵便コードを持ち、世界中で使用されます。
...
モード 4 は最初と 2 番目のメッセージにデータをエンコードし、短い ECC 補正を行います。
...
モード 5 は最初と 2 番目のメッセージにデータをエンコードし、長い ECC 補正を行います。
...
モード 6 は最初と 2 番目のメッセージにデータをエンコードし、短い ECC 補正を行います。デバイスのエンコードに使用されます。
