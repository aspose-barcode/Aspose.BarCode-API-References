...
type: docs
weight: 87
url: /ja/androidjava/com.aspose.barcode.generation/fontmode/
---
**Inheritance:**
...
| フィールド | Description |
| --- | --- |
| [AUTO](#AUTO) | バーコードのサイズに基づいてフォントサイズを自動的に計算します。 |
| [MANUAL](#MANUAL) | ユーザーが定義したフォントサイズを使用します。 |
## Methods
...
バーコードのサイズに基づいてフォントサイズを自動的に計算します。
