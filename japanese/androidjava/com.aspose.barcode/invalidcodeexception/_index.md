...
description: コードテキストに無効な文字が含まれている場合、例外がスローされます。
type: docs
weight: 15
url: /ja/androidjava/com.aspose.barcode/invalidcodeexception/
---
**Inheritance:**
...
コードテキストに無効な文字が含まれている場合、例外がスローされます。
## Constructors

| Constructor | Description |
| --- | --- |
| [InvalidCodeException()](#InvalidCodeException--) | クラスの新しいインスタンスを初期化します。 |
| [InvalidCodeException(String message)](#InvalidCodeException-java.lang.String-) | InvalidCodeException クラスの新しいインスタンスを、指定されたエラーメッセージで初期化します。 |
## Methods
...
InvalidCodeException クラスの新しいインスタンスを、指定されたエラーメッセージで初期化します。
