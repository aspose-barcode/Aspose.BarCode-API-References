...
type: docs
weight: 57
url: /ja/androidjava/com.aspose.barcode.barcoderecognition/inverseimagemode/
---
**Inheritance:**
...
| フィールド | Description |
| --- | --- |
| [AUTO](#AUTO) | QRコードを除くすべてのバーコードタイプに対して、逆画像上のバーコードの追加認識を無効にします。 |
| [DISABLED](#DISABLED) | 逆画像上のバーコードの追加認識を無効にします。 |
| [ENABLED](#ENABLED) | 逆画像上のバーコードの追加認識を有効にします |
## Methods
...
QRコードを除くすべてのバーコードタイプに対して、逆画像上のバーコードの追加認識を無効にします。
