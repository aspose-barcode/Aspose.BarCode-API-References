...
description: Definisce un formato particolare per il testo includendo la dimensione del carattere e gli attributi di stile, dove la dimensione è nella proprietà Unit value.
type: docs
weight: 44
url: /it/androidjava/com.aspose.barcode.generation/fontunit/
---
**Inheritance:**
java.lang.Object
```
...
Definisce un formato particolare per il testo, includendo il tipo di carattere, la dimensione e gli attributi di stile dove la dimensione è nella proprietà Unit value.
...
| [getClass()](#getClass--) |  |
| [getFamilyName()](#getFamilyName--) | Restituisce il nome del carattere di questo Font. |
| [getSize()](#getSize--) | Restituisce la dimensione di questo FontUnit in Unit value. |
| [getStateHash()](#getStateHash--) |  |
| [getStyle()](#getStyle--) | Restituisce le informazioni di stile per questo FontUnit. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setFamilyName(Typeface value)](#setFamilyName-android.graphics.Typeface-) | Imposta il nome del carattere di questo Font. |
| [setStyle(int value)](#setStyle-int-) | Imposta le informazioni di stile per questo FontUnit. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Restituisce il nome del carattere di questo Font.
...
Restituisce la dimensione di questo FontUnit in Unit value.
...
Restituisce le informazioni di stile per questo FontUnit.
...
Imposta il nome del carattere di questo Font.

**Parameters:**
| Parameter | Type | Descrizione |
| --- | --- | --- |
| valore | android.graphics.Typeface |  |
...
Imposta le informazioni di stile per questo FontUnit.
