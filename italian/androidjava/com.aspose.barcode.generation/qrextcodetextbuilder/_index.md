...
description: Generatore di codetext esteso per i codici a barre QR 2D per la modalità ExtendedCodetext di QrEncodeMode. Usa la proprietà TwoDDisplayText di BarcodeGenerator per impostare il testo visibile rimuovendo i caratteri di gestione.
type: docs
weight: 63
url: /it/androidjava/com.aspose.barcode.generation/qrextcodetextbuilder/
---
**Inheritance:**
...
| Parameter | Type | Descrizione |
| --- | --- | --- |
| codetext | java.lang.String | Valore del FNC1 nella seconda posizione |
