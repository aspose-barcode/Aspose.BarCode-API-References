...
type: docs
weight: 56
url: /it/androidjava/com.aspose.barcode.generation/maxicodemode/
---
**Inheritance:**
...
Modalità di codifica per i codici a barre MaxiCode. Questo esempio mostra come generare codici a barre MaxiCode usando ComplexBarcodeGenerator
...
| [MODE_2](#MODE-2) | La modalità 2 codifica le informazioni postali nel primo messaggio e i dati nel secondo messaggio. |
| [MODE_3](#MODE-3) | La modalità 3 codifica le informazioni postali nel primo messaggio e i dati nel secondo messaggio. |
| [MODE_4](#MODE-4) | La modalità 4 codifica i dati nel primo e nel secondo messaggio, con correzione ECC breve. |
| [MODE_5](#MODE-5) | La modalità 5 codifica i dati nel primo e nel secondo messaggio, con correzione ECC lunga. |
| [MODE_6](#MODE-6) | La modalità 6 codifica i dati nel primo e nel secondo messaggio, con correzione ECC breve. |
## Methods
...
La modalità 2 codifica le informazioni postali nel primo messaggio e i dati nel secondo messaggio. Ha un codice postale a 9 cifre (usato solo negli USA).
...
La modalità 3 codifica le informazioni postali nel primo messaggio e i dati nel secondo messaggio. Ha un codice postale alfanumerico a 6 caratteri, usato in tutto il mondo.
...
La modalità 4 codifica i dati nel primo e nel secondo messaggio, con correzione ECC breve.
...
La modalità 5 codifica i dati nel primo e nel secondo messaggio, con correzione ECC lunga.
...
La modalità 6 codifica i dati nel primo e nel secondo messaggio, con correzione ECC breve. Usata per codificare dispositivi.
