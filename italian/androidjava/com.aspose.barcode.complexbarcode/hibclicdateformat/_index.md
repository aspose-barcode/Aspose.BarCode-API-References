...
description: Specifica i diversi tipi di formati data per HIBC LIC.
type: docs
weight: 42
url: /it/androidjava/com.aspose.barcode.complexbarcode/hibclicdateformat/
---
**Inheritance:**
...
Specifica i diversi tipi di formati data per HIBC LIC.
## Campi

| Campo | Descrizione |
| --- | --- |
| [MMDDYY](#MMDDYY) | Formato MMDDYY. |
| [MMYY](#MMYY) | Formato MMYY. |
| [NONE](#NONE) | Non codificare la data di scadenza. |
| [YYJJJ](#YYJJJ) | Formato data giuliano. |
| [YYJJJHH](#YYJJJHH) | Formato data giuliano con ore. |
| [YYMMDD](#YYMMDD) | Formato YYMMDD. |
| [YYMMDDHH](#YYMMDDHH) | Formato YYMMDDHH. |
| [YYYYMMDD](#YYYYMMDD) | Formato YYYYMMDD. |
## Methods
...
Non codificare la data di scadenza.
...
Formato YYYYMMDD. Verrà codificato nei dati supplementari aggiuntivi.
