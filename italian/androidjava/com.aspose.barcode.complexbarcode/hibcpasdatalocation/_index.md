...
description: Tipi di posizione dei dati HIBC PAS.
type: docs
weight: 19
url: /it/androidjava/com.aspose.barcode.complexbarcode/hibcpasdatalocation/
---
**Inheritance:**
...
Tipi di posizione dei dati HIBC PAS.
## Campi

| Campo | Descrizione |
| --- | --- |
| [ASSET](#ASSET) | K - Tipo di dati dell'asset |
| [BUSINESS_RECORD](#BUSINESS-RECORD) | E - Registro aziendale |
| [DEVICES_AND_MATERIALS](#DEVICES-AND-MATERIALS) | H - Dispositivi e materiali |
| [DIRECT_PATIENT_IMAGE_ITEM](#DIRECT-PATIENT-IMAGE-ITEM) | D - Elemento immagine paziente diretto |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IDENTIFICATION_CARD](#IDENTIFICATION-CARD) | I - Carta d'identità |
| [LIBRARY_REFERENCE_MATERIAL](#LIBRARY-REFERENCE-MATERIAL) | G - Materiale di riferimento della biblioteca |
| [MEDICAL_ADMINISTRATION_RECORD](#MEDICAL-ADMINISTRATION-RECORD) | F - Registro di amministrazione medica |
| [PATIENT](#PATIENT) | A - Paziente |
| [PATIENT_CARE_RECORD](#PATIENT-CARE-RECORD) | B - Registro di assistenza al paziente |
| [PRODUCT_CONTAINER](#PRODUCT-CONTAINER) | J - Contenitore del prodotto |
| [SPECIMEN_CONTAINER](#SPECIMEN-CONTAINER) | C - Contenitore del campione |
| [SURGICAL_INSTRUMENT](#SURGICAL-INSTRUMENT) | L - Strumento chirurgico |
...
D - Elemento immagine paziente diretto
...
G - Materiale di riferimento della biblioteca
...
F - Registro di amministrazione medica
...
B - Registro di assistenza al paziente
