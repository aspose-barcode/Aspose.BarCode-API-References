...
description: Classe base per la codifica e decodifica del testo incorporato nel codice MaxiCode per le modalità 2 e 3.
type: docs
weight: 32
url: /it/androidjava/com.aspose.barcode.complexbarcode/maxicodestructuredcodetext/
---
**Inheritance:**
...
Classe base per la codifica e la decodifica del testo incorporato nel codice MaxiCode per le modalità 2 e 3. Questo esempio mostra come decodificare il codetext MaxiCode grezzo in un'istanza di MaxiCodeStructuredCodetext.
