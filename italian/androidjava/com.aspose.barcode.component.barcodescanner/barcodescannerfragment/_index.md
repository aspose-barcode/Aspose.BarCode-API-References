...
description: Fragment per il riconoscimento dei codici a barre.
type: docs
weight: 14
url: /it/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment per il riconoscimento di codici a barre. Questo fragment può essere inserito all'interno di un'Activity personalizzata o in un FragmentContainerView e utilizzato per la scansione e il riconoscimento dei codici a barre.

Esempio

Esempio di layout del fragment

Codice Java

// Inizializzazione di BarcodeScannerFragment // Può essere fatto usando un file di risorse o programmaticamente/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Collegamento di BarcodeScannerFragment al layout personalizzato // Prenderà le dimensioni del contenitore genitore requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // Le preferenze di BarcodeRecognitionSettings dovrebbero essere inizializzate dopo aver collegato BarcodeScannerFragment all'attività genitore. // BarcodeScannerFragmentPreferencesHandler verrà chiamato dopo il metodo BarcodeScannerFragment.onCreate() metodo barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | Descrizione |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Costruttore predefinito |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Imposta il BarcodeScannerFragmentPreferencesHandler che può essere chiamato dopo il metodo BarcodeScannerFragment.onViewCreated() |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Interno? Il pulsante mostra preferenze, per BarcodeScanner è sempre false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Imposta un'implementazione personalizzata di PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Imposta il pulsante mostra preferenze, per BarcodeScanner è sempre false |
...
Imposta il BarcodeScannerFragmentPreferencesHandler che può essere chiamato dopo il metodo BarcodeScannerFragment.onViewCreated()
...
TODO Interno? Il pulsante mostra preferenze, per BarcodeScanner è sempre false
...
Imposta un'implementazione personalizzata di PreferencesFragment.

**Parameters:**
| Parameter | Type | Descrizione |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Può essere chiamato prima dell'avvio del processo di riconoscimento in BarcodeScannerFragment. |
...
Imposta il pulsante mostra preferenze, per BarcodeScanner è sempre false
