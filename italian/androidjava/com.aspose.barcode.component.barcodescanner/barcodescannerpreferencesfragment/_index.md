...
description: PreferencesFragment può essere utilizzato per personalizzare il processo di riconoscimento dei codici a barre usando un'interfaccia grafica personalizzata.
type: docs
weight: 17
url: /it/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment può essere usato per personalizzare il processo di riconoscimento del codice a barre utilizzando un'interfaccia grafica personalizzata. PreferencesFragment può essere implementato come classe personalizzata e può essere collegato a BarcodeScannerFragment usando il metodo BarcodeRecognitionSettings.setPreferencesFragment().
## Constructors
