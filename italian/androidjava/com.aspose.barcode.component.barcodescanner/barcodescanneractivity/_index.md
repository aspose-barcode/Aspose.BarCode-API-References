...
description: Attività che contiene BarcodeScannerFragment. È una classe interna e il client non dovrebbe chiamare questa classe, ma il client dovrebbe registrare BarcodeScannerActivity in AndroidManifest.xml
type: docs
weight: 13
url: /it/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
Attività che contiene BarcodeScannerFragment. È una classe interna e il client non dovrebbe chiamare questa classe, ma il client dovrebbe registrare BarcodeScannerActivity in AndroidManifest.xml
## Constructors
