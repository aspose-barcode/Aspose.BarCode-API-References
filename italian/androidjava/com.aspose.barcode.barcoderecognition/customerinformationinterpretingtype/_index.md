...
description: Definisce il tipo di interpretazione C_TABLE o N_TABLE delle informazioni del cliente per AustralianPost BarCode.
type: docs
weight: 54
url: /it/androidjava/com.aspose.barcode.barcoderecognition/customerinformationinterpretingtype/
---
**Inheritance:**
...
Definisce il tipo di interpretazione (C\_TABLE o N\_TABLE) delle informazioni cliente per il BarCode AustralianPost.
...
| Campo | Descrizione |
| --- | --- |
| [C_TABLE](#C-TABLE) | Usa C\_TABLE per interpretare le informazioni del cliente. |
| [N_TABLE](#N-TABLE) | Usa N\_TABLE per interpretare le informazioni del cliente. |
| [OTHER](#OTHER) | Non interpretare le informazioni del cliente. |
## Methods
...
Usa C\_TABLE per interpretare le informazioni del cliente. Consente A..Z, a..z, 1..9, spazio e \# sing.
...
Usa N\_TABLE per interpretare le informazioni del cliente. Consente cifre.
