...
type: docs
weight: 57
url: /it/androidjava/com.aspose.barcode.barcoderecognition/inverseimagemode/
---
**Inheritance:**
...
| Campo | Descrizione |
| --- | --- |
| [AUTO](#AUTO) | Disabilita il riconoscimento aggiuntivo dei codici a barre su immagini inverse per tutti i tipi di codice a barre eccetto QR Code |
| [DISABLED](#DISABLED) | Disabilita il riconoscimento aggiuntivo dei codici a barre su immagini inverse. |
| [ENABLED](#ENABLED) | Abilita il riconoscimento aggiuntivo dei codici a barre su immagini inverse |
## Methods
...
Disabilita il riconoscimento aggiuntivo dei codici a barre su immagini inverse per tutti i tipi di codice a barre eccetto QR Code
...
Disabilita il riconoscimento aggiuntivo dei codici a barre su immagini inverse.
...
Abilita il riconoscimento aggiuntivo dei codici a barre su immagini inverse
