...
description: I principali parametri di decodifica del BarCode.
type: docs
weight: 20
url: /it/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | Abilita la convalida del checksum durante il riconoscimento per i codici a barre 1D e postali. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | Abilita la convalida del checksum durante il riconoscimento per i codici a barre 1D e postali. |
...
| Parameter | Type | Descrizione |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | Abilita la convalida del checksum durante il riconoscimento per i codici a barre 1D e postali. |
...
| Parameter | Type | Descrizione |
| --- | --- | --- |
| valore | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
