...
type: docs
weight: 52
url: /it/androidjava/com.aspose.barcode.barcoderecognition/checksumvalidation/
---
**Inheritance:**
...
Abilita la convalida del checksum durante il riconoscimento per i codici a barre 1D e postali.
...
Checksum mai usato: Codabar, PatchCode, Pharmacode, DataLogic2of5
...
Checksum sempre usato: Resto delle simbologie
...
| Campo | Descrizione |
| --- | --- |
| [DEFAULT](#DEFAULT) | Se il checksum è richiesto dalla specifica, verrà convalidato. |
| [OFF](#OFF) | Non convalidare il checksum. |
| [ON](#ON) | Convalida sempre il checksum se possibile. |
## Methods
...
Se il checksum è richiesto dalla specifica, verrà convalidato.
...
Convalida sempre il checksum se possibile.
