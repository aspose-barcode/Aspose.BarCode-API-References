...
type: docs
weight: 51
url: /it/androidjava/com.aspose.barcode.barcoderecognition/barcodequalitymode/
---
**Inheritance:**
...
| Campo | Descrizione |
| --- | --- |
| [HIGH](#HIGH) | Abilita i metodi di riconoscimento per codici a barre di alta qualità. |
| [LOW](#LOW) | Abilita i metodi di riconoscimento per codici a barre di bassa qualità. |
| [NORMAL](#NORMAL) | Abilita i metodi di riconoscimento per codici a barre di qualità comune (normale). |
## Methods
...
Abilita i metodi di riconoscimento per codici a barre di alta qualità.
...
Abilita i metodi di riconoscimento per codici a barre di bassa qualità.
...
Abilita i metodi di riconoscimento per codici a barre di qualità comune (normale).
