...
Значение 0,7 означает, что нижние 70% возможных областей отфильтровываются и далее не обрабатываются. Порог вероятности области должен быть между [0,05, 0,9] Используйте высокие значения для четких изображений с небольшим количеством штрих-кодов. Используйте низкие значения для изображений с большим количеством штрих-кодов или для шумных изображений. Низкое значение может привести к увеличению времени распознавания.
