...
description: Активность, содержащая BarcodeScannerFragment. Это внутренний класс, и клиент не должен вызывать этот класс, но клиент должен зарегистрировать BarcodeScannerActivity в AndroidManifest.xml
type: docs
weight: 13
url: /ru/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
Activity, содержащий BarcodeScannerFragment. Это внутренний класс, и клиент не должен вызывать этот класс, но клиент должен зарегистрировать BarcodeScannerActivity в AndroidManifest.xml
## Конструкторы
