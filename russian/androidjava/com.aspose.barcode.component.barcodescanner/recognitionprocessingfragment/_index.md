...
description: Внутренний содержит графический интерфейс, который отображается во время процесса распознавания
type: docs
weight: 26
url: /ru/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessingfragment/
---
**Inheritance:**
...
Внутренний содержит графический интерфейс, который отображается во время процесса распознавания
## Конструкторы
