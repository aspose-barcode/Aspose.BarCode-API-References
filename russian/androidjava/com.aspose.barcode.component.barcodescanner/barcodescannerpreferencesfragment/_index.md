...
description: PreferencesFragment может использоваться для настройки процесса распознавания штрих-кодов с помощью пользовательского графического интерфейса.
type: docs
weight: 17
url: /ru/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment может использоваться для настройки процесса распознавания штрихкода с помощью пользовательского графического интерфейса. PreferencesFragment может быть реализован как пользовательский класс и может быть присоединён к BarcodeScannerFragment с использованием метода BarcodeRecognitionSettings.setPreferencesFragment().
## Конструкторы
