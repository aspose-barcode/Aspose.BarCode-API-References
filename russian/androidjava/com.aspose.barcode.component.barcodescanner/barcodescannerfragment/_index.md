...
description: Фрагмент для распознавания штрих-кодов.
type: docs
weight: 14
url: /ru/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Фрагмент для распознавания штрих‑кодов. Этот фрагмент можно разместить внутри пользовательской Activity или внутри FragmentContainerView и использовать для сканирования и распознавания штрих‑кодов.
...
// Инициализация BarcodeScannerFragment // Можно выполнить с использованием файла ресурсов или программно/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Присоединение BarcodeScannerFragment к пользовательскому макету // Он займет размер родительского контейнера requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // Настройки BarcodeRecognitionSettings должны быть инициализированы после присоединения BarcodeScannerFragment к родительской активности. // BarcodeScannerFragmentPreferencesHandler будет вызван после метода BarcodeScannerFragment.onCreate() barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \{
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Конструктор по умолчанию |
## Методы
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Устанавливает BarcodeScannerFragmentPreferencesHandler, который может быть вызван после метода BarcodeScannerFragment.onViewCreated() |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Внутреннее? Кнопка отображения настроек для BarcodeScanner всегда false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Устанавливает пользовательскую реализацию PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Устанавливает кнопку отображения настроек, для BarcodeScanner всегда false |
...
Устанавливает BarcodeScannerFragmentPreferencesHandler, который может быть вызван после метода BarcodeScannerFragment.onViewCreated()
...
TODO Внутреннее? Кнопка отображения настроек для BarcodeScanner всегда false
...
Устанавливает пользовательскую реализацию PreferencesFragment.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Можно вызвать до начала процесса распознавания в BarcodeScannerFragment. |
...
Устанавливает кнопку отображения настроек, для BarcodeScanner всегда false
