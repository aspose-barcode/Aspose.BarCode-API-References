...
description: Представляет фон изображения, полученный с камеры, который будет отрисован во время процесса распознавания
type: docs
weight: 24
url: /ru/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentcameraphotobackground/
---
**Inheritance:**
...
Представляет фон изображения, полученный с камеры, который будет отрисован во время процесса распознавания
## Конструкторы
