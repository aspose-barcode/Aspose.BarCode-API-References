...
description: Типы 4‑состояний штрих‑кода Mailmark
type: docs
weight: 22
url: /ru/androidjava/com.aspose.barcode.complexbarcode/mailmark1dtype/
---
**Inheritance:**
...
Типы 4‑состояний штрих‑кода Mailmark
## Поля

| Поле | Описание |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Type_C](#Type-C) | 4‑состояния Mailmark Barcode C |
| [Type_L](#Type-L) | 4‑состояния Mailmark Barcode L |
## Методы
...
4‑состояния Mailmark Barcode C
...
4‑состояния Mailmark Barcode L
