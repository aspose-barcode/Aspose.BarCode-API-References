...
description: Класс для кодирования и декодирования текста, встроенного в код MaxiCode для режима 3.
type: docs
weight: 27
url: /ru/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode3/
---
**Inheritance:**
...
Класс для кодирования и декодирования текста, встроенного в код MaxiCode для режима 3. Этот пример показывает, как кодировать и декодировать MaxiCode codetext для режима 3.
