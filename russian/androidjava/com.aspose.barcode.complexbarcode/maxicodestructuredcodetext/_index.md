...
description: Базовый класс для кодирования и декодирования текста, встроенного в код MaxiCode для режимов 2 и 3.
type: docs
weight: 32
url: /ru/androidjava/com.aspose.barcode.complexbarcode/maxicodestructuredcodetext/
---
**Inheritance:**
...
Базовый класс для кодирования и декодирования текста, встроенного в код MaxiCode для режимов 2 и 3. Этот пример показывает, как декодировать необработанный код MaxiCode в экземпляр MaxiCodeStructuredCodetext.
