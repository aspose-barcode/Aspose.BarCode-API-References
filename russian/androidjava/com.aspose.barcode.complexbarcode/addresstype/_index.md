...
type: docs
weight: 41
url: /ru/androidjava/com.aspose.barcode.complexbarcode/addresstype/
---
**Inheritance:**
...
| Поле | Описание |
| --- | --- |
| [COMBINED_ELEMENTS](#COMBINED-ELEMENTS) | Объединённые элементы адреса |
| [CONFLICTING](#CONFLICTING) | Конфликтующий |
| [STRUCTURED](#STRUCTURED) | Структурированный адрес |
| [UNDETERMINED](#UNDETERMINED) | Неопределённый |
## Методы
