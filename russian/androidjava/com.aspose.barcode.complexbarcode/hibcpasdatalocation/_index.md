...
description: Типы расположения данных HIBC PAS.
type: docs
weight: 19
url: /ru/androidjava/com.aspose.barcode.complexbarcode/hibcpasdatalocation/
---
**Inheritance:**
...
Типы расположения данных HIBC PAS.
## Поля

| Поле | Описание |
| --- | --- |
| [ASSET](#ASSET) | K - тип данных актива |
| [BUSINESS_RECORD](#BUSINESS-RECORD) | E - бизнес‑запись |
| [DEVICES_AND_MATERIALS](#DEVICES-AND-MATERIALS) | H - устройства и материалы |
| [DIRECT_PATIENT_IMAGE_ITEM](#DIRECT-PATIENT-IMAGE-ITEM) | D - элемент прямого изображения пациента |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IDENTIFICATION_CARD](#IDENTIFICATION-CARD) | I - удостоверение личности |
| [LIBRARY_REFERENCE_MATERIAL](#LIBRARY-REFERENCE-MATERIAL) | G - справочный материал библиотеки |
| [MEDICAL_ADMINISTRATION_RECORD](#MEDICAL-ADMINISTRATION-RECORD) | F - медицинская административная запись |
| [PATIENT](#PATIENT) | A - пациент |
| [PATIENT_CARE_RECORD](#PATIENT-CARE-RECORD) | B - запись ухода за пациентом |
| [PRODUCT_CONTAINER](#PRODUCT-CONTAINER) | J - контейнер продукта |
| [SPECIMEN_CONTAINER](#SPECIMEN-CONTAINER) | C - контейнер образца |
| [SURGICAL_INSTRUMENT](#SURGICAL-INSTRUMENT) | L - хирургический инструмент |
| [USER_DEFINED](#USER-DEFINED) | Z - пользовательский |
## Методы
...
D - элемент прямого изображения пациента
...
G - справочный материал библиотеки
...
F - медицинская административная запись
