...
type: docs
weight: 37
url: /ru/androidjava/com.aspose.barcode.barcoderecognition/multidecodetype/
---
**Inheritance:**
...
Этот пример показывает, как создать составные типы MultiDecode, которые комбинируют SingleDecodeType и MultiDecode.
...
| --- | --- |
| [MultiDecodeType(SingleDecodeType[] barcodeTypes)](#MultiDecodeType-com.aspose.barcode.barcoderecognition.SingleDecodeType...-) | Инициализирует новый экземпляр класса MultiDecodeType. |
| [MultiDecodeType(BaseDecodeType[] barcodeTypes)](#MultiDecodeType-com.aspose.barcode.barcoderecognition.BaseDecodeType...-) | Инициализирует новый экземпляр класса MultiDecodeType. |
## Методы
...
Инициализирует новый экземпляр класса MultiDecodeType.
