...
description: Основные параметры декодирования BarCode.
type: docs
weight: 20
url: /ru/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | Включить проверку контрольной суммы во время распознавания для 1D и почтовых штрих‑кодов. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | Включить проверку контрольной суммы во время распознавания для 1D и почтовых штрих‑кодов. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | Включить проверку контрольной суммы во время распознавания для 1D и почтовых штрих‑кодов. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
