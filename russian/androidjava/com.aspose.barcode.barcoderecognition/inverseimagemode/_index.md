...
type: docs
weight: 57
url: /ru/androidjava/com.aspose.barcode.barcoderecognition/inverseimagemode/
---
**Inheritance:**
...
| Поле | Описание |
| --- | --- |
| [AUTO](#AUTO) | Отключает дополнительное распознавание штрих‑кодов на инвертированных изображениях для всех типов штрих‑кодов, кроме QR Code. |
| [DISABLED](#DISABLED) | Отключает дополнительное распознавание штрих‑кодов на инвертированных изображениях. |
| [ENABLED](#ENABLED) | Включает дополнительное распознавание штрих‑кодов на инвертированных изображениях. |
## Методы
...
Отключает дополнительное распознавание штрих‑кодов на инвертированных изображениях для всех типов штрих‑кодов, кроме QR Code.
...
Отключает дополнительное распознавание штрих‑кодов на инвертированных изображениях.
...
Включает дополнительное распознавание штрих‑кодов на инвертированных изображениях.
