...
description: Внутренний класс, связанный с отрисовкой области распознавания
type: docs
weight: 10
url: /ru/androidjava/com.aspose.barcode.component.barcodescanner.recognitionareaview/recognitionmarkerview/
---
**Inheritance:**
...
Внутренний класс, связанный с отрисовкой области распознавания
## Конструкторы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| полотно | android.graphics.Canvas |  |
