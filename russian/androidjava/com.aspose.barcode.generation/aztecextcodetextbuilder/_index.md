...
type: docs
weight: 11
url: /ru/androidjava/com.aspose.barcode.generation/aztecextcodetextbuilder/
---
**Inheritance:**
...
Генератор расширенного кодтекста для штрихкодов Aztec в режиме ExtendedCodetext режима AztecEncodeMode

Используйте свойство TwoDDisplayText объекта BarcodeGenerator, чтобы установить видимый текст, удаляя управляющие символы.
