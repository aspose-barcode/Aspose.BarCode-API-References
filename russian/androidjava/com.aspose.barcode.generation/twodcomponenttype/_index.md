...
description: Тип 2D‑компонента  Этот пример показывает, как создать и сохранить изображение GS1 Composite Bar.
type: docs
weight: 110
url: /ru/androidjava/com.aspose.barcode.generation/twodcomponenttype/
---
**Inheritance:**
...
Автоматический выбор типа 2D‑компонента
...
Тип CC-A 2D-компонента. Это структурный вариант MicroPDF417
...
Тип CC-B 2D-компонента. Это символ MicroPDF417.
...
Тип CC-C 2D-компонента. Это символ PDF417.
