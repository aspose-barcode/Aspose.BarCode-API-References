...
description: Расширенный генератор кодового текста для штрихкодов MaxiCode в режиме ExtendedCodetext режима MaxiCodeEncodeMode. Используйте свойство TwoDDisplayText класса BarcodeGenerator, чтобы установить видимый текст, удаляя управляющие символы.
type: docs
weight: 55
url: /ru/androidjava/com.aspose.barcode.generation/maxicodeextcodetextbuilder/
---
**Inheritance:**
...
Генератор расширенного текста кода для штрих‑кодов MaxiCode в режиме ExtendedCodetext режима MaxiCodeEncodeMode. Используйте свойство TwoDDisplayText объекта BarcodeGenerator, чтобы установить видимый текст, удаляя управляющие символы. Этот пример показывает, как использовать MaxiCodeExtCodetextBuilder в расширенном режиме.
