...
description: Тип кодирования символьной системы.
type: docs
weight: 67
url: /ru/androidjava/com.aspose.barcode.generation/symbologyencodetype/
---
**Inheritance:**
...
Тип кодирования символьного набора. См. EncodeTypes для получения экземпляра.
