...
description: Указывает начальный или конечный символ спецификации штрихкода Codabar.
type: docs
weight: 23
url: /ru/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
Указывает начальный или конечный символ спецификации штрихкода Codabar.
## Поля

| Поле | Описание |
| --- | --- |
| [A](#A) | Указывает символ A как начальный или конечный символ спецификации штрих‑кода Codabar. |
| [B](#B) | Указывает символ B как начальный или конечный символ спецификации штрих‑кода Codabar. |
| [C](#C) | Указывает символ C как начальный или конечный символ спецификации штрих‑кода Codabar. |
| [D](#D) | Указывает символ D как начальный или конечный символ спецификации штрих‑кода Codabar. |
...
Указывает символ A как начальный или конечный символ спецификации штрих‑кода Codabar.
...
Указывает символ B как начальный или конечный символ спецификации штрих‑кода Codabar.
...
Указывает символ C как начальный или конечный символ спецификации штрих‑кода Codabar.
...
Указывает символ D как начальный или конечный символ спецификации штрих‑кода Codabar.
