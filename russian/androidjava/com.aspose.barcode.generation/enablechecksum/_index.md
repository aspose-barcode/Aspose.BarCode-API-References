...
description: Включить контрольную сумму при генерации 1D штрихкодов.
type: docs
weight: 86
url: /ru/androidjava/com.aspose.barcode.generation/enablechecksum/
---
**Inheritance:**
...
Включить контрольную сумму при генерации 1D штрихкодов.
...
| [YES](#YES) | Всегда используйте контрольную сумму, если это возможно. |
## Методы
...
Всегда используйте контрольную сумму, если это возможно.
