...
description: Классификация EncodeTypes
type: docs
weight: 76
url: /ru/androidjava/com.aspose.barcode.generation/barcodeclassifications/
---
**Inheritance:**
...
Классификация EncodeTypes
## Поля

| Поле | Описание |
| --- | --- |
| [COUPON](#COUPON) | Указывает COUPON-barcode |
| [DATABAR](#DATABAR) | Указывает DataBar-barcode |
| [NONE](#NONE) | Неуказанная классификация |
| [POSTAL](#POSTAL) | Указывает POSTAL-barcode |
| [TYPE_1D](#TYPE-1D) | Указывает 1D-barcode |
| [TYPE_2D](#TYPE-2D) | Указывает 2D-barcode |
## Методы
