...
description: Используется, чтобы сообщить кодировщику, следует ли добавить кодовое слово 922 Macro PDF417 Terminator в сегмент.
type: docs
weight: 101
url: /ru/androidjava/com.aspose.barcode.generation/pdf417macroterminator/
---
**Inheritance:**
...
| Поле | Описание |
| --- | --- |
| [AUTO](#AUTO) | Терминатор будет добавлен автоматически, если указано количество сегментов и текущий сегмент является последним. |
| [NONE](#NONE) | Терминатор не будет добавлен. |
| [SET](#SET) | Терминатор будет добавлен. |
## Методы
...
Терминатор будет добавлен автоматически, если указано количество сегментов и текущий сегмент является последним. В остальных случаях терминатор не будет добавлен.
