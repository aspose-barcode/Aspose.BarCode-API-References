...
description: Идентификаторы расширенной интерпретации канала.
type: docs
weight: 37
url: /ru/androidjava/com.aspose.barcode.generation/eciencodings/
---
**Inheritance:**
...
Идентификаторы Extended Channel Interpretation. Используется для передачи считывателю штрих‑кода деталей о используемых ссылках для кодирования данных в символе.
