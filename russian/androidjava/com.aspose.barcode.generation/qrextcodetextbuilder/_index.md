...
description: Расширенный генератор кодового текста для 2D QR штрихкодов в режиме ExtendedCodetext режима QrEncodeMode. Используйте свойство TwoDDisplayText класса BarcodeGenerator, чтобы установить видимый текст, удаляя управляющие символы.
type: docs
weight: 63
url: /ru/androidjava/com.aspose.barcode.generation/qrextcodetextbuilder/
---
**Inheritance:**
...
Генератор расширенного кодтекста для двумерных QR‑штрихкодов в режиме ExtendedCodetext режима QrEncodeMode. Используйте свойство TwoDDisplayText класса BarcodeGenerator, чтобы задать видимый текст, удаляя управляющие символы. Этот пример показывает, как использовать FNC1 в первой позиции в расширенном режиме:
...
//generate BarcodeGenerator
generator = new BarcodeGenerator(EncodeTypes.QR);
generator.getParameters().getBarcode().getQR().setEncodeMode(QREncodeMode.ExtendedCodetext);
generator.getParameters().getBarcode().getQR().setErrorLevel(QRErrorLevel.LevelL);
generator.setCodeText(lCodetext);
...
| [addFNC1FirstPosition()](#addFNC1FirstPosition--) | Добавляет FNC1 в первую позицию к элементам расширенного кодтекста |
| [addFNC1GroupSeparator()](#addFNC1GroupSeparator--) | Добавляет разделитель группы (GS - '\\\\u001D') к элементам расширенного кодтекста |
| [addFNC1SecondPosition(String codetext)](#addFNC1SecondPosition-java.lang.String-) | Добавляет FNC1 во вторую позицию к элементам расширенного кодтекста |
...
Добавляет FNC1 в первую позицию к элементам расширенного кодтекста
...
Добавляет разделитель группы (GS - '\\\\u001D') к элементам расширенного кодтекста
...
Добавляет FNC1 во вторую позицию к элементам расширенного кодтекста

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| codetext | java.lang.String | Значение FNC1 во второй позиции |
