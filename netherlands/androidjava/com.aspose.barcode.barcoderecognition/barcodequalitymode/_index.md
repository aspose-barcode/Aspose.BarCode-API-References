...
type: docs
weight: 51
url: /nl/androidjava/com.aspose.barcode.barcoderecognition/barcodequalitymode/
---
**Inheritance:**
...
| Veld | Beschrijving |
| --- | --- |
| [HIGH](#HIGH) | Schakelt herkenningsmethoden in voor barcodes van hoge kwaliteit. |
| [LOW](#LOW) | Schakelt herkenningsmethoden in voor barcodes van lage kwaliteit. |
| [NORMAL](#NORMAL) | Schakelt herkenningsmethoden in voor barcodes van gewone (normale) kwaliteit. |
## Methods
...
Schakelt herkenningsmethoden in voor barcodes van hoge kwaliteit.
...
Schakelt herkenningsmethoden in voor barcodes van lage kwaliteit.
...
Schakelt herkenningsmethoden in voor barcodes van gewone (normale) kwaliteit.
