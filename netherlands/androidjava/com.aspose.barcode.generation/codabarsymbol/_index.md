...
description: Specificeert het start- of stopsymbool van de Codabar-barcode-specificatie.
type: docs
weight: 23
url: /nl/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
Specificeert het start- of stopsymbool van de Codabar-barcode-specificatie.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [A](#A) | Specificeert teken A als het start- of stopsymbool van de Codabar-barcode-specificatie. |
| [B](#B) | Specificeert teken B als het start- of stopsymbool van de Codabar-barcode-specificatie. |
| [C](#C) | Specificeert teken C als het start- of stopsymbool van de Codabar-barcode-specificatie. |
| [D](#D) | Specificeert teken D als het start- of stopsymbool van de Codabar-barcode-specificatie. |
...
Specificeert teken A als het start- of stopsymbool van de Codabar-barcode-specificatie.
...
Specificeert teken B als het start- of stopsymbool van de Codabar-barcode-specificatie.
...
Specificeert teken C als het start- of stopsymbool van de Codabar-barcode-specificatie.
...
Specificeert teken D als het start- of stopsymbool van de Codabar-barcode-specificatie.
