...
description: Coderingsmodus voor Code128-barcode.
type: docs
weight: 80
url: /nl/androidjava/com.aspose.barcode.generation/code128encodemode/
---
**Inheritance:**
...
Coderingsmodus voor Code128-barcode.  Code 128 specificatie.
...
| Veld | Beschrijving |
| --- | --- |
| [AUTO](#AUTO) | Codeer codetekst in klassieke ISO 15417-modus. |
| [CODE_A](#CODE-A) | Codeer codetekst alleen in 128A-codeset. |
| [CODE_AB](#CODE-AB) | Codeer codetekst alleen in 128A- en 128B-codesets. |
| [CODE_AC](#CODE-AC) | Codeer codetekst alleen in 128A- en 128C-codesets. |
| [CODE_B](#CODE-B) | Codeer codetekst alleen in 128B-codeset. |
| [CODE_BC](#CODE-BC) | Codeer codetekst alleen in 128B- en 128C-codesets. |
| [CODE_C](#CODE-C) | Codeer codetekst alleen in 128C-codeset. |
## Methods
...
Codeer codetekst in klassieke ISO 15417-modus. De modus moet in alle gewone gevallen worden gebruikt.
...
Codeer codetekst alleen in 128A-codeset.
...
Codeer codetekst alleen in 128A- en 128B-codesets.
...
Codeer codetekst alleen in 128A- en 128C-codesets.
...
Codeer codetekst alleen in 128B-codeset.
...
Codeer codetekst alleen in 128B- en 128C-codesets.
...
Codeer codetekst alleen in 128C-codeset.
