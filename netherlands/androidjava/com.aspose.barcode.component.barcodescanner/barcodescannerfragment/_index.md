...
description: Fragment voor barcodeherkenning.
type: docs
weight: 14
url: /nl/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment voor herkenning van barcodes. Deze fragment kan worden geplaatst in een aangepaste Activity of in FragmentContainerView en wordt gebruikt voor het scannen en herkennen van barcodes.

Voorbeeld

Voorbeeld van fragmentlay-out

Java code

// Initialiseren van BarcodeScannerFragment // Het kan worden gedaan met behulp van een resourcebestand of programmatisch/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Koppelen van BarcodeScannerFragment aan aangepaste lay-out // Het zal de grootte van de bovenliggende container innemen requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings-voorkeuren moeten worden geïnitialiseerd na het koppelen van BarcodeScannerFragment aan de bovenliggende activiteit. // BarcodeScannerFragmentPreferencesHandler wordt aangeroepen na de BarcodeScannerFragment.onCreate() methode barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Standaardconstructor |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Stelt de BarcodeScannerFragmentPreferencesHandler in die kan worden aangeroepen na de BarcodeScannerFragment.onViewCreated() methode |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Intern? Is toon voorkeurenknop, voor BarcodeScanner altijd false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Stelt een aangepaste implementatie van PreferencesFragment in. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Stelt toon voorkeurenknop in, voor BarcodeScanner altijd false |
...
Stelt de BarcodeScannerFragmentPreferencesHandler in die kan worden aangeroepen na de BarcodeScannerFragment.onViewCreated() methode
...
TODO Intern? Is toon voorkeurenknop, voor BarcodeScanner altijd false
...
Stelt een aangepaste implementatie van PreferencesFragment in.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Kan worden aangeroepen vóór het starten van het herkenningsproces in BarcodeScannerFragment. |
...
Stelt toon voorkeurenknop in, voor BarcodeScanner altijd false
