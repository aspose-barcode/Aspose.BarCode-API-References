...
description: 宏字符 05 和 06 值用于在特殊模式下获得更紧凑的编码 05 宏字符被翻译为gtu001E05u001D作为解码数据头u001Eu0004作为解码数据尾 06 宏字符被翻译为gtu001E06u001D作为解码数据头u001Eu0004作为解码数据尾
type: docs
weight: 790
...
宏字符 05 和 06 值用于在特殊模式下获得更紧凑的编码。 05 宏字符被翻译为“[)&gt;\u001E05\u001D”作为解码数据头，“\u001E\u0004”作为解码数据尾。 06 宏字符被翻译为“[)&gt;\u001E06\u001D”作为解码数据头，“\u001E\u0004”作为解码数据尾。
