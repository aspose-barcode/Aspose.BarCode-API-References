...
description: BarCodeGeneratorControl 是一个 WPF 控件可以在 WPF 窗口或页面中使用
type: docs
weight: 1030
url: /zh/net/aspose.barcode.wpf/barcodegeneratorelement/
---
## BarcodeGeneratorElement class

BarCodeGeneratorControl 是一个 WPF 控件，可以在 WPF 窗口或页面中使用。
...
| 姓名 | 描述 |
| --- | --- |
| [BarcodeGeneratorElement](barcodegeneratorelement)() | 默认构造函数。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AustralianPostEncodingTable](../../aspose.barcode.wpf/barcodegeneratorelement/australianpostencodingtable) { get; set; } | AustralianPost 编码表。 |
| [AustralianPostShortBarHeight](../../aspose.barcode.wpf/barcodegeneratorelement/australianpostshortbarheight) { get; set; } | AustralianPost 短条高度（以像素为单位）。 |
| [AutoSizeMode](../../aspose.barcode.wpf/barcodegeneratorelement/autosizemode) { get; set; } | 指定不同类型的自动调整大小模式。 |
| [AztecAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/aztecaspectratio) { get; set; } | 纵横比。 |
| [AztecCodeTextEncoding](../../aspose.barcode.wpf/barcodegeneratorelement/azteccodetextencoding) { get; set; } | 文本编码。 |
| [AztecErrorLevel](../../aspose.barcode.wpf/barcodegeneratorelement/aztecerrorlevel) { get; set; } | 错误级别。 |
| [AztecSymbolMode](../../aspose.barcode.wpf/barcodegeneratorelement/aztecsymbolmode) { get; set; } | Aztec 符号模式。 |
| [BackColor](../../aspose.barcode.wpf/barcodegeneratorelement/backcolor) { get; set; } | 条形码图像的背景颜色。 |
| [BarColor](../../aspose.barcode.wpf/barcodegeneratorelement/barcolor) { get; set; } | 条形颜色。 |
| [BarHeight](../../aspose.barcode.wpf/barcodegeneratorelement/barheight) { get; set; } | 一维条码条的高度（以像素为单位）。在 AutoSizeMode.Nearest 和 AutoSizeMode.Interpolation 模式中被忽略。 |
| [BorderColor](../../aspose.barcode.wpf/barcodegeneratorelement/bordercolor) { get; set; } | 边框颜色。 |
| [BorderDashStyle](../../aspose.barcode.wpf/barcodegeneratorelement/borderdashstyle) { get; set; } | 边框破折号样式。 |
| [BorderVisible](../../aspose.barcode.wpf/barcodegeneratorelement/bordervisible) { get; set; } | 边界可见性。 |
| [BorderWidth](../../aspose.barcode.wpf/barcodegeneratorelement/borderwidth) { get; set; } | 边框宽度（以像素为单位）。 |
| [CaptionAboveAlignment](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovealignment) { get; set; } | 对齐上方的标题。 |
| [CaptionAboveFontFamily](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovefontfamily) { get; set; } | 字体系列上方的标题。 |
| [CaptionAboveFontSize](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovefontsize) { get; set; } | 字体大小以上的标题。 |
| [CaptionAboveNoWrap](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovenowrap) { get; set; } | 在文本中指定自动换行（换行）。 |
| [CaptionAbovePadding](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovepadding) { get; set; } | 填充上方的标题。 |
| [CaptionAboveText](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovetext) { get; set; } | 说明文字。 |
| [CaptionAboveTextColor](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovetextcolor) { get; set; } | 文字颜色上方的标题。 |
| [CaptionAboveVisible](../../aspose.barcode.wpf/barcodegeneratorelement/captionabovevisible) { get; set; } | 可见性上方的标题。 |
| [CaptionBelowAlignment](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowalignment) { get; set; } | 对齐下方的标题。 |
| [CaptionBelowFontFamily](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowfontfamily) { get; set; } | 字体系列下方的标题。 |
| [CaptionBelowFontSize](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowfontsize) { get; set; } | 低于字体大小的标题。 |
| [CaptionBelowNoWrap](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelownowrap) { get; set; } | 在文本中指定自动换行（换行）。 |
| [CaptionBelowPadding](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowpadding) { get; set; } | 填充下方的标题。 |
| [CaptionBelowText](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowtext) { get; set; } | 说明文字。 |
| [CaptionBelowTextColor](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowtextcolor) { get; set; } | 文字颜色下方的标题。 |
| [CaptionBelowVisible](../../aspose.barcode.wpf/barcodegeneratorelement/captionbelowvisible) { get; set; } | 可见性下方的标题。 |
| [ChecksumAlwaysShow](../../aspose.barcode.wpf/barcodegeneratorelement/checksumalwaysshow) { get; set; } | 始终在 Code128 和 GS1Code128 条形码的人类可读文本中显示校验和数字。 |
| [CodabarChecksumMode](../../aspose.barcode.wpf/barcodegeneratorelement/codabarchecksummode) { get; set; } | 校验和模式。 |
| [CodabarStartSymbol](../../aspose.barcode.wpf/barcodegeneratorelement/codabarstartsymbol) { get; set; } | 开始符号。 |
| [CodabarStopSymbol](../../aspose.barcode.wpf/barcodegeneratorelement/codabarstopsymbol) { get; set; } | 停止符号。 |
| [CodablockAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/codablockaspectratio) { get; set; } | 纵横比。 |
| [CodablockColumns](../../aspose.barcode.wpf/barcodegeneratorelement/codablockcolumns) { get; set; } | 列数。 |
| [CodablockRows](../../aspose.barcode.wpf/barcodegeneratorelement/codablockrows) { get; set; } | 行数。 |
| [Code16KAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/code16kaspectratio) { get; set; } | 纵横比。 |
| [Code16KQuietZoneLeftCoef](../../aspose.barcode.wpf/barcodegeneratorelement/code16kquietzoneleftcoef) { get; set; } | xDimension 中左侧静区的大小。 |
| [Code16KQuietZoneRightCoef](../../aspose.barcode.wpf/barcodegeneratorelement/code16kquietzonerightcoef) { get; set; } | xDimension 中右侧静区的大小。 |
| [Codetext](../../aspose.barcode.wpf/barcodegeneratorelement/codetext) { get; set; } | 需要编码的数据，不同类型的条码可能有不同的Codetext长度限制和不同的charset。 |
| [CodeTextFontFamily](../../aspose.barcode.wpf/barcodegeneratorelement/codetextfontfamily) { get; set; } | Codetext 字体系列。 |
| [CodeTextFontSize](../../aspose.barcode.wpf/barcodegeneratorelement/codetextfontsize) { get; set; } | Codetext 字体大小。 |
| [CodeTextParametersAlignment](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparametersalignment) { get; set; } | 代码文本对齐。 |
| [CodeTextParametersColor](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparameterscolor) { get; set; } | 代码文本颜色。 |
| [CodeTextParametersFontMode](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparametersfontmode) { get; set; } | 指定字体模式。如果 FontMode 设置为 Auto，字体大小将根据 xDimension 值自动计算。 |
| [CodeTextParametersLocation](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparameterslocation) { get; set; } | 代码文本位置。 |
| [CodeTextParametersNoWrap](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparametersnowrap) { get; set; } | 切换“不换行”模式。 |
| [CodeTextParametersSpace](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparametersspace) { get; set; } | CodeText 和 BarCode 之间的间距（以像素为单位）。 |
| [CodeTextParametersTwoDDisplayText](../../aspose.barcode.wpf/barcodegeneratorelement/codetextparameterstwoddisplaytext) { get; set; } | 将显示的文本，而不是二维条码中的代码文本。 |
| [CouponSupplementSpace](../../aspose.barcode.wpf/barcodegeneratorelement/couponsupplementspace) { get; set; } | 条形码和补充像素之间的空间。 |
| [DataBarAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/databaraspectratio) { get; set; } | 纵横比。 |
| [DataBarColumns](../../aspose.barcode.wpf/barcodegeneratorelement/databarcolumns) { get; set; } | DataBar 列数。 |
| [DataBarRows](../../aspose.barcode.wpf/barcodegeneratorelement/databarrows) { get; set; } | DataBar 行数。 |
| [DataMatrixAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/datamatrixaspectratio) { get; set; } | 纵横比。 |
| [DataMatrixCodeTextEncoding](../../aspose.barcode.wpf/barcodegeneratorelement/datamatrixcodetextencoding) { get; set; } | 文本编码。 |
| [DataMatrixColumns](../../aspose.barcode.wpf/barcodegeneratorelement/datamatrixcolumns) { get; set; } | 列数。 |
| [DataMatrixEcc](../../aspose.barcode.wpf/barcodegeneratorelement/datamatrixecc) { get; set; } | Datamatrix ECC 类型。 |
| [DataMatrixEncodeMode](../../aspose.barcode.wpf/barcodegeneratorelement/datamatrixencodemode) { get; set; } | 编码模式。 |
| [DataMatrixRows](../../aspose.barcode.wpf/barcodegeneratorelement/datamatrixrows) { get; set; } | 行数。 |
| [DotCodeAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/dotcodeaspectratio) { get; set; } | 纵横比。 |
| [DotCodeMask](../../aspose.barcode.wpf/barcodegeneratorelement/dotcodemask) { get; set; } | Dotcode 条码掩码。 |
| [EnableEscape](../../aspose.barcode.wpf/barcodegeneratorelement/enableescape) { get; set; } | 指示是否将字符“\”解释为 CodeText 属性中的转义字符。 |
| [EncodeType](../../aspose.barcode.wpf/barcodegeneratorelement/encodetype) { get; set; } | BarCode 的编码类型（符号）。 |
| [FilledBars](../../aspose.barcode.wpf/barcodegeneratorelement/filledbars) { get; set; } | 获取或设置指示条是否填充的值。 |
| [IsChecksumEnabled](../../aspose.barcode.wpf/barcodegeneratorelement/ischecksumenabled) { get; set; } | 在生成一维条码期间启用校验和。 |
| [ITFItfBorderThickness](../../aspose.barcode.wpf/barcodegeneratorelement/itfitfborderthickness) { get; set; } | ITF 边框厚度（以像素为单位）。 |
| [ITFItfBorderType](../../aspose.barcode.wpf/barcodegeneratorelement/itfitfbordertype) { get; set; } | ITF 边框类型。 |
| [ITFQuietZoneCoef](../../aspose.barcode.wpf/barcodegeneratorelement/itfquietzonecoef) { get; set; } | xDimension 中静区的大小。 |
| [MaxiCodeAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/maxicodeaspectratio) { get; set; } | 纵横比。 |
| [MaxiCodeEncodeMode](../../aspose.barcode.wpf/barcodegeneratorelement/maxicodeencodemode) { get; set; } | 编码模式。 |
| [Padding](../../aspose.barcode.wpf/barcodegeneratorelement/padding) { get; set; } | 条码填充。 |
| [PatchCodeExtraBarcodeText](../../aspose.barcode.wpf/barcodegeneratorelement/patchcodeextrabarcodetext) { get; set; } | 在页面模式下生成 PatchCode 时，为额外的 QR 条码指定代码文本。 |
| [PatchCodePatchFormat](../../aspose.barcode.wpf/barcodegeneratorelement/patchcodepatchformat) { get; set; } | PatchCode 格式。选择 PatchOnly 以生成单个 PatchCode。使用页面格式生成以 PatchCodes 为边框的 Patch 页面。 |
| [Pdf417AspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417aspectratio) { get; set; } | 纵横比。 |
| [Pdf417CodeTextEncoding](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417codetextencoding) { get; set; } | 文本编码。 |
| [Pdf417Columns](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417columns) { get; set; } | 列数。 |
| [Pdf417CompactionMode](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417compactionmode) { get; set; } | 压缩模式。 |
| [Pdf417ECIEncoding](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417eciencoding) { get; set; } | ECI 编码。 |
| [Pdf417ErrorLevel](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417errorlevel) { get; set; } | 错误级别。 |
| [Pdf417IsReaderInitialization](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417isreaderinitialization) { get; set; } | 用于指示阅读器将符号中包含的数据解释为阅读器初始化的编程。 |
| [Pdf417MacroFileID](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417macrofileid) { get; set; } | Macro Pdf417 条形码的文件 ID。 |
| [Pdf417MacroSegmentID](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417macrosegmentid) { get; set; } | Macro Pdf417 条码的段 ID。 |
| [Pdf417MacroSegmentsCount](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417macrosegmentscount) { get; set; } | 段数。 |
| [Pdf417Rows](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417rows) { get; set; } | 行数。 |
| [Pdf417Truncate](../../aspose.barcode.wpf/barcodegeneratorelement/pdf417truncate) { get; set; } | 条形码的 Pdf417 符号类型是否被截断（以减少空间）。 |
| [PostalShortBarHeight](../../aspose.barcode.wpf/barcodegeneratorelement/postalshortbarheight) { get; set; } | 邮政短条高度（以像素为单位）。 |
| [QRAspectRatio](../../aspose.barcode.wpf/barcodegeneratorelement/qraspectratio) { get; set; } | 纵横比。 |
| [QRCodeTextEncoding](../../aspose.barcode.wpf/barcodegeneratorelement/qrcodetextencoding) { get; set; } | 文本编码。 |
| [QRECIEncoding](../../aspose.barcode.wpf/barcodegeneratorelement/qreciencoding) { get; set; } | ECI 编码。 |
| [QREncodeMode](../../aspose.barcode.wpf/barcodegeneratorelement/qrencodemode) { get; set; } | 编码模式。 |
| [QREncodeType](../../aspose.barcode.wpf/barcodegeneratorelement/qrencodetype) { get; set; } | 编码类型。 |
| [QRErrorLevel](../../aspose.barcode.wpf/barcodegeneratorelement/qrerrorlevel) { get; set; } | 错误级别。 |
| [QRVersion](../../aspose.barcode.wpf/barcodegeneratorelement/qrversion) { get; set; } | 二维码版本。 |
| [Resolution](../../aspose.barcode.wpf/barcodegeneratorelement/resolution) { get; set; } | 获取或设置条形码图像的分辨率。两个维度的一个值。 |
| [SupplementSupplementData](../../aspose.barcode.wpf/barcodegeneratorelement/supplementsupplementdata) { get; set; } | 补充代码文本。 |
| [SupplementSupplementSpace](../../aspose.barcode.wpf/barcodegeneratorelement/supplementsupplementspace) { get; set; } | 条形码和补充像素之间的空间。 |
| [ThrowExceptionWhenCodeTextIncorrect](../../aspose.barcode.wpf/barcodegeneratorelement/throwexceptionwhencodetextincorrect) { get; set; } | 仅适用于一维条码。如果 codetext 不正确并且值设置为 true - 将引发异常。否则代码文本将被更正以匹配条形码的规范。 |
| [WideNarrowRatio](../../aspose.barcode.wpf/barcodegeneratorelement/widenarrowratio) { get; set; } | 宽条与窄条的比率。 |
| [XDimension](../../aspose.barcode.wpf/barcodegeneratorelement/xdimension) { get; set; } | x-dimension 是条码条或空格单位的最小宽度。在 AutoSizeMode.Nearest 和 AutoSizeMode.Interpolation 模式中被忽略。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [ToString](../../aspose.barcode.wpf/barcodegeneratorelement/tostring)() | BarcodeGenerator 类的字符串表示 |
...
| static [PaddingProperty](../../aspose.barcode.wpf/barcodegeneratorelement/paddingproperty) | 填充属性 |
...
| static [ResolutionProperty](../../aspose.barcode.wpf/barcodegeneratorelement/resolutionproperty) | 分辨率属性 |
...
* 命名空间 [Aspose.BarCode.WPF](../../aspose.barcode.wpf)
* 部件 [Aspose.BarCode](../../)
