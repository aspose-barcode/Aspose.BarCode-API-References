...
type: docs
weight: 11
url: /zh/androidjava/com.aspose.barcode.generation/aztecextcodetextbuilder/
---
**Inheritance:**
...
AztecEncodeMode 的 ExtendedCodetext 模式下用于 Aztec 条码的扩展代码文本生成器

使用 BarcodeGenerator 的 TwoDDisplayText 属性设置可见文本以去除管理字符。
