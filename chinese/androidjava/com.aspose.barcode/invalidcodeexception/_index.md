...
description: 当代码文本中包含无效字符时，将抛出此异常。
type: docs
weight: 15
url: /zh/androidjava/com.aspose.barcode/invalidcodeexception/
---
**Inheritance:**
...
当代码文本中包含无效字符时，将抛出此异常。
## Constructors

| Constructor | 描述 |
| --- | --- |
| [InvalidCodeException()](#InvalidCodeException--) | 初始化该类的新实例。 |
| [InvalidCodeException(String message)](#InvalidCodeException-java.lang.String-) | 使用指定的错误信息初始化 InvalidCodeException 类的新实例。 |
## Methods
