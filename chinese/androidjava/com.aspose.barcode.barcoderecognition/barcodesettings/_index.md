...
description: 主要的 BarCode 解码参数。
type: docs
weight: 20
url: /zh/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | 在识别 1D 和邮政条码时启用校验和验证。 |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | 在识别 1D 和邮政条码时启用校验和验证。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | 在识别 1D 和邮政条码时启用校验和验证。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| 值 | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
