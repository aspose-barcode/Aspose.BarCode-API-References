...
type: docs
weight: 57
url: /zh/androidjava/com.aspose.barcode.barcoderecognition/inverseimagemode/
---
**Inheritance:**
...
| 字段 | 描述 |
| --- | --- |
| [AUTO](#AUTO) | 禁用对除 QR Code 之外的所有条码类型在反相图像上的额外识别。 |
| [DISABLED](#DISABLED) | 禁用在反相图像上对条码的额外识别。 |
| [ENABLED](#ENABLED) | 启用在反相图像上对条码的额外识别 |
## Methods
...
禁用对除 QR Code 之外的所有条码类型在反相图像上的额外识别。
