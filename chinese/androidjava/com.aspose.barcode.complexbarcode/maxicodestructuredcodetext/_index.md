...
description: 用于对嵌入 MaxiCode 代码中模式 2 和 3 的文本进行编码和解码的基类。
type: docs
weight: 32
url: /zh/androidjava/com.aspose.barcode.complexbarcode/maxicodestructuredcodetext/
---
**Inheritance:**
...
用于对模式 2 和 3 中嵌入 MaxiCode 代码的文本进行编码和解码的基类。此示例展示了如何将原始 MaxiCode 代码文本解码为 MaxiCodeStructuredCodetext 实例。
