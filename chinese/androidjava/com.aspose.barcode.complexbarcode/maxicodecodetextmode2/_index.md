...
description: 用于对嵌入 MaxiCode 代码中模式 2 的文本进行编码和解码的类。
type: docs
weight: 26
url: /zh/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode2/
---
**Inheritance:**
...
用于对模式 2 中嵌入的 MaxiCode 代码文本进行编码和解码的类。此示例展示了如何对模式 2 的 MaxiCode 编码文本进行编码和解码。
