...
description: HIBC PAS 数据位置类型。
type: docs
weight: 19
url: /zh/androidjava/com.aspose.barcode.complexbarcode/hibcpasdatalocation/
---
**Inheritance:**
...
| 字段 | 描述 |
| --- | --- |
| [ASSET](#ASSET) | K - 资产数据类型 |
| [BUSINESS_RECORD](#BUSINESS-RECORD) | E - 业务记录 |
| [DEVICES_AND_MATERIALS](#DEVICES-AND-MATERIALS) | H - 设备和材料 |
| [DIRECT_PATIENT_IMAGE_ITEM](#DIRECT-PATIENT-IMAGE-ITEM) | D - 直接患者图像项目 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IDENTIFICATION_CARD](#IDENTIFICATION-CARD) | I - 身份证件 |
| [LIBRARY_REFERENCE_MATERIAL](#LIBRARY-REFERENCE-MATERIAL) | G - 图书馆参考材料 |
| [MEDICAL_ADMINISTRATION_RECORD](#MEDICAL-ADMINISTRATION-RECORD) | F - 医疗管理记录 |
| [PATIENT](#PATIENT) | A - 患者 |
| [PATIENT_CARE_RECORD](#PATIENT-CARE-RECORD) | B - 患者护理记录 |
| [PRODUCT_CONTAINER](#PRODUCT-CONTAINER) | J - 产品容器 |
| [SPECIMEN_CONTAINER](#SPECIMEN-CONTAINER) | C - 标本容器 |
| [SURGICAL_INSTRUMENT](#SURGICAL-INSTRUMENT) | L - 外科仪器 |
| [USER_DEFINED](#USER-DEFINED) | Z - 用户自定义 |
## Methods
