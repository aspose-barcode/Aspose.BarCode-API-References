...
description: PreferencesFragment 可用于使用自定义 GUI 定制条码识别过程。
type: docs
weight: 17
url: /zh/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment 可以用于使用自定义 GUI 定制条形码识别过程。PreferencesFragment 可以实现为自定义类，并且可以通过 BarcodeRecognitionSettings.setPreferencesFragment() 方法附加到 BarcodeScannerFragment。
## Constructors
