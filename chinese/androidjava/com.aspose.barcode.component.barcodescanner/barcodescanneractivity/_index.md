...
description: 包含 BarcodeScannerFragment 的 Activity。它是内部类，客户端不应调用此类，但客户端应在 AndroidManifest.xml 中注册 BarcodeScannerActivity。
type: docs
weight: 13
url: /zh/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
包含 BarcodeScannerFragment 的 Activity。它是内部类，客户端不应调用此类，但客户端应在 AndroidManifest.xml 中注册 BarcodeScannerActivity。
## Constructors
