...
description: 用于条码识别的 Fragment。
type: docs
weight: 14
url: /zh/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
用于识别条形码的 Fragment。此 Fragment 可以放置在自定义 Activity 中或放在 FragmentContainerView 中，用于条形码的扫描和识别。
...
// 初始化 BarcodeScannerFragment // 它可以使用资源文件或以编程方式创建/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// 将 BarcodeScannerFragment 附加到自定义布局 // 它将占据父容器的大小 requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // 在将 BarcodeScannerFragment 附加到父活动后，应初始化 BarcodeRecognitionSettings 首选项。 // 在调用 BarcodeScannerFragment.onCreate() 方法后，将调用 BarcodeScannerFragmentPreferencesHandler barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | 描述 |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | 默认构造函数 |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | 设置 BarcodeScannerFragmentPreferencesHandler，可在 BarcodeScannerFragment.onViewCreated() 方法后调用 |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO 内部？显示首选项按钮，对 BarcodeScanner 始终为 false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | 设置 PreferencesFragment 的自定义实现。 |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | 设置显示首选项按钮，对 BarcodeScanner 始终为 false |
...
设置 BarcodeScannerFragmentPreferencesHandler，可在 BarcodeScannerFragment.onViewCreated() 方法后调用
...
TODO 内部？显示首选项按钮，对 BarcodeScanner 始终为 false
...
设置 PreferencesFragment 的自定义实现。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | 可在 BarcodeScannerFragment 中启动识别过程之前调用。 |
...
设置显示首选项按钮，对 BarcodeScanner 始终为 false
