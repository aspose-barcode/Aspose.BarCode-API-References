...
description: Fragment för streckkodigenkänning.
type: docs
weight: 14
url: /sv/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment för igenkänning av streckkoder. Detta fragment kan placeras i en anpassad Activity eller i en FragmentContainerView och användas för skanning och igenkänning av streckkoder.

Exempel

Exempel på fragmentlayout

Java-kod

// Initiering av BarcodeScannerFragment // Den kan skapas med resursfil eller programatiskt/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Fäster BarcodeScannerFragment till anpassad layout // Den kommer att ta storleken på föräldrakontainern requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings-preferenser bör initieras efter att BarcodeScannerFragment har fästs till föräldraaktiviteten. // BarcodeScannerFragmentPreferencesHandler kommer att anropas efter BarcodeScannerFragment.onCreate()-metoden barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \{
## Constructors
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Ställer in BarcodeScannerFragmentPreferencesHandler som kan anropas efter BarcodeScannerFragment.onViewCreated()-metoden |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Intern? Är visa preferenser-knappen, för BarcodeScanner alltid falsk |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Ställer in en anpassad implementation av PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Ställer in visa preferenser-knappen, för BarcodeScanner alltid falsk |
...
Ställer in BarcodeScannerFragmentPreferencesHandler som kan anropas efter BarcodeScannerFragment.onViewCreated()-metoden
...
TODO Intern? Är visa preferenser-knappen, för BarcodeScanner alltid falsk
...
Ställer in en anpassad implementation av PreferencesFragment.

**Parameters:**
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Kan anropas innan start av igenkänningsprocessen i BarcodeScannerFragment. |
...
Ställer in visa preferenser-knappen, för BarcodeScanner alltid falsk
