...
description: PreferencesFragment kan användas för att anpassa streckkodigenkänningsprocessen med ett anpassat GUI.
type: docs
weight: 17
url: /sv/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment kan användas för att anpassa streckkodens igenkänningsprocess med en anpassad GUI. PreferencesFragment kan implementeras som en anpassad klass och kan bifogas till BarcodeScannerFragment med metoden BarcodeRecognitionSettings.setPreferencesFragment().
## Constructors
