...
description: Avkodningsparametrar för AustraliaPost.
type: docs
weight: 10
url: /sv/androidjava/com.aspose.barcode.barcoderecognition/australiapostsettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getClass()](#getClass--) |  |
| [getCustomerInformationDecoder()](#getCustomerInformationDecoder--) | Publikt gränssnitt för avkodning av Customer Information Field som används i AustraliaPost-symbologi. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCustomerInformationDecoder(AustraliaPostCustomerInformationDecoder value)](#setCustomerInformationDecoder-com.aspose.barcode.barcoderecognition.AustraliaPostCustomerInformationDecoder-) | Publikt gränssnitt för avkodning av Customer Information Field som används i AustraliaPost-symbologi. |
...
Publikt gränssnitt för avkodning av Customer Information Field som används i AustraliaPost-symbologi.
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| value | [CustomerInformationInterpretingType](../../com.aspose.barcode.barcoderecognition/customerinformationinterpretingtype) | Tolkningstypen (CTable, NTable eller Annat) för kundinformation för AustralianPost-streckkod |
