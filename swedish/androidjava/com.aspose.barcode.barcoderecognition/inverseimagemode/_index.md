...
type: docs
weight: 57
url: /sv/androidjava/com.aspose.barcode.barcoderecognition/inverseimagemode/
---
**Inheritance:**
...
| Fält | Beskrivning |
| --- | --- |
| [AUTO](#AUTO) | Inaktiverar ytterligare igenkänning av streckkoder på inversa bilder för alla streckkodstyper förutom QR Code |
| [DISABLED](#DISABLED) | Inaktiverar ytterligare igenkänning av streckkoder på inversa bilder. |
| [ENABLED](#ENABLED) | Aktiverar ytterligare igenkänning av streckkoder på inversa bilder |
## Methods
...
Inaktiverar ytterligare igenkänning av streckkoder på inversa bilder för alla streckkodstyper förutom QR Code
...
Inaktiverar ytterligare igenkänning av streckkoder på inversa bilder.
...
Aktiverar ytterligare igenkänning av streckkoder på inversa bilder
