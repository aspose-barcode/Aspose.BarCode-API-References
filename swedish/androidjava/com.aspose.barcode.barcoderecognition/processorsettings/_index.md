...
description: ProcessorSettings möjliggör att känna igen streckkoder med flerkärnig prestandaförbättring
type: docs
weight: 41
url: /sv/androidjava/com.aspose.barcode.barcoderecognition/processorsettings/
---
**Inheritance:**
java.lang.Object
```
...
ProcessorSettings möjliggör att känna igen streckkoder med flerkärnig prestandaförbättring
...
| [getClass()](#getClass--) |  |
| [getMaxAdditionalAllowedThreads()](#getMaxAdditionalAllowedThreads--) | Ange det maximala antalet extra trådar för att köra kod parallellt |
| [getUseAllCores()](#getUseAllCores--) | Behövs för att använda alla kärnor. |
| [getUseOnlyThisCoresCount()](#getUseOnlyThisCoresCount--) | Ange antalet kärnor som ska användas. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setMaxAdditionalAllowedThreads(int value)](#setMaxAdditionalAllowedThreads-int-) | Ange det maximala antalet extra trådar för att köra kod parallellt |
| [setUseAllCores(boolean value)](#setUseAllCores-boolean-) | Behövs för att använda alla kärnor. |
| [setUseOnlyThisCoresCount(int value)](#setUseOnlyThisCoresCount-int-) | Ange antalet kärnor som ska användas. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ange det maximala antalet extra trådar för att köra kod parallellt
