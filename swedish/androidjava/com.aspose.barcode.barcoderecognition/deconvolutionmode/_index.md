...
type: docs
weight: 55
url: /sv/androidjava/com.aspose.barcode.barcoderecognition/deconvolutionmode/
---
**Inheritance:**
...
| Fält | Beskrivning |
| --- | --- |
| [FAST](#FAST) | Aktiverar snabba dekonvolutionsmetoder för högkvalitativa bilder. |
| [NORMAL](#NORMAL) | Aktiverar normala dekonvolutionsmetoder för vanliga bilder. |
| [SLOW](#SLOW) | Aktiverar långsamma dekonvolutionsmetoder för lågkvalitativa bilder. |
## Methods
...
Aktiverar snabba dekonvolutionsmetoder för högkvalitativa bilder.
...
Aktiverar normala dekonvolutionsmetoder för vanliga bilder.
...
Aktiverar långsamma dekonvolutionsmetoder för lågkvalitativa bilder.
