...
description: Utökad kodtextgenerator för MaxiCode-streckkoder för ExtendedCodetext‑läge i MaxiCodeEncodeMode. Använd TwoDDisplayText‑egenskapen i BarcodeGenerator för att sätta synlig text genom att ta bort hanterande tecken.
type: docs
weight: 55
url: /sv/androidjava/com.aspose.barcode.generation/maxicodeextcodetextbuilder/
---
**Inheritance:**
...
Utökad kodtextgenerator för MaxiCode-streckkoder för ExtendedCodetext-läget i MaxiCodeEncodeMode. Använd TwoDDisplayText-egenskapen i BarcodeGenerator för att ställa in synlig text genom att ta bort styrtecken. Detta exempel visar hur man använder MaxiCodeExtCodetextBuilder i Extended-läget.
