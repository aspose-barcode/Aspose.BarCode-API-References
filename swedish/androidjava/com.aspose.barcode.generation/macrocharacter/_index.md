...
description: Macro-tecken 05 och 06 används för att få en mer kompakt kodning i speciallägen.
type: docs
weight: 94
url: /sv/androidjava/com.aspose.barcode.generation/macrocharacter/
---
**Inheritance:**
...
Macro‑tecken 05 och 06‑värden används för att erhålla en mer kompakt kodning i speciella lägen. 05‑macro‑tecken översätts till "[)>05" som avkodad datakopf och "" som avkodad datakräk. 06‑macro‑tecken översätts till "[)>06" som avkodad datakopf och "" som avkodad datakräk.
...
| Fält | Beskrivning |
| --- | --- |
| [MACRO_05](#MACRO-05) | 05‑macro‑tecken läggs till i streckkoddata på första positionen. |
| [MACRO_06](#MACRO-06) | 06 Makro tecken läggs till i streckkodens data på första positionen. |
| [NONE](#NONE) | Inga makrotecken läggs till i streckkodens data. |
## Methods
...
05 Makro tecken läggs till i streckkodens data på första positionen. GS1-dataidentifierare ISO 15434-tecken översätts till "[)>05" som avkodad datatopp och "" som avkodad datakant.
...
06 Makro tecken läggs till i streckkodens data på första positionen. ASC MH10-dataidentifierare ISO 15434-tecken översätts till "[)>06" som avkodad datatopp och "" som avkodad datakant.
...
Inga makrotecken läggs till i streckkodens data.
