...
type: docs
weight: 86
url: /sv/androidjava/com.aspose.barcode.generation/enablechecksum/
---
**Inheritance:**
...
Kontrollsumma används aldrig: Codabar
...
| Fält | Beskrivning |
| --- | --- |
| [DEFAULT](#DEFAULT) | Om kontrollsumma krävs av specifikationen - kommer den att bifogas. |
| [NO](#NO) | Använd inte kontrollsumma. |
...
Om kontrollsumma krävs av specifikationen - kommer den att bifogas.
