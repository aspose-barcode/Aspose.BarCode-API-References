...
description: Utökad kodtextgenerator för 2D QR-streckkoder för ExtendedCodetext‑läge i QrEncodeMode. Använd TwoDDisplayText‑egenskapen i BarcodeGenerator för att sätta synlig text genom att ta bort hanterande tecken.
type: docs
weight: 63
url: /sv/androidjava/com.aspose.barcode.generation/qrextcodetextbuilder/
---
**Inheritance:**
...
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| codetext | java.lang.String | Värdet av FNC1 i den andra positionen |
