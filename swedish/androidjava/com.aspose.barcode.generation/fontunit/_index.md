...
description: Definierar ett specifikt format för text inklusive teckensnittets storlek och stilattribut där storleken anges i egenskapen Unit value.
type: docs
weight: 44
url: /sv/androidjava/com.aspose.barcode.generation/fontunit/
---
**Inheritance:**
java.lang.Object
```
...
Definierar ett specifikt format för text, inklusive teckensnitt, storlek och stilattribut där storleken i Unit‑värdeegenskapen.
...
| [getClass()](#getClass--) |  |
| [getFamilyName()](#getFamilyName--) | Hämtar teckensnittets namn för detta Font. |
| [getSize()](#getSize--) | Hämtar storleken på detta FontUnit i Unit value. |
| [getStateHash()](#getStateHash--) |  |
| [getStyle()](#getStyle--) | Hämtar stilinformation för detta FontUnit. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setFamilyName(Typeface value)](#setFamilyName-android.graphics.Typeface-) | Ställer in teckensnittets namn för detta Font. |
| [setStyle(int value)](#setStyle-int-) | Ställer in stilinformation för detta FontUnit. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Hämtar storleken på detta FontUnit i Unit value.
...
Hämtar stilinformation för detta FontUnit.
...
Ställer in teckensnittets namn för detta Font.

**Parameters:**
| Parameter | Type | Beskrivning |
| --- | --- | --- |
| värde | android.graphics.Typeface |  |
...
Ställer in stilinformation för detta FontUnit.
