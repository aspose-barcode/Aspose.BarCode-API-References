...
type: docs
weight: 140
url: /sv/net/aspose.barcode.barcoderecognition/checksumvalidation/
---
...
| --- | --- | --- |
| Default | `0` | Om kontrollsumman krävs av specifikationen - kommer den att valideras. |
| On | `1` | Verifiera alltid kontrollsumman om möjligt. |
| Off | `2` | Validera inte kontrollsumman. |
