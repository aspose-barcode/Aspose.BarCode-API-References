...
description: Κλάση για κωδικοποίηση και αποκωδικοποίηση του τυπικού δευτερεύοντος μηνύματος για τον κώδικα MaxiCode barcode.
type: docs
weight: 30
url: /el/androidjava/com.aspose.barcode.complexbarcode/maxicodestandardsecondmessage/
---
**Inheritance:**
...
Κλάση για κωδικοποίηση και αποκωδικοποίηση του τυπικού δευτερεύοντος μηνύματος για τον κώδικα MaxiCode barcode.
## Constructors
...
| [getClass()](#getClass--) |  |
| [getHashCode()](#getHashCode--) | Επιστρέφει τον κωδικό κατακερματισμού για αυτήν την παρουσία. |
