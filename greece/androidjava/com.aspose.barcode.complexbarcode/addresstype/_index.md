...
type: docs
weight: 41
url: /el/androidjava/com.aspose.barcode.complexbarcode/addresstype/
---
**Inheritance:**
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [COMBINED_ELEMENTS](#COMBINED-ELEMENTS) | Συνδυασμένα στοιχεία διεύθυνσης |
| [CONFLICTING](#CONFLICTING) | Αντιφατικό |
| [STRUCTURED](#STRUCTURED) | Δομημένη διεύθυνση |
| [UNDETERMINED](#UNDETERMINED) | Απροσδιόριστο |
## Methods
...
Συνδυασμένα στοιχεία διεύθυνσης
