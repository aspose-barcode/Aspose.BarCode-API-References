...
type: docs
weight: 23
url: /el/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [A](#A) | Καθορίζει τον χαρακτήρα A ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar. |
| [B](#B) | Καθορίζει τον χαρακτήρα B ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar. |
| [C](#C) | Καθορίζει τον χαρακτήρα C ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar. |
| [D](#D) | Καθορίζει τον χαρακτήρα D ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar. |
...
Καθορίζει τον χαρακτήρα A ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar.
...
Καθορίζει τον χαρακτήρα B ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar.
...
Καθορίζει τον χαρακτήρα C ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar.
...
Καθορίζει τον χαρακτήρα D ως το αρχικό ή τελικό σύμβολο της προδιαγραφής barcode Codabar.
