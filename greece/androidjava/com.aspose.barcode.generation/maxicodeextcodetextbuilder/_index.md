...
description: Εκτεταμένος γεννήτρια κωδικού κειμένου για γραμμωτούς κώδικες MaxiCode για τη λειτουργία ExtendedCodetext του MaxiCodeEncodeMode. Χρησιμοποιήστε την ιδιότητα TwoDDisplayText του BarcodeGenerator για να ορίσετε το εμφανιζόμενο κείμενο αφαιρώντας διαχειριστικούς χαρακτήρες.
type: docs
weight: 55
url: /el/androidjava/com.aspose.barcode.generation/maxicodeextcodetextbuilder/
---
**Inheritance:**
