...
type: docs
weight: 43
url: /el/androidjava/com.aspose.barcode.generation/fontstyle/
---
**Inheritance:**
...
| [STRIKEOUT](#STRIKEOUT) | Κείμενο με μια γραμμή στη μέση |
| [UNDERLINE](#UNDERLINE) | Υπογραμμισμένο κείμενο |
## Methods
...
Κείμενο με μια γραμμή στη μέση
