...
description: Λειτουργία κωδικοποίησης για γραμμωτούς κώδικες Aztec.
type: docs
weight: 73
url: /el/androidjava/com.aspose.barcode.generation/aztecencodemode/
---
**Inheritance:**
...
Λειτουργία κωδικοποίησης για γραμμωτούς κώδικες Aztec.
...
| [BYTES](#BYTES) | Κωδικοποιήστε το κείμενο κώδικα ως απλά bytes. |
...
Κωδικοποιήστε το κείμενο κώδικα ως απλά bytes. Εάν εντοπίσει οποιονδήποτε χαρακτήρα Unicode, ο χαρακτήρας θα κωδικοποιηθεί ως δύο bytes, πρώτα το χαμηλότερο byte.
...
Εκτεταμένη λειτουργία που υποστηρίζει πολλαπλές λειτουργίες ECI.

Καλύτερα είναι να χρησιμοποιήσετε το AztecExtCodetextBuilder για τη δημιουργία εκτεταμένου κειμένου κώδικα.
