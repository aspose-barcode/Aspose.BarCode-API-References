...
type: docs
weight: 95
url: /el/androidjava/com.aspose.barcode.generation/maxicodeencodemode/
---
**Inheritance:**
...
Καλύτερο είναι να χρησιμοποιήσετε το MaxiCodeExtCodetextBuilder για τη δημιουργία εκτεταμένου κειμένου κώδικα.
