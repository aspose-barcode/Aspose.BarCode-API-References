...
description: Οι τιμές των Macro Characters 05 και 06 χρησιμοποιούνται για την απόκτηση πιο συμπαγούς κωδικοποίησης σε ειδικές λειτουργίες.
type: docs
weight: 94
url: /el/androidjava/com.aspose.barcode.generation/macrocharacter/
---
**Inheritance:**
...
| [MACRO_06](#MACRO-06) | 06 το Μακροχαρακτήρας προστίθεται στα δεδομένα barcode στην πρώτη θέση. |
| [NONE](#NONE) | Κανένας από τους Μακροχαρακτήρες δεν προστίθεται στα δεδομένα barcode |
## Methods
...
05 το Μακροχαρακτήρας προστίθεται στα δεδομένα barcode στην πρώτη θέση. Ο Αναγνωριστής Δεδομένων GS1 ISO 15434 μεταφράζεται σε "[)>05" ως κεφαλίδα αποκωδικοποιημένων δεδομένων και "" ως τερματικό αποκωδικοποιημένων δεδομένων.
...
06 το Μακροχαρακτήρας προστίθεται στα δεδομένα barcode στην πρώτη θέση. Ο Αναγνωριστής Δεδομένων ASC MH10 ISO 15434 μεταφράζεται σε "[)>06" ως κεφαλίδα αποκωδικοποιημένων δεδομένων και "" ως τερματικό αποκωδικοποιημένων δεδομένων.
...
Κανένας από τους Μακροχαρακτήρες δεν προστίθεται στα δεδομένα barcode
