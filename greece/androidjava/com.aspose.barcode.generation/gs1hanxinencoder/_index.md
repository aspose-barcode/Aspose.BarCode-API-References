...
description: Περιέχει συναρτήσεις για κωδικοποίηση GS1HanXin
type: docs
weight: 47
url: /el/androidjava/com.aspose.barcode.generation/gs1hanxinencoder/
---
**Inheritance:**
...
Περιέχει συναρτήσεις για κωδικοποίηση GS1HanXin
## Constructors
...
| --- | --- | --- |
| παράμετροι | com.aspose.barcode.generation.renderers.barcoderenderers.encoders.parameters.HanXinEncoderParameters |  |
