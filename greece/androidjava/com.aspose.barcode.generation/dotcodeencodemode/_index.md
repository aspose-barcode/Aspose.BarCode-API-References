...
type: docs
weight: 85
url: /el/androidjava/com.aspose.barcode.generation/dotcodeencodemode/
---
**Inheritance:**
...
Καλύτερο είναι να χρησιμοποιήσετε το DotCodeExtCodetextBuilder για τη δημιουργία εκτεταμένου κώδικα κειμένου.
