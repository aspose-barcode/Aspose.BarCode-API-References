...
description: Εσωτερικό Περιέχει το GUI που αποδόθηκε κατά τη διαδικασία αναγνώρισης
type: docs
weight: 26
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessingfragment/
---
**Inheritance:**
...
Εσωτερικό Περιέχει το GUI που αποδόθηκε κατά τη διαδικασία αναγνώρισης
## Constructors
