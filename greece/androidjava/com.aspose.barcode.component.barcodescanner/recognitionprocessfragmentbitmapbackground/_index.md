...
description: Αναπαριστά το φόντο εικόνας που θα αποδοθεί κατά τη διαδικασία αναγνώρισης
type: docs
weight: 23
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentbitmapbackground/
---
**Inheritance:**
...
Αναπαριστά το φόντο εικόνας που θα αποδοθεί κατά τη διαδικασία αναγνώρισης
## Constructors
...
| --- | --- | --- |
| backgroundBitmap | android.graphics.Bitmap | το φόντο της εικόνας που θα εμφανιστεί κατά τη διάρκεια της διαδικασίας αναγνώρισης |
