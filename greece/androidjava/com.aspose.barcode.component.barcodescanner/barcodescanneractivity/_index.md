...
description: Δραστηριότητα που περιέχει το BarcodeScannerFragment. Αυτή είναι εσωτερική κλάση και ο πελάτης δεν πρέπει να καλέσει αυτήν την κλάση, αλλά πρέπει να καταχωρήσει το BarcodeScannerActivity στο AndroidManifest.xml
type: docs
weight: 13
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
Δραστηριότητα που περιέχει το BarcodeScannerFragment. Είναι εσωτερική κλάση και ο πελάτης δεν πρέπει να καλέσει αυτήν την κλάση, αλλά πρέπει να καταχωρήσει το BarcodeScannerActivity στο AndroidManifest.xml.
## Constructors
