...
description: PreferencesFragment μπορεί να χρησιμοποιηθεί για την προσαρμογή της διαδικασίας αναγνώρισης barcode χρησιμοποιώντας προσαρμοσμένο GUI.
type: docs
weight: 17
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment μπορεί να χρησιμοποιηθεί για την προσαρμογή της διαδικασίας αναγνώρισης barcode χρησιμοποιώντας προσαρμοσμένο GUI. PreferencesFragment μπορεί να υλοποιηθεί ως προσαρμοσμένη κλάση και μπορεί να προσαρτηθεί στο BarcodeScannerFragment χρησιμοποιώντας τη μέθοδο BarcodeRecognitionSettings.setPreferencesFragment().
## Constructors
