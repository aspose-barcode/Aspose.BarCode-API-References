...
description: Αναπαριστά το φόντο εικόνας που λαμβάνεται από την κάμερα και θα αποδοθεί κατά τη διαδικασία αναγνώρισης
type: docs
weight: 24
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentcameraphotobackground/
---
**Inheritance:**
...
Αναπαριστά το φόντο εικόνας που λαμβάνεται από την κάμερα και θα αποδοθεί κατά τη διαδικασία αναγνώρισης
## Constructors
