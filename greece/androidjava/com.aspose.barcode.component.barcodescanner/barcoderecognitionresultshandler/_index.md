...
description: Διαχειριστής για την επεξεργασία των αποτελεσμάτων αναγνώρισης. Χρησιμοποιείται στην πλευρά της δραστηριότητας αναγνώρισης.
type: docs
weight: 28
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/barcoderecognitionresultshandler/
---```
