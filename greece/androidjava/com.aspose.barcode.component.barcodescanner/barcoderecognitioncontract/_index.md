...
type: docs
weight: 10
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/barcoderecognitioncontract/
---
**Inheritance:**
...
Εσωτερική BarcodeRecognitionContract απαιτείται για τη ρύθμιση κλήσης του BarcodeScannerActivity από τη δραστηριότητα πελάτη
## Constructors
