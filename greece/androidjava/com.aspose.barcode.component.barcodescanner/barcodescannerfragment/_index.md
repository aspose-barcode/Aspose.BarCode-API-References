...
description: Fragment για την αναγνώριση barcode.
type: docs
weight: 14
url: /el/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment για την αναγνώριση barcode. Αυτό το Fragment μπορεί να τοποθετηθεί μέσα σε προσαρμοσμένη Activity ή σε FragmentContainerView και να χρησιμοποιηθεί για σάρωση και αναγνώριση Barcodes.

Παράδειγμα

Παράδειγμα διάταξης Fragment

Κώδικας Java

// Αρχικοποίηση του BarcodeScannerFragment // Μπορεί να γίνει χρησιμοποιώντας αρχείο πόρων ή προγραμματιστικά/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// Σύνδεση του BarcodeScannerFragment σε προσαρμοσμένη διάταξη // Θα πάρει το μέγεθος του γονικού κοντέινερ requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // Οι προτιμήσεις BarcodeRecognitionSettings πρέπει να αρχικοποιηθούν μετά τη σύνδεση του BarcodeScannerFragment στη γονική δραστηριότητα. // Το BarcodeScannerFragmentPreferencesHandler θα κληθεί μετά τη μέθοδο BarcodeScannerFragment.onCreate() method barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \{
## Constructors

| Constructor | Περιγραφή |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | Προεπιλεγμένος κατασκευαστής |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | Ορίζει το BarcodeScannerFragmentPreferencesHandler που μπορεί να κληθεί μετά τη μέθοδο BarcodeScannerFragment.onViewCreated() |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO Εσωτερικό; Το κουμπί εμφάνισης προτιμήσεων, για το BarcodeScanner είναι πάντα ψευδές |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | Ορίζει μια προσαρμοσμένη υλοποίηση του PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | Ορίζει το κουμπί εμφάνισης προτιμήσεων, για το BarcodeScanner πάντα ψευδές |
...
Ορίζει το BarcodeScannerFragmentPreferencesHandler που μπορεί να κληθεί μετά τη μέθοδο BarcodeScannerFragment.onViewCreated()
...
TODO Εσωτερικό; Το κουμπί εμφάνισης προτιμήσεων, για το BarcodeScanner είναι πάντα ψευδές
...
Ορίζει μια προσαρμοσμένη υλοποίηση του PreferencesFragment.

**Parameters:**
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | Μπορεί να κληθεί πριν από την έναρξη της διαδικασίας αναγνώρισης στο BarcodeScannerFragment. |
...
Ορίζει το κουμπί εμφάνισης προτιμήσεων, για το BarcodeScanner πάντα ψευδές
