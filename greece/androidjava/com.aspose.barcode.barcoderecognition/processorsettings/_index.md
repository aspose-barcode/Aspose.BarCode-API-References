...
description: Οι ProcessorSettings επιτρέπουν την αναγνώριση barcode με πολυνηματική βελτίωση της απόδοσης
type: docs
weight: 41
url: /el/androidjava/com.aspose.barcode.barcoderecognition/processorsettings/
---
**Inheritance:**
java.lang.Object
```
...
Οι ProcessorSettings επιτρέπουν την αναγνώριση barcode με πολυνηματική βελτίωση της απόδοσης
