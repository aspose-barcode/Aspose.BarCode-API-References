...
description: Δημόσια διεπαφή για την αποκωδικοποίηση του πεδίου Customer Information Field που χρησιμοποιείται στη συμβολική γραφή AustraliaPost.
type: docs
weight: 50
url: /el/androidjava/com.aspose.barcode.barcoderecognition/australiapostcustomerinformationdecoder/
---```
