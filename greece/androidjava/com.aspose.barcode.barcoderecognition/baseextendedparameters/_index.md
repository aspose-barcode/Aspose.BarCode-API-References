...
description: Βασική κλάση για την αποθήκευση επεκταμένων παραμέτρων του αναγνωρισμένου barcode
type: docs
weight: 24
url: /el/androidjava/com.aspose.barcode.barcoderecognition/baseextendedparameters/
---
**Inheritance:**
java.lang.Object
```
...
Βασική κλάση για την αποθήκευση επεκταμένων παραμέτρων του αναγνωρισμένου barcode
## Methods
