...
type: docs
weight: 38
url: /el/androidjava/com.aspose.barcode.barcoderecognition/multydecodetype/
---
**Inheritance:**
...
| --- | --- |
| [MultyDecodeType(SingleDecodeType[] barcodeTypes)](#MultyDecodeType-com.aspose.barcode.barcoderecognition.SingleDecodeType...-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [MultyDecodeType](../../com.aspose.barcode.barcoderecognition/multydecodetype). |
| [MultyDecodeType(BaseDecodeType[] barcodeTypes)](#MultyDecodeType-com.aspose.barcode.barcoderecognition.BaseDecodeType...-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [MultyDecodeType](../../com.aspose.barcode.barcoderecognition/multydecodetype). |
## Methods
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [MultyDecodeType](../../com.aspose.barcode.barcoderecognition/multydecodetype).
