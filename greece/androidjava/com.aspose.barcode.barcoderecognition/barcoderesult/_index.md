...
type: docs
weight: 18
url: /el/androidjava/com.aspose.barcode.barcoderecognition/barcoderesult/
---
**Inheritance:**
java.lang.Object
```
...
Αποθηκεύει δεδομένα του αναγνωρισμένου barcode όπως ο τύπος SingleDecodeType, το κείμενο κωδικού string, η περιοχή BarCodeRegionParameters και άλλες παραμέτρους
