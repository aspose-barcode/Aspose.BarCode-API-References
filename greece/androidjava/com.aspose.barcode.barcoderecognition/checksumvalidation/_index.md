...
type: docs
weight: 52
url: /el/androidjava/com.aspose.barcode.barcoderecognition/checksumvalidation/
---
**Inheritance:**
...
Ενεργοποίηση επικύρωσης αθροίσματος ελέγχου κατά την αναγνώριση για γραμμικούς (1D) και ταχυδρομικούς κωδικούς.
...
Το άθροισμα ελέγχου δεν χρησιμοποιείται ποτέ: Codabar, PatchCode, Pharmacode, DataLogic2of5
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [DEFAULT](#DEFAULT) | Εάν το άθροισμα ελέγχου απαιτείται από την προδιαγραφή - θα επικυρωθεί. |
| [OFF](#OFF) | Να μην γίνει επικύρωση του αθροίσματος ελέγχου. |
| [ON](#ON) | Πάντα να επικυρώνεται το άθροισμα ελέγχου εάν είναι δυνατό. |
## Methods
...
Εάν το άθροισμα ελέγχου απαιτείται από την προδιαγραφή - θα επικυρωθεί.
...
Να μην γίνει επικύρωση του αθροίσματος ελέγχου.
...
Πάντα να επικυρώνεται το άθροισμα ελέγχου εάν είναι δυνατό.
