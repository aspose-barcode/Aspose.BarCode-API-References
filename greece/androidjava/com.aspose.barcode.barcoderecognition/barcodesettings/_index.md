...
description: Οι κύριες παράμετροι αποκωδικοποίησης BarCode.
type: docs
weight: 20
url: /el/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | Ενεργοποίηση επικύρωσης αθροίσματος ελέγχου κατά την αναγνώριση για γραμμικούς (1D) και ταχυδρομικούς κωδικούς. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | Ενεργοποίηση επικύρωσης αθροίσματος ελέγχου κατά την αναγνώριση για γραμμικούς (1D) και ταχυδρομικούς κωδικούς. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | Ενεργοποίηση επικύρωσης αθροίσματος ελέγχου κατά την αναγνώριση για γραμμικούς (1D) και ταχυδρομικούς κωδικούς. |
...
| Parameter | Type | Περιγραφή |
| --- | --- | --- |
| τιμή | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
