...
description: Pdf417 바코드 압축 모드.
type: docs
weight: 98
url: /ko/androidjava/com.aspose.barcode.generation/pdf417compactionmode/
---
**Inheritance:**
...
| 필드 | 설명 |
| --- | --- |
| [AUTO](#AUTO) | 자동 감지 압축 모드. |
| [BINARY](#BINARY) | 이진 압축 모드. |
| [NUMERIC](#NUMERIC) | 숫자 압축 모드. |
| [TEXT](#TEXT) | 텍스트 압축. |
## Methods
