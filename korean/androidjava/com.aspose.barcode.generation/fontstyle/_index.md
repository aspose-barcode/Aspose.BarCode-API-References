...
description: 텍스트에 적용되는 스타일 정보를 지정합니다.
type: docs
weight: 43
url: /ko/androidjava/com.aspose.barcode.generation/fontstyle/
---
**Inheritance:**
...
| [ITALIC](#ITALIC) | 기울임 텍스트 |
| [REGULAR](#REGULAR) | 일반 텍스트 |
| [STRIKEOUT](#STRIKEOUT) | 가운데에 선이 그어진 텍스트 |
| [UNDERLINE](#UNDERLINE) | 밑줄이 있는 텍스트 |
## Methods
