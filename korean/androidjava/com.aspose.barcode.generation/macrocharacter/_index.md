...
description: 특수 모드에서 보다 압축된 인코딩을 얻기 위해 매크로 문자 05 및 06 값을 사용합니다.
type: docs
weight: 94
url: /ko/androidjava/com.aspose.barcode.generation/macrocharacter/
---
**Inheritance:**
...
특수 모드에서 더 압축된 인코딩을 얻기 위해 매크로 문자 05와 06 값을 사용합니다. 05 매크로 문자는 디코드된 데이터 헤더를 "[)>\u001e05\u001d" 로, 디코드된 데이터 트레일러를 "\u001e\u0004" 로 변환합니다. 06 매크로 문자는 디코드된 데이터 헤더를 "[)>\u001e06\u001d" 로, 디코드된 데이터 트레일러를 "\u001e\u0004" 로 변환합니다.
...
| 필드 | 설명 |
| --- | --- |
| [MACRO_05](#MACRO-05) | 05 매크로 문자는 바코드 데이터의 첫 번째 위치에 추가됩니다. |
| [MACRO_06](#MACRO-06) | 06 매크로 문자가 바코드 데이터의 첫 번째 위치에 추가됩니다. |
| [NONE](#NONE) | 매크로 문자가 바코드 데이터에 추가되지 않습니다. |
## Methods
...
05 매크로 문자가 바코드 데이터의 첫 번째 위치에 추가됩니다. GS1 데이터 식별자 ISO 15434 문자는 디코드된 데이터 헤더로 "[)>05" 로, 디코드된 데이터 트레일러로 "" 로 변환됩니다.
...
06 매크로 문자가 바코드 데이터의 첫 번째 위치에 추가됩니다. ASC MH10 데이터 식별자 ISO 15434 문자는 디코드된 데이터 헤더로 "[)>06" 로, 디코드된 데이터 트레일러로 "" 로 변환됩니다.
