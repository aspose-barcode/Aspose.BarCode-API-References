...
description: GS1HanXin 인코딩을 위한 기능을 포함합니다.
type: docs
weight: 47
url: /ko/androidjava/com.aspose.barcode.generation/gs1hanxinencoder/
---
**Inheritance:**
...
GS1HanXin 인코딩을 위한 기능을 포함합니다.
## Constructors

| Constructor | 설명 |
| --- | --- |
| [GS1HanXinEncoder(HanXinEncoderParameters parameters)](#GS1HanXinEncoder-com.aspose.barcode.generation.renderers.barcoderenderers.encoders.parameters.HanXinEncoderParameters-) | 입력 데이터는 모드 구분자로 괄호 ()만 사용해야 하며, 예: (01)12345678901231(21)ASPOSE(30)9876. GS1 사양에 따르면, 모든 사전 정의된 길이의 GS1 데이터 문자열 뒤에는 사전 정의되지 않은 길이의 GS1 데이터 문자열이 와야 합니다. |
## Methods
...
입력 데이터는 모드 구분자로 괄호 ()만 사용해야 하며, 예: (01)12345678901231(21)ASPOSE(30)9876. GS1 사양에 따르면, 모든 사전 정의된 길이의 GS1 데이터 문자열 뒤에는 사전 정의되지 않은 길이의 GS1 데이터 문자열이 와야 합니다.
