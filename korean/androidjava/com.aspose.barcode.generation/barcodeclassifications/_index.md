...
description: EncodeTypes 분류
type: docs
weight: 76
url: /ko/androidjava/com.aspose.barcode.generation/barcodeclassifications/
---
**Inheritance:**
...
| 필드 | 설명 |
| --- | --- |
| [COUPON](#COUPON) | COUPON 바코드를 지정합니다 |
| [DATABAR](#DATABAR) | DataBar 바코드를 지정합니다 |
| [NONE](#NONE) | 지정되지 않은 분류 |
| [POSTAL](#POSTAL) | POSTAL 바코드를 지정합니다 |
| [TYPE_1D](#TYPE-1D) | 1D 바코드를 지정합니다 |
| [TYPE_2D](#TYPE-2D) | 2D 바코드를 지정합니다 |
## Methods
