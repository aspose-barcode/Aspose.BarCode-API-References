...
type: docs
weight: 56
url: /ko/androidjava/com.aspose.barcode.generation/maxicodemode/
---
**Inheritance:**
...
MaxiCode 바코드의 인코딩 모드입니다. 이 샘플은 ComplexBarcodeGenerator를 사용하여 MaxiCode 바코드를 생성하는 방법을 보여줍니다.
...
| [MODE_2](#MODE-2) | 모드 2는 첫 번째 메시지에 우편 정보를, 두 번째 메시지에 데이터를 인코딩합니다. |
| [MODE_3](#MODE-3) | 모드 3은 첫 번째 메시지에 우편 정보를, 두 번째 메시지에 데이터를 인코딩합니다. |
| [MODE_4](#MODE-4) | 모드 4는 첫 번째와 두 번째 메시지에 데이터를 인코딩하며, 짧은 ECC 보정을 사용합니다. |
| [MODE_5](#MODE-5) | 모드 5는 첫 번째와 두 번째 메시지에 데이터를 인코딩하며, 긴 ECC 보정을 사용합니다. |
| [MODE_6](#MODE-6) | 모드 6은 첫 번째와 두 번째 메시지에 데이터를 인코딩하고, 짧은 ECC 보정을 적용합니다. |
## Methods
...
모드 2는 첫 번째 메시지에 우편 정보를, 두 번째 메시지에 데이터를 인코딩합니다. 9자리 우편 번호를 사용합니다(미국에서만 사용).
...
모드 3은 첫 번째 메시지에 우편 정보를, 두 번째 메시지에 데이터를 인코딩합니다. 전 세계에서 사용되는 6자리 영숫자 우편 번호를 사용합니다.
...
모드 4는 첫 번째와 두 번째 메시지에 데이터를 인코딩하며, 짧은 ECC 보정을 사용합니다.
...
모드 5는 첫 번째와 두 번째 메시지에 데이터를 인코딩하며, 긴 ECC 보정을 사용합니다.
...
모드 6은 첫 번째와 두 번째 메시지에 데이터를 인코딩하고, 짧은 ECC 보정을 적용합니다. 장치를 인코딩하는 데 사용됩니다.
