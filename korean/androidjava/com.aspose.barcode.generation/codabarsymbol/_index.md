...
description: Codabar 바코드 사양의 시작 또는 종료 기호를 지정합니다.
type: docs
weight: 23
url: /ko/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
Codabar 바코드 사양의 시작 또는 종료 기호를 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [A](#A) | Codabar 바코드 사양에서 문자 A를 시작 또는 정지 기호로 지정합니다. |
| [B](#B) | Codabar 바코드 사양에서 문자 B를 시작 또는 정지 기호로 지정합니다. |
| [C](#C) | Codabar 바코드 사양에서 문자 C를 시작 또는 정지 기호로 지정합니다. |
| [D](#D) | Codabar 바코드 사양에서 문자 D를 시작 또는 정지 기호로 지정합니다. |
...
Codabar 바코드 사양에서 문자 A를 시작 또는 정지 기호로 지정합니다.
...
Codabar 바코드 사양에서 문자 B를 시작 또는 정지 기호로 지정합니다.
...
Codabar 바코드 사양에서 문자 C를 시작 또는 정지 기호로 지정합니다.
...
Codabar 바코드 사양에서 문자 D를 시작 또는 정지 기호로 지정합니다.
