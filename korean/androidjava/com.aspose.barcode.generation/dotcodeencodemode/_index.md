...
description: DotCode 바코드의 인코딩 모드입니다.
type: docs
weight: 85
url: /ko/androidjava/com.aspose.barcode.generation/dotcodeencodemode/
---
**Inheritance:**
...
확장된 코드텍스트 생성을 위해 DotCodeExtCodetextBuilder를 사용하는 것이 좋습니다.
