...
description: 모드 2 및 3용 MaxiCode 코드에 삽입된 텍스트를 인코딩 및 디코딩하기 위한 기본 클래스.
type: docs
weight: 32
url: /ko/androidjava/com.aspose.barcode.complexbarcode/maxicodestructuredcodetext/
---
**Inheritance:**
...
모드 2 및 3용 MaxiCode 코드에 삽입된 텍스트를 인코딩 및 디코딩하기 위한 기본 클래스입니다. 이 샘플은 원시 MaxiCode 코드텍스트를 MaxiCodeStructuredCodetext 인스턴스로 디코딩하는 방법을 보여줍니다.
