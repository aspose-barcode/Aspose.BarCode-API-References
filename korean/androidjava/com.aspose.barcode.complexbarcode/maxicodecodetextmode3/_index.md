...
description: 모드 3용 MaxiCode 코드에 삽입된 텍스트를 인코딩 및 디코딩하기 위한 클래스.
type: docs
weight: 27
url: /ko/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode3/
---
**Inheritance:**
...
모드 3용 MaxiCode 코드에 포함된 텍스트를 인코딩하고 디코딩하기 위한 클래스입니다. 이 샘플은 모드 3용 MaxiCode 코드텍스트를 인코딩하고 디코딩하는 방법을 보여줍니다.
