...
description: PreferencesFragment는 사용자 정의 GUI를 사용하여 바코드 인식 프로세스를 맞춤 설정하는 데 사용할 수 있습니다.
type: docs
weight: 17
url: /ko/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment은 사용자 정의 GUI를 사용하여 바코드 인식 프로세스를 맞춤 설정하는 데 사용할 수 있습니다. PreferencesFragment은 사용자 정의 클래스으로 구현될 수 있으며 BarcodeRecognitionSettings.setPreferencesFragment() 메서드를 사용하여 BarcodeScannerFragment에 연결할 수 있습니다.
## Constructors
