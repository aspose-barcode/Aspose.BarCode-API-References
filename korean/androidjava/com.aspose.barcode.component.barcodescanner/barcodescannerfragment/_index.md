...
description: 바코드 인식을 위한 Fragment.
type: docs
weight: 14
url: /ko/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
바코드 인식을 위한 프래그먼트입니다. 이 프래그먼트는 사용자 정의 Activity 또는 FragmentContainerView 내부에 배치하여 바코드 스캔 및 인식에 사용할 수 있습니다.
...
// BarcodeScannerFragment 초기화 // 리소스 파일을 사용하거나 프로그래밍 방식으로 만들 수 있습니다/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// BarcodeScannerFragment를 사용자 레이아웃에 연결 // 부모 컨테이너의 크기를 차지합니다 requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // BarcodeRecognitionSettings 기본 설정은 BarcodeScannerFragment를 부모 액티비티에 연결한 후 초기화해야 합니다. // BarcodeScannerFragmentPreferencesHandler는 BarcodeScannerFragment.onCreate() 메서드 이후에 호출됩니다 barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \\{
## Constructors

| Constructor | 설명 |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | 기본 생성자 |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | BarcodeScannerFragment.onViewCreated() 메서드 이후에 호출될 수 있는 BarcodeScannerFragmentPreferencesHandler를 설정합니다. |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO 내부? BarcodeScanner에 대한 설정 버튼 표시 여부는 항상 false입니다. |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | PreferencesFragment의 사용자 정의 구현을 설정합니다. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | 설정 버튼 표시를 설정합니다. BarcodeScanner에 대해서는 항상 false입니다. |
...
BarcodeScannerFragment.onViewCreated() 메서드 이후에 호출될 수 있는 BarcodeScannerFragmentPreferencesHandler를 설정합니다.
...
TODO 내부? BarcodeScanner에 대한 설정 버튼 표시 여부는 항상 false입니다.
...
PreferencesFragment의 사용자 정의 구현을 설정합니다.

**Parameters:**
| Parameter | Type | 설명 |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | BarcodeScannerFragment에서 인식 프로세스를 시작하기 전에 호출할 수 있습니다. |
...
설정 버튼 표시를 설정합니다. BarcodeScanner에 대해서는 항상 false입니다.
