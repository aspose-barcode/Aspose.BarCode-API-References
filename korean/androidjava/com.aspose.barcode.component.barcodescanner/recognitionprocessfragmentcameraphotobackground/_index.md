...
description: 인식 프로세스 중에 렌더링될 카메라에서 얻은 이미지 배경을 나타냅니다.
type: docs
weight: 24
url: /ko/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentcameraphotobackground/
---
**Inheritance:**
...
인식 프로세스 중에 렌더링될 카메라에서 얻은 이미지 배경을 나타냅니다.
## Constructors
