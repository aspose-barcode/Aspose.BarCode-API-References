...
description: BarcodeScannerFragment을 포함하는 Activity입니다. 내부 클래스이며 클라이언트가 이 클래스를 호출해서는 안 되지만, 클라이언트는 AndroidManifest.xml에 BarcodeScannerActivity를 등록해야 합니다.
type: docs
weight: 13
url: /ko/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
BarcodeScannerFragment를 포함하는 Activity입니다. 이는 내부 클래스이며 클라이언트가 이 클래스를 호출해서는 안 되지만, 클라이언트는 AndroidManifest.xml에 BarcodeScannerActivity를 등록해야 합니다.
## Constructors
