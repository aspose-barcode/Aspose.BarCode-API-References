...
description: 인식 프로세스 중에 렌더링될 이미지 배경을 나타냅니다.
type: docs
weight: 23
url: /ko/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentbitmapbackground/
---
**Inheritance:**
...
| Parameter | Type | 설명 |
| --- | --- | --- |
| backgroundBitmap | android.graphics.Bitmap | 인식 과정 중에 렌더링될 이미지 배경 |
