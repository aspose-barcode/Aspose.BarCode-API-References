...
type: docs
weight: 15
url: /ko/androidjava/com.aspose.barcode/invalidcodeexception/
---
**Inheritance:**
...
| Constructor | 설명 |
| --- | --- |
| [InvalidCodeException()](#InvalidCodeException--) | 클래스의 새 인스턴스를 초기화합니다. |
| [InvalidCodeException(String message)](#InvalidCodeException-java.lang.String-) | InvalidCodeException 클래스의 새 인스턴스를 지정된 오류 메시지와 함께 초기화합니다. |
## Methods
...
InvalidCodeException 클래스의 새 인스턴스를 지정된 오류 메시지와 함께 초기화합니다.
