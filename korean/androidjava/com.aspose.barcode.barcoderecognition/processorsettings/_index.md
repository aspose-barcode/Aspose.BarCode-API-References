...
description: ProcessorSettings는 멀티스레드 성능 향상을 통해 바코드를 인식하도록 허용합니다
type: docs
weight: 41
url: /ko/androidjava/com.aspose.barcode.barcoderecognition/processorsettings/
---
**Inheritance:**
java.lang.Object
```
...
ProcessorSettings는 멀티스레드 성능 향상을 통해 바코드를 인식하도록 허용합니다
