...
type: docs
weight: 55
url: /ko/androidjava/com.aspose.barcode.barcoderecognition/deconvolutionmode/
---
**Inheritance:**
...
| 필드 | 설명 |
| --- | --- |
| [FAST](#FAST) | 고품질 이미지에 대한 빠른 디컨볼루션 방법을 활성화합니다. |
| [NORMAL](#NORMAL) | 일반 이미지에 대한 표준 디컨볼루션 방법을 활성화합니다. |
| [SLOW](#SLOW) | 저품질 이미지에 대한 느린 디컨볼루션 방법을 활성화합니다. |
## Methods
...
고품질 이미지에 대한 빠른 디컨볼루션 방법을 활성화합니다.
...
일반 이미지에 대한 표준 디컨볼루션 방법을 활성화합니다.
...
저품질 이미지에 대한 느린 디컨볼루션 방법을 활성화합니다.
