...
type: docs
weight: 57
url: /ko/androidjava/com.aspose.barcode.barcoderecognition/inverseimagemode/
---
**Inheritance:**
...
| 필드 | 설명 |
| --- | --- |
| [AUTO](#AUTO) | QR 코드 제외 모든 바코드 유형에 대해 역이미지에서 바코드 추가 인식을 비활성화합니다. |
| [DISABLED](#DISABLED) | 역이미지에서 바코드 추가 인식을 비활성화합니다. |
| [ENABLED](#ENABLED) | 역이미지에서 바코드 추가 인식을 활성화합니다 |
## Methods
...
QR 코드 제외 모든 바코드 유형에 대해 역이미지에서 바코드 추가 인식을 비활성화합니다.
