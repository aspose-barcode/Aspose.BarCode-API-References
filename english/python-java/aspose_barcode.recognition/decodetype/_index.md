...
| --- | --- | --- | --- |
| [contains_any](#contains_any) | `bool` | Yes |  |
| [is_1d](#is_1d) | `bool` | Yes |  |
| [is_2d](#is_2d) | `bool` | Yes |  |
| [is_postal](#is_postal) | `bool` | Yes |  |
...
| [CODE_39](#code_39) | `2` | Specifies that the data should be decoded with Code 39 basic charset barcode specification: ISO/IEC 16388. |
| [CODE_39_FULL_ASCII](#code_39_full_ascii) | `3` | Specifies that the data should be decoded with Code 39 full ASCII charset barcode specification: ISO/IEC 16388. |
| [CODE_93](#code_93) | `5` | Specifies that the data should be decoded with CODE 93 barcode specification. |
...
| [GS_1_AZTEC](#gs_1_aztec) | `81` | Specifies that the data should be decoded with GS1 Aztec barcode specification. |
| [GS_1_CODE_128](#gs_1_code_128) | `7` | Specifies that the data should be decoded with GS1 CODE 128 barcode specification. |
| [GS_1_COMPOSITE_BAR](#gs_1_composite_bar) | `80` | Specifies that the data should be decoded with GS1 Composite Bar barcode specification. |
| [GS_1_DATA_MATRIX](#gs_1_data_matrix) | `31` | Specifies that the data should be decoded with GS1DataMatrix barcode symbology. |
| [GS_1_DOT_CODE](#gs_1_dot_code) | `77` | Specifies that the data should be decoded with GS1 DotCode blank specification. |
...
| [HIBC_AZTEC_LIC](#hibc_aztec_lic) | `69` | Specifies that the data should be decoded with HIBC LIC Aztec blank specification. |
| [HIBC_AZTEC_PAS](#hibc_aztec_pas) | `74` | Specifies that the data should be decoded with HIBC PAS Aztec blank specification. |
| [HIBC_CODE_128_LIC](#hibc_code_128_lic) | `68` | Specifies that the data should be decoded with HIBC LIC Code128 blank specification. |
| [HIBC_CODE_128_PAS](#hibc_code_128_pas) | `73` | Specifies that the data should be decoded with HIBC PAS Code128 blank specification. |
| [HIBC_CODE_39_LIC](#hibc_code_39_lic) | `67` | Specifies that the data should be decoded with HIBC LIC Code39 blank specification. |
| [HIBC_CODE_39_PAS](#hibc_code_39_pas) | `72` | Specifies that the data should be decoded with HIBC PAS Code39 blank specification. |
| [HIBC_DATA_MATRIX_LIC](#hibc_data_matrix_lic) | `70` | Specifies that the data should be decoded with HIBC LIC DataMatrix blank specification. |
| [HIBC_DATA_MATRIX_PAS](#hibc_data_matrix_pas) | `75` | Specifies that the data should be decoded with HIBC PAS DataMatrix blank specification. |
| [HIBCQRLIC](#hibcqrlic) | `71` | Specifies that the data should be decoded with HIBC LIC QR blank specification. |
| [HIBCQRPAS](#hibcqrpas) | `76` | Specifies that the data should be decoded with HIBC PAS QR blank specification. |
...
### DecodeType.contains_any (static) {#contains_any}
...
### DecodeType.is_postal (static) {#is_postal}
...
### DecodeType.ALL_SUPPORTED_TYPES {#all_supported_types}
...
### DecodeType.AUSTRALIA_POST {#australia_post}
...
### DecodeType.AUSTRALIAN_POSTE_PARCEL {#australian_poste_parcel}
...
### DecodeType.CODABLOCK_F {#codablock_f}
...
### DecodeType.CODE_16_K {#code_16_k}
...
### DecodeType.CODE_39_FULL_ASCII {#code_39_full_ascii}
...
### DecodeType.COMPACT_PDF_417 {#compact_pdf_417}
...
### DecodeType.DATA_LOGIC_2_OF_5 {#data_logic_2_of_5}
...
### DecodeType.DATA_MATRIX {#data_matrix}
...
### DecodeType.DATABAR_EXPANDED {#databar_expanded}
...
### DecodeType.DATABAR_EXPANDED_STACKED {#databar_expanded_stacked}
...
### DecodeType.DATABAR_LIMITED {#databar_limited}
...
### DecodeType.DATABAR_OMNI_DIRECTIONAL {#databar_omni_directional}
...
### DecodeType.DATABAR_STACKED {#databar_stacked}
...
### DecodeType.DATABAR_STACKED_OMNI_DIRECTIONAL {#databar_stacked_omni_directional}
...
### DecodeType.DATABAR_TRUNCATED {#databar_truncated}
...
### DecodeType.DEUTSCHE_POST_IDENTCODE {#deutsche_post_identcode}
...
### DecodeType.DEUTSCHE_POST_LEITCODE {#deutsche_post_leitcode}
...
### DecodeType.DUTCH_KIX {#dutch_kix}
...
### DecodeType.GS_1_AZTEC {#gs_1_aztec}
...
### DecodeType.GS_1_CODE_128 {#gs_1_code_128}
...
### DecodeType.GS_1_COMPOSITE_BAR {#gs_1_composite_bar}
...
### DecodeType.GS_1_DATA_MATRIX {#gs_1_data_matrix}
...
### DecodeType.GS_1_DOT_CODE {#gs_1_dot_code}
...
### DecodeType.GS_1_HAN_XIN {#gs_1_han_xin}
...
### DecodeType.GS_1_MICRO_PDF_417 {#gs_1_micro_pdf_417}
...
### DecodeType.HIBC_AZTEC_LIC {#hibc_aztec_lic}
...
### DecodeType.HIBC_AZTEC_PAS {#hibc_aztec_pas}
...
### DecodeType.HIBC_CODE_128_LIC {#hibc_code_128_lic}
...
### DecodeType.HIBC_CODE_128_PAS {#hibc_code_128_pas}
...
### DecodeType.HIBC_CODE_39_LIC {#hibc_code_39_lic}
...
### DecodeType.HIBC_CODE_39_PAS {#hibc_code_39_pas}
...
### DecodeType.HIBC_DATA_MATRIX_LIC {#hibc_data_matrix_lic}
...
### DecodeType.HIBC_DATA_MATRIX_PAS {#hibc_data_matrix_pas}
...
### DecodeType.HIBCQRLIC {#hibcqrlic}
...
### DecodeType.HIBCQRPAS {#hibcqrpas}
...
### DecodeType.IATA_2_OF_5 {#iata_2_of_5}
...
### DecodeType.INTERLEAVED_2_OF_5 {#interleaved_2_of_5}
...
### DecodeType.ITALIAN_POST_25 {#italian_post_25}
...
### DecodeType.MACRO_PDF_417 {#macro_pdf_417}
...
### DecodeType.MATRIX_2_OF_5 {#matrix_2_of_5}
...
### DecodeType.MAXI_CODE {#maxi_code}
...
### DecodeType.MICR_E_13_B {#micr_e_13_b}
...
### DecodeType.MICRO_PDF_417 {#micro_pdf_417}
...
### DecodeType.MOST_COMMON_TYPES {#most_common_types}
...
### DecodeType.PATCH_CODE {#patch_code}
...
### DecodeType.PHARMACODE {#pharmacode}
...
### DecodeType.POSTAL_TYPES {#postal_types}
...
### DecodeType.RECT_MICRO_QR {#rect_micro_qr}
...
### DecodeType.STANDARD_2_OF_5 {#standard_2_of_5}
...
### DecodeType.SUPPLEMENT {#supplement}
...
### DecodeType.SWISS_POST_PARCEL {#swiss_post_parcel}
