...
| Name | Description |
| --- | --- |
| [__init__](./dotcodeextcodetextbuilder/) |  |

## Methods

| Name | Return Type | Static | Description |
| --- | --- | --- | --- |
| [add_fnc1_format_identifier](./add_fnc1_format_identifier/) | `None` | No |  |
| [add_fnc3_reader_initialization](./add_fnc3_reader_initialization/) | `None` | No |  |
| [add_fnc3_symbol_separator](./add_fnc3_symbol_separator/) | `None` | No |  |
| [add_structured_append_mode](./add_structured_append_mode/) | `None` | No |  |
| [extended_codetext](./extended_codetext/) | `str \| None` | No | Reimplemented from ExtCodetextBuilder. |
