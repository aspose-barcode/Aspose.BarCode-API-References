...
| --- | --- | --- |
| [AUTO](/python-java/aspose_barcode.generation.maxi_code_encode_mode/maxicodeencodemode/auto/) | `0` | In Auto mode, the CodeText is encoded with maximum data compactness. Unicode characters are re-encoded in the ECIEncoding specified encoding with the insertion of an ECI identifier. If a character is found that is not supported by the selected ECI encoding, an exception is thrown. |
| [BINARY](/python-java/aspose_barcode.generation.maxi_code_encode_mode/maxicodeencodemode/binary/) | `4` | In Binary mode, the CodeText is encoded with maximum data compactness. If a Unicode character is found, an exception is thrown. |
| [BYTES](/python-java/aspose_barcode.generation.maxi_code_encode_mode/maxicodeencodemode/bytes/) | `1` | Encode codetext as plain bytes. If it detects any Unicode character, the character will be encoded as two bytes, lower byte first. |
| [EXTENDED](/python-java/aspose_barcode.generation.maxi_code_encode_mode/maxicodeencodemode/extended/) | `3` | Extended mode which supports multi ECI modes. It is better to use MaxiCodeExtCodetextBuilder for extended codetext generation. Use Display2DText property to set visible text to removing managing characters. ECI identifiers are set as single slash and six digits identifier "\000026" - UTF8 ECI identifier All unicode characters after ECI identifier are automatically encoded into correct character codeset. |
| [EXTENDED_CODETEXT](/python-java/aspose_barcode.generation.maxi_code_encode_mode/maxicodeencodemode/extended_codetext/) | `2` | Extended mode which supports multi ECI modes. It is better to use MaxiCodeExtCodetextBuilder for extended codetext generation. Use Display2DText property to set visible text to removing managing characters. ECI identifiers are set as single slash and six digits identifier "\000026" - UTF8 ECI identifier All unicode characters after ECI identifier are automatically encoded into correct character codeset. |
