...
### SwissQRBill__construct(\Aspose\Barcode\Bridge\SwissQRBillDTO $swissQRBillDto) {#constructor}

| Parameter | Type | Description |
| --- | --- | --- |
| `$swissQRBillDto` | `\Aspose\Barcode\Bridge\SwissQRBillDTO` |  |

### createAndSetCreditorReferencecreateAndSetCreditorReference(string $rawReference) {#createandsetcreditorreference}
