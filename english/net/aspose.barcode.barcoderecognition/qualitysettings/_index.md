...
| [AllowAdditionalRestorations](../../aspose.barcode.barcoderecognition/qualitysettings/allowadditionalrestorations/) { get; set; } | Allows engine using additional image restorations to recognize corrupted barcodes. At this time, it is used only in MicroPdf417 barcode type. |
