---
title: QRExtendedParameters.ErrorLevel
...
type: docs
weight: 10
url: /net/aspose.barcode.barcoderecognition/qrextendedparameters/errorlevel/
---
## QRExtendedParameters.ErrorLevel property

Reed-Solomon error correction level of recognized barcode. From low to high: LevelL, LevelM, LevelQ, LevelH.

```csharp
public QRErrorLevel ErrorLevel { get; }
```
