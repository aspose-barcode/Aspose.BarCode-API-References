...
| Name | Description |
| --- | --- |
| [AllowOnlyGS1Encoding](../../aspose.barcode.generation/databarparameters/allowonlygs1encoding/) { get; set; } | If this flag is set, it allows only GS1 encoding standard for Databar barcode types |
