...
| [DataMatrixEncodeMode](../../aspose.barcode.generation/datamatrixparameters/datamatrixencodemode/) { get; set; } | Encode mode of Datamatrix barcode. Default value: EncodeMode.Auto. |
| [DataMatrixVersion](../../aspose.barcode.generation/datamatrixparameters/datamatrixversion/) { get; set; } | Gets or sets a Datamatrix symbol size. Default value: Version.Auto. |
| [EccType](../../aspose.barcode.generation/datamatrixparameters/ecctype/) { get; set; } | Gets or sets a Datamatrix ECC type. Default value: DataMatrixEccType.Ecc200. |
| [ECIEncoding](../../aspose.barcode.generation/datamatrixparameters/eciencoding/) { get; set; } | Gets or sets ECI encoding. Used when EncodeMode is Auto. Default value: ISO-8859-1 |
| [EncodeMode](../../aspose.barcode.generation/datamatrixparameters/encodemode/) { get; set; } | Encode mode of Datamatrix barcode. Default value: EncodeMode.Auto. |
...
| [Version](../../aspose.barcode.generation/datamatrixparameters/version/) { get; set; } | Gets or sets a Datamatrix symbol size. Default value: Version.Auto. |
