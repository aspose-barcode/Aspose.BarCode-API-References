---
title: GS1CompositeBarParameters.AllowOnlyGS1Encoding
...
type: docs
weight: 10
url: /net/aspose.barcode.generation/gs1compositebarparameters/allowonlygs1encoding/
---
## GS1CompositeBarParameters.AllowOnlyGS1Encoding property

If this flag is set, it allows only GS1 encoding standard for GS1CompositeBar 2D Component

```csharp
public bool AllowOnlyGS1Encoding { get; set; }
```
