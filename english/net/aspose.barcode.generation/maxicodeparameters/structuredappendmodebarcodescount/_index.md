...
type: docs
weight: 60
url: /net/aspose.barcode.generation/maxicodeparameters/structuredappendmodebarcodescount/
---
## MaxiCodeParameters.StructuredAppendModeBarcodesCount property
...
```csharp
public int StructuredAppendModeBarcodesCount { get; set; }
```
