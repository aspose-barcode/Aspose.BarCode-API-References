---
title: Pdf417ParametersUI.MacroPdf417FileName
...
type: docs
weight: 140
url: /net/aspose.barcode.windows.forms/pdf417parametersui/macropdf417filename/
---
## Pdf417ParametersUI.MacroPdf417FileName property

MacroPdf417 barcode file name (optional field). MicroPDF417 barcode file name (optional field for Structured Append mode)

```csharp
public string MacroPdf417FileName { get; set; }
```
