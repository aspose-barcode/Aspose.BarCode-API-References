...
description: MaxiCodeStandardCodetext property. Gets or sets MaxiCode mode. Standard codetext can be used only with modes 4 5 and 6
type: docs
weight: 30
...
Gets or sets MaxiCode mode. Standard codetext can be used only with modes 4, 5 and 6.
