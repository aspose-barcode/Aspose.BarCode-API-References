...
description: 
type: docs
url: /aspose.barcode.complexbarcode/usadriveidhaircolor/
---
...
|BALD|BAL - Bald.|
|BLACK|BLK - Black color|
|BLOND|BLN - Blonde color|
|BROWN|BRO - Brown color|
|GRAY|GRY - Gray color|
|RED|RED - Red / Auburn|
|SANDY|SDY - Sandy color|
|WHITE|WHI - White color|
