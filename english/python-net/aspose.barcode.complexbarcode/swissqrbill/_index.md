...
description: 
type: docs
url: /python-net/aspose.barcode.complexbarcode/swissqrbill/
---
...
| Name | Description |
| :- | :- |
|create_and_set_creditor_reference(raw_reference)|Creates and sets a ISO11649 creditor reference from a raw string by prefixing<br/>            the String with "RF" and the modulo 97 checksum.|
