...
description: 
type: docs
url: /python-net/aspose.barcode.generation/itfparameters/
---
...
| Name | Description |
| :- | :- |
|border_thickness|Gets or sets an ITF border (bearer bar) thickness in Unit value.<br/>            Default value: 12pt.|
|border_type|Border type of ITF barcode.<br/>            Default value: ITF14BorderType.Bar.|
