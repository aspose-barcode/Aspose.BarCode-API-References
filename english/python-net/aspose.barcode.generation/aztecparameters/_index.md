...
description: 
type: docs
url: /python-net/aspose.barcode.generation/aztecparameters/
---
...
| Name | Description |
| :- | :- |
|encode_mode|Gets or sets a Aztec encode mode. <br/>            Default value: Auto.|
...
|error_level|Level of error correction of Aztec types of barcode.<br/>            Value should between 5 to 95.|
|symbol_mode|Gets or sets a Aztec Symbol mode.<br/>            Default value: AztecSymbolMode.Auto.|
