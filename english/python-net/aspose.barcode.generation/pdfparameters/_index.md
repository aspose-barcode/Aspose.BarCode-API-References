...
description: 
type: docs
url: /python-net/aspose.barcode.generation/pdfparameters/
---
...
|is_text_as_path|Are paths used instead of text (use if Unicode characters are not displayed)<br/>            Default value: false.|
