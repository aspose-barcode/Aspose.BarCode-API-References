...
| [get_Format](./get_format/)() const | PatchCode format. Choose PatchOnly to generate single PatchCode. Use page format to generate Patch page with PatchCodes as borders. Default value: [PatchFormat.PatchOnly](../patchformat/) |
| [get_PatchFormat](./get_patchformat/)() | PatchCode format. Choose PatchOnly to generate single PatchCode. Use page format to generate Patch page with PatchCodes as borders. Default value: [PatchFormat.PatchOnly](../patchformat/) |
...
| [set_Format](./set_format/)(Aspose::BarCode::Generation::PatchFormat) | PatchCode format. Choose PatchOnly to generate single PatchCode. Use page format to generate Patch page with PatchCodes as borders. Default value: [PatchFormat.PatchOnly](../patchformat/) |
