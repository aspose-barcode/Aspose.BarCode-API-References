...
---
## DotCodeParameters::set_StructuredAppendModeBarcodesCount method


Identifies DotCode structured append mode barcodes count. Default value is -1. Count must be a value from 1 to 35.

```cpp
void Aspose::BarCode::Generation::DotCodeParameters::set_StructuredAppendModeBarcodesCount(int32_t value)
```
