...
| Method | Description |
| --- | --- |
| [get_FamilyName](./get_familyname/)() const | Gets the face name of this Font. |
| [get_Size](./get_size/)() const | Gets size of this [FontUnit](./) in [Unit](../unit/) value. |
| [get_Style](./get_style/)() const | Gets style information for this [FontUnit](./). |
