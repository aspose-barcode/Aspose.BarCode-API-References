...
type: docs
weight: 1700
url: /cpp/aspose.barcode.generation/qrparameters/get_encodegs1separatorinbytemode/
---
## QrParameters::get_EncodeGS1SeparatorInByteMode method




```cpp
bool Aspose::BarCode::Generation::QrParameters::get_EncodeGS1SeparatorInByteMode() const
```

## Remarks


Gets a value indicating whether GS1 special characters should be encoded in Byte mode for QR and RectMicroQR barcodes.
