...
| [get_EncodeGS1SeparatorInByteMode](./get_encodegs1separatorinbytemode/)() const |  |
| [get_EncodeMode](./get_encodemode/)() const | QR symbology type of [BarCode](../../aspose.barcode/)'s encoding mode. Default value: [QREncodeMode.Auto](../qrencodemode/). |
...
| [get_Version](./get_version/)() const | Version of QR Code.From Version1 to Version40. Default value is [QRVersion.Auto](../qrversion/). |
...
| [set_EncodeGS1SeparatorInByteMode](./set_encodegs1separatorinbytemode/)(bool) |  |
| [set_EncodeMode](./set_encodemode/)(QREncodeMode) | QR symbology type of [BarCode](../../aspose.barcode/)'s encoding mode. Default value: [QREncodeMode.Auto](../qrencodemode/). |
...
| [set_Version](./set_version/)(QRVersion) | Version of QR Code.From Version1 to Version40. Default value is [QRVersion.Auto](../qrversion/). |
