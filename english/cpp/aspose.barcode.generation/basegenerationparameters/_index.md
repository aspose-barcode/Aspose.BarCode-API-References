...
| [get_BackColor](./get_backcolor/)() const | Background color of the barcode image. Default value: Color.White. See [Color](../). |
...
| [get_Resolution](./get_resolution/)() const | Gets the resolution of the [BarCode](../../aspose.barcode/) image. One value for both dimensions. Default value: 96 dpi. |
| [get_RotationAngle](./get_rotationangle/)() const | [BarCode](../../aspose.barcode/) image rotation angle, measured in degree, e.g. RotationAngle = 0 or RotationAngle = 360 means no rotation. If RotationAngle NOT equal to 90, 180, 270 or 0, it may increase the difficulty for the scanner to read the image. Default value: 0. |
| [get_UseAntiAlias](./get_useantialias/)() const | Gets a value indicating whether is used anti-aliasing mode to render image |
