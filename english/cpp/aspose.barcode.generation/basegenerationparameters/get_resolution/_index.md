...
description: ' method. Gets the resolution of the BarCode image. One value for both dimensions. Default value: 96 dpi in C++.'
type: docs
weight: 500
...
```cpp
float Aspose::BarCode::Generation::BaseGenerationParameters::get_Resolution() const
```
