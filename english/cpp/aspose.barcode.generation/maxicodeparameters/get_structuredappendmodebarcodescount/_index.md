...
---
## MaxiCodeParameters::get_StructuredAppendModeBarcodesCount method
...
```cpp
int32_t Aspose::BarCode::Generation::MaxiCodeParameters::get_StructuredAppendModeBarcodesCount() const
```
