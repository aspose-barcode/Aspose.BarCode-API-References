...
description: ' method. Gets the index of the QR structured append mode barcode. Index starts from 0 in C++.'
type: docs
weight: 300
...
```cpp
int32_t Aspose::BarCode::Generation::QrStructuredAppendParameters::get_SequenceIndicator() const
```
