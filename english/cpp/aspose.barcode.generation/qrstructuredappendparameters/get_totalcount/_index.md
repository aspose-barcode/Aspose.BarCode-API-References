...
description: ' method. Gets the QR structured append mode barcodes quantity. Max value is 16 in C++.'
type: docs
weight: 500
...
```cpp
int32_t Aspose::BarCode::Generation::QrStructuredAppendParameters::get_TotalCount() const
```
