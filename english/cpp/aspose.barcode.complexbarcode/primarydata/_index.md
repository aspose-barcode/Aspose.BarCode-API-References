...
| [get_LabelerIdentificationCode](./get_labeleridentificationcode/)() const | Identifies date of labeler identification code. Labeler identification code must be 4 symbols alphanumeric string, with first character always being alphabetic. |
| [get_ProductOrCatalogNumber](./get_productorcatalognumber/)() const | Identifies product or catalog number. Product or catalog number must be alphanumeric string up to 18 sybmols length. |
| [get_UnitOfMeasureID](./get_unitofmeasureid/)() const | Identifies unit of measure ID. Unit of measure ID must be integer value from 0 to 9. |
