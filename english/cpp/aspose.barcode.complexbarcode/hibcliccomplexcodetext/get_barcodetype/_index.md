...
description: ' method. Gets barcode type. HIBC LIC codetext can be encoded using HIBCCode39LIC, HIBCCode128LIC, HIBCAztecLIC, HIBCDataMatrixLIC and HIBCQRLIC encode types. Default value: HIBCCode39LIC in C++.'
type: docs
weight: 100
...
```cpp
System::SharedPtr<Generation::BaseEncodeType> Aspose::BarCode::ComplexBarcode::HIBCLICComplexCodetext::get_BarcodeType() const
```
