...
| [get_LotNumber](./get_lotnumber/)() const | Identifies lot or batch number. Lot/batch number must be alphanumeric string with up to 18 sybmols length. . |
| [get_Quantity](./get_quantity/)() const | Identifies quantity, must be integer value from 0 to 500. Quantity can be set to -1 in order not to use this field. Default value: -1 |
| [get_SerialNumber](./get_serialnumber/)() const | Identifies serial number. Serial number must be alphanumeric string up to 18 sybmols length. |
