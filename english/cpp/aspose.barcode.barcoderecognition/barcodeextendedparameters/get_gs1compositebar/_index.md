...
description: ' method. Gets a GS1CompositeBar additional informationGS1CompositeBarExtendedParameters of recognized barcode in C++.'
type: docs
weight: 1000
...
```cpp
System::SharedPtr<GS1CompositeBarExtendedParameters> Aspose::BarCode::BarCodeRecognition::BarCodeExtendedParameters::get_GS1CompositeBar() const
```
