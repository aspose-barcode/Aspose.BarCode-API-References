...
| [get_StructuredAppendBarcodeId](./get_structuredappendbarcodeid/)() const | Gets the ID of the Aztec structured append mode barcode. ID starts from 1 and must be less or equal to barcodes count. Default value is 0. |
| [get_StructuredAppendBarcodesCount](./get_structuredappendbarcodescount/)() const | Gets the Aztec structured append mode barcodes count. Default value is 0. Count must be a value from 1 to 26. |
| [get_StructuredAppendFileId](./get_structuredappendfileid/)() const | Gets the File ID of the Aztec structured append mode. Default value is empty string |
