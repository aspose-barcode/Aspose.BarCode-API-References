...
---
## Details_RecognitionAbortedException::set_ExecutionTime method


Gets the execution time of current recognition session

```cpp
void Aspose::BarCode::BarCodeRecognition::Details_RecognitionAbortedException::set_ExecutionTime(int32_t value)
```
