...
| [get_BarCodeReadType](./get_barcodereadtype/)() | Gets the barcode decode type used for recognition. Must be set before calling [ReadBarCodes](./readbarcodes/). |
...
| [set_BarCodeReadType](./set_barcodereadtype/)(System::SharedPtr\<BaseDecodeType\>) | Sets the barcode decode type used for recognition. Must be set before calling [ReadBarCodes](./readbarcodes/). |
