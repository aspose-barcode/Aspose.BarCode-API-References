...
```cpp
Aspose::BarCode::BarCodeRecognition::MultiDecodeType::MultiDecodeType(const System::ArrayPtr<System::SharedPtr<SingleDecodeType>> &barcodeTypes)
```
...
```cpp
Aspose::BarCode::BarCodeRecognition::MultiDecodeType::MultiDecodeType(const System::ArrayPtr<System::SharedPtr<BaseDecodeType>> &barcodeTypes)
```
