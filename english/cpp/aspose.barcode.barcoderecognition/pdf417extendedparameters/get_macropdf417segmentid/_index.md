...
description: ' method. Gets the segment ID of the barcode,only available with MacroPdf417 in C++.'
type: docs
weight: 200
...
```cpp
int32_t Aspose::BarCode::BarCodeRecognition::Pdf417ExtendedParameters::get_MacroPdf417SegmentID() const
```
