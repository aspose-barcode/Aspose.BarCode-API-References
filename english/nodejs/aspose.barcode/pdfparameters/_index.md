...
description: "PDF parameters wrapper. Expects an underlying `mwObject` instance that provides the corresponding getter/setter methods returning/accepting CMYK strings like..."
type: docs
weight: 780
