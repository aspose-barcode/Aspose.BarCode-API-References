---
title: QualitySettings.setMinimalXDimension
...
---
## setMinimalXDimension(object) {#setminimalxdimension}
...
| --- | --- | --- |
| value | object | Minimal size of XDimension in pixels which is used with UseMinimalXDimension. |
