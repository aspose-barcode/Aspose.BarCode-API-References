---
title: QualitySettings.setInverseImage
...
---
## setInverseImage(object) {#setinverseimage}
...
| --- | --- | --- |
| value | object | Additional recognition of barcodes on images with inverse colors |
