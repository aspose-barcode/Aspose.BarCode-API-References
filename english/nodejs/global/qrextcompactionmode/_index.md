...
type: docs
weight: 530
url: /nodejs/global/qrextcompactionmode/
---
...
| Name | Description |
| --- | --- |
| AUTO | The encoder selects the most efficient QR compaction mode automatically. |
| NUMERIC | Encodes codetext in QR Numeric mode. Only digits 0-9 are allowed. |
