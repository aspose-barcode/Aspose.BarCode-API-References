...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">CodeWordList</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.common.constants.micropdf417constants/codewordlist/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class CodeWordList extends System.Collections.Generic.List<CodeWord>
```
## Constructors

| Constructor | Description |
| --- | --- |
| [CodeWordList()](#CodeWordList--) |  |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCodeWord(int[] symbol)](#getCodeWord-int---) |  |
...
### getCodeWord(int[] symbol) {#getCodeWord-int---}
```
public int getCodeWord(int[] symbol)
```
