...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">RowAddressPatternList</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.common.constants.micropdf417constants/rowaddresspatternlist/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class RowAddressPatternList extends System.Collections.Generic.List<RowAddressPattern>
```
## Constructors

| Constructor | Description |
| --- | --- |
| [RowAddressPatternList()](#RowAddressPatternList--) |  |
## Methods
...
| [getClass()](#getClass--) |  |
| [getRAPNumber(int[] symbol, int type)](#getRAPNumber-int---int-) |  |
...
### getRAPNumber(int[] symbol, int type) {#getRAPNumber-int---int-}
```
public int getRAPNumber(int[] symbol, int type)
```
