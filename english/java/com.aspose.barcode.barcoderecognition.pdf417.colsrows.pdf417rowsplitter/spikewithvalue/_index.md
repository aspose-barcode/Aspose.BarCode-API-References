...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">SpikeWithValue</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.pdf417.colsrows.pdf417rowsplitter/spikewithvalue/</div></td>
  </tr>
  </tbody>
</table>
...
java.lang.Object
```
public class SpikeWithValue
```
## Constructors

| Constructor | Description |
| --- | --- |
| [SpikeWithValue(int aPos, int aValue)](#SpikeWithValue-int-int-) |  |
## Fields
...
### SpikeWithValue(int aPos, int aValue) {#SpikeWithValue-int-int-}
```
public SpikeWithValue(int aPos, int aValue)
```
