...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">RecognitionEngineException</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.internal/recognitionengineexception/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class RecognitionEngineException extends BarCodeRecognitionException
```
## Constructors

| Constructor | Description |
| --- | --- |
| [RecognitionEngineException(String message)](#RecognitionEngineException-java.lang.String-) |  |
...
### RecognitionEngineException(String message) {#RecognitionEngineException-java.lang.String-}
```
public RecognitionEngineException(String message)
```
...
### RecognitionEngineException() {#RecognitionEngineException--}
```
public RecognitionEngineException()
```
