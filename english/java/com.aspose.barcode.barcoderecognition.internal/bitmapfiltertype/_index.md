...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">BitmapFilterType</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto"></div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">50</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.internal/bitmapfiltertype/</div></td>
  </tr>
  </tbody>
</table>
...
```
public enum BitmapFilterType extends Enum<BitmapFilterType>
```
## Fields
...
### ARGBImage {#ARGBImage}
```
public static final BitmapFilterType ARGBImage
```


### ColorQuantization {#ColorQuantization}
```
public static final BitmapFilterType ColorQuantization
```


### Gray {#Gray}
```
public static final BitmapFilterType Gray
```


### MedianSmoothing {#MedianSmoothing}
```
public static final BitmapFilterType MedianSmoothing
```
...
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static BitmapFilterType valueOf(String name)
```
...
### values() {#values--}
```
public static BitmapFilterType[] values()
```
...
**Returns:**
com.aspose.barcode.barcoderecognition.internal.BitmapFilterType[]
### wait() {#wait--}
```
