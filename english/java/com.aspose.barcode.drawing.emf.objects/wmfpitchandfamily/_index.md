...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">WmfPitchAndFamily</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf.objects/wmfpitchandfamily/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class WmfPitchAndFamily extends XmfObject
```
## Constructors
...
| [WmfPitchAndFamily(byte family, byte pitch)](#WmfPitchAndFamily-byte-byte-) |  |
## Fields

| Field | Description |
| --- | --- |
| [PackedData](#PackedData) | objectData |
## Methods
...
### WmfPitchAndFamily(byte family, byte pitch) {#WmfPitchAndFamily-byte-byte-}
```
public WmfPitchAndFamily(byte family, byte pitch)
```
