...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EccConvolution080</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">Class for the convolution algorithm ECC 080</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">12</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.common.constants.datamatrixconstants.eccconvolution/eccconvolution080/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class EccConvolution080 extends EccMathStrategy implements IConvolutionStrategy, IConvolutionFano
```

Class for the convolution algorithm ECC 080
## Constructors

| Constructor | Description |
| --- | --- |
| [EccConvolution080()](#EccConvolution080--) | Initializes a new instance of the  EccConvolution080  class. |
## Methods
...
| [algorithm(List<Byte> inBytes)](#algorithm-java.util.List-java.lang.Byte--) | Implements convolutional code 3-2-11 and adds prefix and postfix |
| [blockLength()](#blockLength--) | The length of convoluted block for ECC 080, is equal number of summators |
| [continueConvolution(List<Byte> inBytes)](#continueConvolution-java.util.List-java.lang.Byte--) |  |
| [createPrefix()](#createPrefix--) | Create 19 bits corresponding ECC 080 |
| [deltaFactor()](#deltaFactor--) | Returns constant for the Fano algorithm of ECC 080 |
...
| [hashCode()](#hashCode--) |  |
| [inBlockLength()](#inBlockLength--) | The length of input block for ECC 080 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [penaltyFactor()](#penaltyFactor--) | Returns constant for the Fano algorithm of ECC 080 |
| [possibleBlocks()](#possibleBlocks--) | Blocks for building decoded sequence by the algorithm Fano of ECC 080 |
...
### EccConvolution080() {#EccConvolution080--}
```
public EccConvolution080()
```


Initializes a new instance of the  EccConvolution080  class.
...
Implements convolutional code 3-2-11 and adds prefix and postfix
...
**Returns:**
[List](../../java.util/list) - output bytes
...
The length of convoluted block for ECC 080, is equal number of summators

**Returns:**
int - The length of convoluted bytes for ECC 080
### continueConvolution(List<Byte> inBytes) {#continueConvolution-java.util.List-java.lang.Byte--}
```
...
Create 19 bits corresponding ECC 080
...
Returns constant for the Fano algorithm of ECC 080

**Returns:**
int - Constant Delta for the Fano algorithm of ECC 080
...
The length of input block for ECC 080
...
**Returns:**
int - constant for the Fano algorithm of ECC 080
...
Blocks for building decoded sequence by the algorithm Fano of ECC 080
