...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EmfFormatSignature</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">The FormatSignature enumeration defines values that are used to identify the format of embedded data in EMF records.</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">13</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/emfformatsignature/</div></td>
  </tr>
  </tbody>
</table>
...
```
public static final long ENHMETA_SIGNATURE
```
...
```
public static final long EPS_SIGNATURE
```
