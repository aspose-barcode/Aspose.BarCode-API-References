...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">WmfFamilyFont</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">The FamilyFont enumeration specifies the font family.</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">24</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/wmffamilyfont/</div></td>
  </tr>
  </tbody>
</table>
...
| [FF_DECORATIVE](#FF-DECORATIVE) | Novelty fonts. |
| [FF_DONTCARE](#FF-DONTCARE) | The default font is specified, which is implementation-dependent. |
| [FF_MODERN](#FF-MODERN) | Fonts with constant stroke width, with or without serifs. |
| [FF_ROMAN](#FF-ROMAN) | Fonts with variable stroke widths, which are proportional to the actual widths of the glyphs, and which have serifs. |
| [FF_SCRIPT](#FF-SCRIPT) | Fonts designed to look like handwriting. |
| [FF_SWISS](#FF-SWISS) | Fonts with variable stroke widths, which are proportional to the actual widths of the glyphs, and which do not have serifs. |
## Methods
