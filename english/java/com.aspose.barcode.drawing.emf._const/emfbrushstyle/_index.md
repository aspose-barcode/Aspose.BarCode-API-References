...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EmfBrushStyle</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">The BrushStyle Enumeration specifies the different possible brush types  that can be used in graphics operations.</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">11</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/emfbrushstyle/</div></td>
  </tr>
  </tbody>
</table>
...
```
public final class EmfBrushStyle extends System.Enum
```
...
| Field | Description |
| --- | --- |
| [BS_DIBPATTERN](#BS-DIBPATTERN) | A pattern brush specified by a DIB. |
| [BS_DIBPATTERN8X8](#BS-DIBPATTERN8X8) | Not supported. |
| [BS_DIBPATTERNPT](#BS-DIBPATTERNPT) | A pattern brush specified by a DIB. |
| [BS_HATCHED](#BS-HATCHED) | A brush that paints a predefined simple pattern, or "hatch", onto a solid background |
| [BS_INDEXED](#BS-INDEXED) | Not supported. |
| [BS_MONOPATTERN](#BS-MONOPATTERN) | Not supported. |
| [BS_NULL](#BS-NULL) | A brush that does nothing. |
| [BS_PATTERN](#BS-PATTERN) | A brush that paints a pattern defined by a bitmap, which MAY be a Bitmap16 Object or a DeviceIndependentBitmap (DIB) Object. |
| [BS_PATTERN8X8](#BS-PATTERN8X8) | Not supported. |
| [BS_SOLID](#BS-SOLID) | A brush that paints a single, constant color, either solid or dithered. |
...
### BS_DIBPATTERN {#BS-DIBPATTERN}
```
public static final long BS_DIBPATTERN
```


A pattern brush specified by a DIB.

### BS_DIBPATTERN8X8 {#BS-DIBPATTERN8X8}
```
public static final long BS_DIBPATTERN8X8
```


Not supported.

### BS_DIBPATTERNPT {#BS-DIBPATTERNPT}
```
public static final long BS_DIBPATTERNPT
```


A pattern brush specified by a DIB.

### BS_HATCHED {#BS-HATCHED}
```
public static final long BS_HATCHED
```


A brush that paints a predefined simple pattern, or "hatch", onto a solid background

### BS_INDEXED {#BS-INDEXED}
```
public static final long BS_INDEXED
```


Not supported.

### BS_MONOPATTERN {#BS-MONOPATTERN}
```
public static final long BS_MONOPATTERN
```
...
### BS_NULL {#BS-NULL}
```
public static final long BS_NULL
```


A brush that does nothing. Using a BS\_NULL brush in a graphics operation MUST have the same effect as using no brush at all

### BS_PATTERN {#BS-PATTERN}
```
public static final long BS_PATTERN
```


A brush that paints a pattern defined by a bitmap, which MAY be a Bitmap16 Object or a DeviceIndependentBitmap (DIB) Object.

### BS_PATTERN8X8 {#BS-PATTERN8X8}
```
public static final long BS_PATTERN8X8
```
...
### BS_SOLID {#BS-SOLID}
```
public static final long BS_SOLID
```
