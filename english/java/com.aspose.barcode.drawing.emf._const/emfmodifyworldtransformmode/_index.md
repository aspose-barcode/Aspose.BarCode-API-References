...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EmfModifyWorldTransformMode</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">ModifyWorldTransformMode Enumeration</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">17</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/emfmodifyworldtransformmode/</div></td>
  </tr>
  </tbody>
</table>
...
```
public static final long MWT_IDENTITY
```
...
```
public static final long MWT_LEFTMULTIPLY
```
...
```
public static final long MWT_RIGHTMULTIPLY
```
...
### MWT_SET {#MWT-SET}
```
public static final long MWT_SET
```
