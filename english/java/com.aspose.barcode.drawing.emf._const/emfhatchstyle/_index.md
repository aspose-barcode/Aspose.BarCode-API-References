...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EmfHatchStyle</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">HatchStyle Enumeration</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">15</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/emfhatchstyle/</div></td>
  </tr>
  </tbody>
</table>
...
```
public static final long HS_BDIAGONAL
```
...
### HS_CROSS {#HS-CROSS}
```
public static final long HS_CROSS
```
...
```
public static final long HS_DIAGCROSS
```
...
```
public static final long HS_DITHEREDBKCLR
```
...
```
public static final long HS_DITHEREDCLR
```
...
```
public static final long HS_DITHEREDTEXTCLR
```
...
```
public static final long HS_FDIAGONAL
```
...
```
public static final long HS_HORIZONTAL
```
...
```
public static final long HS_SOLIDBKCLR
```
...
```
public static final long HS_SOLIDCLR
```
...
```
public static final long HS_SOLIDTEXTCLR
```
...
```
public static final long HS_VERTICAL
```
