...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EmfMapMode</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">The MapMode enumeration is used to define the unit of measure for transforming page  space units into device space units and for defining the orientation of the drawing axes.</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">16</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/emfmapmode/</div></td>
  </tr>
  </tbody>
</table>
...
```
public static final long MM_ANISOTROPIC
```
...
```
public static final long MM_HIENGLISH
```
...
```
public static final long MM_HIMETRIC
```
...
```
public static final long MM_ISOTROPIC
```
...
```
public static final long MM_LOENGLISH
```
...
```
public static final long MM_LOMETRIC
```
...
### MM_TEXT {#MM-TEXT}
```
public static final long MM_TEXT
```
...
### MM_TWIPS {#MM-TWIPS}
```
public static final long MM_TWIPS
```
