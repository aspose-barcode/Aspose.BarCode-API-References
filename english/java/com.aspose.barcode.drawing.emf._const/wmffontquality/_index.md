...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">WmfFontQuality</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">The FontQuality Enumeration specifies how closely the attributes of the logical font should match  those of the physical font when rendering text.</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">25</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/wmffontquality/</div></td>
  </tr>
  </tbody>
</table>
...
| Field | Description |
| --- | --- |
| [ANTIALIASED_QUALITY](#ANTIALIASED-QUALITY) | Specifies that anti-aliasing SHOULD be used when rendering text, if the font supports it. |
| [CLEARTYPE_QUALITY](#CLEARTYPE-QUALITY) | Specifies that ClearType anti-aliasing SHOULD be used when rendering text, if the font supports it. |
| [DEFAULT_QUALITY](#DEFAULT-QUALITY) | Specifies that the character quality of the font does not matter, so DRAFT\_QUALITY can be used. |
| [DRAFT_QUALITY](#DRAFT-QUALITY) | Specifies that the character quality of the font is less important than the matching of logical attribuetes. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NONANTIALIASED_QUALITY](#NONANTIALIASED-QUALITY) | Specifies that anti-aliasing SHOULD NOT be used when rendering text |
| [PROOF_QUALITY](#PROOF-QUALITY) | Specifies that the character quality of the font is more important than the matching of logical attributes. |
## Methods
...
Specifies that the character quality of the font does not matter, so DRAFT\_QUALITY can be used.
...
### NONANTIALIASED_QUALITY {#NONANTIALIASED-QUALITY}
```
