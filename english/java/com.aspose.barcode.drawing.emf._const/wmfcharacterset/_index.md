...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">WmfCharacterSet</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">The CharacterSet Enumeration defines the possible sets of character glyphs that are defined in  fonts for graphics output.</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">22</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf._const/wmfcharacterset/</div></td>
  </tr>
  </tbody>
</table>
...
| Field | Description |
| --- | --- |
| [ANSI_CHARSET](#ANSI-CHARSET) | Specifies the English character set. |
| [ARABIC_CHARSET](#ARABIC-CHARSET) | Specifies the Arabic character set |
| [BALTIC_CHARSET](#BALTIC-CHARSET) | Specifies the Baltic (Northeastern European) character set |
| [CHINESEBIG5_CHARSET](#CHINESEBIG5-CHARSET) | Specifies the "traditional" Chinese character set, used mostly in Taiwan and in the Hong Kong and Macao Special Administrative Regions. |
| [DEFAULT_CHARSET](#DEFAULT-CHARSET) | Specifies a character set based on the current system locale; for example, when the system locale is United States English, the default character set is ANSI\_CHARSET. |
| [EASTEUROPE_CHARSET](#EASTEUROPE-CHARSET) | Specifies a Eastern European character set. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GB2312_CHARSET](#GB2312-CHARSET) | Specifies the "simplified" Chinese character set for People's Republic of China. |
| [GREEK_CHARSET](#GREEK-CHARSET) | Specifies the Greek character set. |
| [HANGUL_CHARSET](#HANGUL-CHARSET) | Also spelled "Hangeul". |
| [HEBREW_CHARSET](#HEBREW-CHARSET) | Specifies the Vietnamese character set. |
| [JOHAB_CHARSET](#JOHAB-CHARSET) | Also spelled "Johap". |
| [MAC_CHARSET](#MAC-CHARSET) | Specifies the Apple Macintosh character set. |
| [OEM_CHARSET](#OEM-CHARSET) | Specifies a mapping to one of the OEM code pages, according to the current system locale setting. |
| [RUSSIAN_CHARSET](#RUSSIAN-CHARSET) | Specifies the Russian Cyrillic character set. |
| [SHIFTJIS_CHARSET](#SHIFTJIS-CHARSET) | Specifies the Japanese character set. |
| [SYMBOL_CHARSET](#SYMBOL-CHARSET) | Specifies a character set of symbols. |
| [THAI_CHARSET](#THAI-CHARSET) | Specifies the Thai character set. |
| [TURKISH_CHARSET](#TURKISH-CHARSET) | Specifies the Turkish character set. |
| [VIETNAMESE_CHARSET](#VIETNAMESE-CHARSET) | Specifies the Vietnamese character set. |
## Methods
...
### CHINESEBIG5_CHARSET {#CHINESEBIG5-CHARSET}
```
...
### EASTEUROPE_CHARSET {#EASTEUROPE-CHARSET}
```
...
### RUSSIAN_CHARSET {#RUSSIAN-CHARSET}
```
...
### SHIFTJIS_CHARSET {#SHIFTJIS-CHARSET}
```
...
### TURKISH_CHARSET {#TURKISH-CHARSET}
```
...
### VIETNAMESE_CHARSET {#VIETNAMESE-CHARSET}
```
