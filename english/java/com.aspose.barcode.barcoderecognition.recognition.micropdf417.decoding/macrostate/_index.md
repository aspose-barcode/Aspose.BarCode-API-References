...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">MacroState</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.micropdf417.decoding/macrostate/</div></td>
  </tr>
  </tbody>
</table>
...
```
public enum MacroState extends Enum<MacroState>
```
## Fields
...
### Separator {#Separator}
```
public static final MacroState Separator
```


### Start {#Start}
```
public static final MacroState Start
```


### Terminator {#Terminator}
```
public static final MacroState Terminator
```
...
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static MacroState valueOf(String name)
```
...
**Returns:**
com.aspose.barcode.barcoderecognition.recognition.micropdf417.decoding.MacroState[]
### wait() {#wait--}
```
