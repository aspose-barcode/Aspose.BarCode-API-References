...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">ShiftLatch</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.micropdf417.decoding/shiftlatch/</div></td>
  </tr>
  </tbody>
</table>
...
```
public enum ShiftLatch extends Enum<ShiftLatch>
```
## Fields
...
### Latch {#Latch}
```
public static final ShiftLatch Latch
```


### Shift {#Shift}
```
public static final ShiftLatch Shift
```
...
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static ShiftLatch valueOf(String name)
```
...
### values() {#values--}
```
public static ShiftLatch[] values()
```
...
**Returns:**
com.aspose.barcode.barcoderecognition.recognition.micropdf417.decoding.ShiftLatch[]
### wait() {#wait--}
```
