...
<div >
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.micropdf417.decoding/group/</div></td>
  </tr>
  </tbody>
</table>
...
### Lower {#Lower}
```
public static final Group Lower
```


### Mixed {#Mixed}
```
public static final Group Mixed
```


### Punct {#Punct}
```
public static final Group Punct
```
...
**Returns:**
com.aspose.barcode.barcoderecognition.recognition.micropdf417.decoding.Group[]
### wait() {#wait--}
```
