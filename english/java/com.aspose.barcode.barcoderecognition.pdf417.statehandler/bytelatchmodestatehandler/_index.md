...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">ByteLatchModeStateHandler</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.pdf417.statehandler/bytelatchmodestatehandler/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class ByteLatchModeStateHandler implements IStateHandlerCallback
```
## Constructors

| Constructor | Description |
| --- | --- |
| [ByteLatchModeStateHandler()](#ByteLatchModeStateHandler--) |  |
## Methods
...
### ByteLatchModeStateHandler() {#ByteLatchModeStateHandler--}
```
public ByteLatchModeStateHandler()
```
