...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">NumericLatchModeStateHandler</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.pdf417.statehandler/numericlatchmodestatehandler/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class NumericLatchModeStateHandler implements IStateHandlerCallback
```
## Constructors

| Constructor | Description |
| --- | --- |
| [NumericLatchModeStateHandler()](#NumericLatchModeStateHandler--) |  |
## Methods
...
### NumericLatchModeStateHandler() {#NumericLatchModeStateHandler--}
```
public NumericLatchModeStateHandler()
```
