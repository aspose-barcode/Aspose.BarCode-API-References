...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EncodingState</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.pdf417.statehandler/encodingstate/</div></td>
  </tr>
  </tbody>
</table>
...
```
public final class EncodingState extends System.Enum
```
## Fields

| Field | Description |
| --- | --- |
| [ByteLatchMode](#ByteLatchMode) |  |
| [ByteShiftMode](#ByteShiftMode) |  |
| [ECILatchMode](#ECILatchMode) |  |
| [End](#End) |  |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MacroSeparator](#MacroSeparator) |  |
| [MacroStart](#MacroStart) |  |
| [MarcoTerminator](#MarcoTerminator) |  |
| [NumericLatchMode](#NumericLatchMode) |  |
| [ReaderInitialisation](#ReaderInitialisation) |  |
| [Start](#Start) |  |
| [TextLatchMode](#TextLatchMode) |  |
## Methods
...
### ByteLatchMode {#ByteLatchMode}
```
public static final int ByteLatchMode
```


### ByteShiftMode {#ByteShiftMode}
```
public static final int ByteShiftMode
```


### ECILatchMode {#ECILatchMode}
```
public static final int ECILatchMode
```
...
### MacroSeparator {#MacroSeparator}
```
public static final int MacroSeparator
```


### MacroStart {#MacroStart}
```
public static final int MacroStart
```


### MarcoTerminator {#MarcoTerminator}
```
public static final int MarcoTerminator
```


### NumericLatchMode {#NumericLatchMode}
```
public static final int NumericLatchMode
```


### ReaderInitialisation {#ReaderInitialisation}
```
public static final int ReaderInitialisation
```
...
### TextLatchMode {#TextLatchMode}
```
public static final int TextLatchMode
```
