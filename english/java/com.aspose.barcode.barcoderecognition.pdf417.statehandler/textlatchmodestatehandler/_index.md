...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">TextLatchModeStateHandler</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.pdf417.statehandler/textlatchmodestatehandler/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class TextLatchModeStateHandler implements IStateHandlerCallback
```
## Constructors

| Constructor | Description |
| --- | --- |
| [TextLatchModeStateHandler()](#TextLatchModeStateHandler--) |  |
## Methods
...
### TextLatchModeStateHandler() {#TextLatchModeStateHandler--}
```
public TextLatchModeStateHandler()
```
