...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">SwissPostParcelEncoder.SwissPostParcelType</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.generation.renderers.barcoderenderers.encoders/swisspostparcelencoder.swisspostparceltype/</div></td>
  </tr>
  </tbody>
</table>
...
```
public static final class SwissPostParcelEncoder.SwissPostParcelType extends System.Enum
```
## Fields

| Field | Description |
| --- | --- |
| [AdditionalService](#AdditionalService) | Format: 4 digits from predefined values, no checksum |
| [DomesticMail](#DomesticMail) | Format: 18 digits, no checksum, 98 at start |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InternationalMail](#InternationalMail) | Format: RXxxxxxxxxxCH. |
## Methods
...
```
public static final int AdditionalService
```


Format: 4 digits from predefined values, no checksum

### DomesticMail {#DomesticMail}
```
public static final int DomesticMail
```


Format: 18 digits, no checksum, 98 at start
...
### InternationalMail {#InternationalMail}
```
public static final int InternationalMail
```


Format: RXxxxxxxxxxCH. X - upper case letter, x - digit, last x is checksum
