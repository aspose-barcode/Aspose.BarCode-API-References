...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">CanvasQualityMode</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.drawing/canvasqualitymode/</div></td>
  </tr>
  </tbody>
</table>
...
```
public enum CanvasQualityMode extends Enum<CanvasQualityMode>
```
## Fields
...
### ANTI_ALIAS {#ANTI-ALIAS}
```
public static final CanvasQualityMode ANTI_ALIAS
```


### DEFAULT {#DEFAULT}
```
public static final CanvasQualityMode DEFAULT
```
...
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static CanvasQualityMode valueOf(String name)
```
...
### values() {#values--}
```
public static CanvasQualityMode[] values()
```
