...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">MergeEqualBarcodesPostFilter</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.postprocesscontroller.filters/mergeequalbarcodespostfilter/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class MergeEqualBarcodesPostFilter extends ExtPostFilter
```
## Constructors

| Constructor | Description |
| --- | --- |
| [MergeEqualBarcodesPostFilter(boolean isOnlyWithSameCodetext)](#MergeEqualBarcodesPostFilter-boolean-) |  |
## Methods
...
### MergeEqualBarcodesPostFilter(boolean isOnlyWithSameCodetext) {#MergeEqualBarcodesPostFilter-boolean-}
```
public MergeEqualBarcodesPostFilter(boolean isOnlyWithSameCodetext)
```
...
| --- | --- | --- |
| isOnlyWithSameCodetext | boolean |  |
