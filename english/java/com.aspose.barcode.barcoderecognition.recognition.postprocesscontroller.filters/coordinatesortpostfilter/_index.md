...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">CoordinateSortPostFilter</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.postprocesscontroller.filters/coordinatesortpostfilter/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class CoordinateSortPostFilter extends PostprocessFilter
```
## Constructors

| Constructor | Description |
| --- | --- |
| [CoordinateSortPostFilter()](#CoordinateSortPostFilter--) |  |
## Methods
...
### CoordinateSortPostFilter() {#CoordinateSortPostFilter--}
```
public CoordinateSortPostFilter()
```
