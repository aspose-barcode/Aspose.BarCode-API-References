...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">RemovePharmacodePostFilter</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.postprocesscontroller.filters/removepharmacodepostfilter/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class RemovePharmacodePostFilter extends PostprocessFilter
```
## Constructors

| Constructor | Description |
| --- | --- |
| [RemovePharmacodePostFilter()](#RemovePharmacodePostFilter--) |  |
## Methods
...
### RemovePharmacodePostFilter() {#RemovePharmacodePostFilter--}
```
public RemovePharmacodePostFilter()
```
