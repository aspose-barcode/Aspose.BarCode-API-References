...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">RemoveSupplementPostFilter</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.postprocesscontroller.filters/removesupplementpostfilter/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class RemoveSupplementPostFilter extends PostprocessFilter
```
## Constructors

| Constructor | Description |
| --- | --- |
| [RemoveSupplementPostFilter()](#RemoveSupplementPostFilter--) |  |
## Methods
...
### RemoveSupplementPostFilter() {#RemoveSupplementPostFilter--}
```
public RemoveSupplementPostFilter()
```
