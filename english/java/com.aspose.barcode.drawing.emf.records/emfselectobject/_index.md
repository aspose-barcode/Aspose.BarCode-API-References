...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">EmfSelectObject</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.drawing.emf.records/emfselectobject/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class EmfSelectObject extends EmfHandleRecord
```
## Constructors

| Constructor | Description |
| --- | --- |
| [EmfSelectObject(int aHandle)](#EmfSelectObject-int-) |  |
## Fields
...
### EmfSelectObject(int aHandle) {#EmfSelectObject-int-}
```
public EmfSelectObject(int aHandle)
```
