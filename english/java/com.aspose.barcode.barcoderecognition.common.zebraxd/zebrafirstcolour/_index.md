...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">ZebraFirstColour</div></td>
  <td><div dir="auto">Aspose.BarCode for Java API Reference</div></td>
  <td><div dir="auto">enum which defines starting color of zebra pattern to avoid misrecognitions</div></td>
  <td><div dir="auto">docs</div></td>
  <td><div dir="auto">22</div></td>
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.common.zebraxd/zebrafirstcolour/</div></td>
  </tr>
  </tbody>
</table>
...
```
public final class ZebraFirstColour extends System.Enum
```

enum which defines starting color of zebra pattern to avoid misrecognitions
## Fields
...
### ziAny {#ziAny}
```
public static final int ziAny
```


### ziBlack {#ziBlack}
```
public static final int ziBlack
```


### ziWhite {#ziWhite}
```
public static final int ziWhite
```
