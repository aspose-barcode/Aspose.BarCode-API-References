...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">AsciiModeStateHandler</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.datamatrix.statehandler/asciimodestatehandler/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class AsciiModeStateHandler implements IStateHandlerCallback
```
## Constructors

| Constructor | Description |
| --- | --- |
| [AsciiModeStateHandler()](#AsciiModeStateHandler--) |  |
## Fields
...
### AsciiModeStateHandler() {#AsciiModeStateHandler--}
```
public AsciiModeStateHandler()
```


### MacroState {#MacroState}
```
public MacroCharactersState MacroState
```
