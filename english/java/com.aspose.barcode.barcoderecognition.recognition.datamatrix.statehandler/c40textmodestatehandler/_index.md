...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">C40TextModeStateHandler</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.recognition.datamatrix.statehandler/c40textmodestatehandler/</div></td>
  </tr>
  </tbody>
</table>
...
```
public class C40TextModeStateHandler implements IStateHandlerCallback
```
## Constructors

| Constructor | Description |
| --- | --- |
| [C40TextModeStateHandler()](#C40TextModeStateHandler--) |  |
## Methods
...
### C40TextModeStateHandler() {#C40TextModeStateHandler--}
```
public C40TextModeStateHandler()
```
