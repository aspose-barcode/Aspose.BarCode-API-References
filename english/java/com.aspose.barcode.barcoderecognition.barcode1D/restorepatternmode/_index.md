...
<div >
  ...
  <tbody>
  <tr>
  <td><div dir="auto">Bar1DZebraRecWBase.RestorePatternMode</div></td>
  ...
  <td><div dir="auto">/java/com.aspose.barcode.barcoderecognition.barcode1d/bar1dzebrarecwbase.restorepatternmode/</div></td>
  </tr>
  </tbody>
</table>
...
```
public enum Bar1DZebraRecWBase.RestorePatternMode extends Enum<barcode1D.Bar1DZebraRecWBase.RestorePatternMode>
```
## Fields
...
### Both {#Both}
```
public static final barcode1D.Bar1DZebraRecWBase.RestorePatternMode Both
```


### Merge {#Merge}
```
public static final barcode1D.Bar1DZebraRecWBase.RestorePatternMode Merge
```


### Split {#Split}
```
public static final barcode1D.Bar1DZebraRecWBase.RestorePatternMode Split
```
...
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static barcode1D.Bar1DZebraRecWBase.RestorePatternMode valueOf(String name)
```
...
**Returns:**
[RestorePatternMode](../../com.aspose.barcode.barcoderecognition.barcode1d/restorepatternmode)
### values() {#values--}
```
public static barcode1D.Bar1DZebraRecWBase.RestorePatternMode[] values()
```
...
**Returns:**
com.aspose.barcode.barcoderecognition.barcode1D.Bar1DZebraRecWBase.RestorePatternMode[]
### wait() {#wait--}
```
