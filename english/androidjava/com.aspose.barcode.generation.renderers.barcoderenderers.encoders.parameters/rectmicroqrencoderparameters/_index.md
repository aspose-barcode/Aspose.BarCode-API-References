---
title: RectMicroQrEncoderParameters
second_title: Aspose.BarCode for Android via Java API Reference
description: 
type: docs
weight: 28
url: /androidjava/com.aspose.barcode.generation.renderers.barcoderenderers.encoders.parameters/rectmicroqrencoderparameters/
---
**Inheritance:**
java.lang.Object, com.aspose.barcode.generation.renderers.barcoderenderers.encoders.parameters.EncoderParameters
```
public class RectMicroQrEncoderParameters extends EncoderParameters
```
## Constructors

| Constructor | Description |
| --- | --- |
| [RectMicroQrEncoderParameters()](#RectMicroQrEncoderParameters--) |  |
## Methods
...
| [setVersion(RectMicroQRVersion value)](#setVersion-com.aspose.barcode.generation.RectMicroQRVersion-) |  |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
### RectMicroQrEncoderParameters() {#RectMicroQrEncoderParameters--}
```
public RectMicroQrEncoderParameters()
```
...
### getVersion() {#getVersion--}
```
public RectMicroQRVersion getVersion()
```
...
### setVersion(RectMicroQRVersion value) {#setVersion-com.aspose.barcode.generation.RectMicroQRVersion-}
```
public void setVersion(RectMicroQRVersion value)
```
