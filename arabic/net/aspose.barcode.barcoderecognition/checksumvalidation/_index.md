...
type: docs
weight: 140
url: /ar/net/aspose.barcode.barcoderecognition/checksumvalidation/
---
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Default | `0` | إذا كان المجموع الاختباري مطلوبًا من خلال المواصفات - فسيتم التحقق من صحته. |
| On | `1` | تحقق دائمًا من المجموع الاختباري إن أمكن. |
| Off | `2` | عدم التحقق من صحة المجموع الاختباري. |
