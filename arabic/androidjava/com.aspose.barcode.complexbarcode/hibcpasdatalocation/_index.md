...
description: أنواع مواقع بيانات HIBC PAS.
type: docs
weight: 19
url: /ar/androidjava/com.aspose.barcode.complexbarcode/hibcpasdatalocation/
---
**Inheritance:**
...
أنواع مواقع بيانات HIBC PAS.
## الحقول

| حقل | الوصف |
| --- | --- |
| [ASSET](#ASSET) | K - نوع بيانات الأصل |
| [BUSINESS_RECORD](#BUSINESS-RECORD) | E - سجل الأعمال |
| [DEVICES_AND_MATERIALS](#DEVICES-AND-MATERIALS) | H - الأجهزة والمواد |
| [DIRECT_PATIENT_IMAGE_ITEM](#DIRECT-PATIENT-IMAGE-ITEM) | D - عنصر صورة المريض المباشرة |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IDENTIFICATION_CARD](#IDENTIFICATION-CARD) | I - بطاقة التعريف |
| [LIBRARY_REFERENCE_MATERIAL](#LIBRARY-REFERENCE-MATERIAL) | G - مادة مرجعية للمكتبة |
| [MEDICAL_ADMINISTRATION_RECORD](#MEDICAL-ADMINISTRATION-RECORD) | F - سجل الإدارة الطبية |
| [PATIENT](#PATIENT) | A - مريض |
| [PATIENT_CARE_RECORD](#PATIENT-CARE-RECORD) | B - سجل رعاية المريض |
| [PRODUCT_CONTAINER](#PRODUCT-CONTAINER) | J - حاوية المنتج |
| [SPECIMEN_CONTAINER](#SPECIMEN-CONTAINER) | C - حاوية العينة |
| [SURGICAL_INSTRUMENT](#SURGICAL-INSTRUMENT) | L - أداة جراحية |
