...
description: أنواع باركود Mailmark رباعي الحالة.
type: docs
weight: 22
url: /ar/androidjava/com.aspose.barcode.complexbarcode/mailmark1dtype/
---
**Inheritance:**
...
أنواع باركود Mailmark رباعي الحالة.
## الحقول

| حقل | الوصف |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Type_C](#Type-C) | باركود Mailmark رباعي الحالة C |
| [Type_L](#Type-L) | باركود Mailmark رباعي الحالة L |
## Methods
...
باركود Mailmark رباعي الحالة C
...
باركود Mailmark رباعي الحالة L
