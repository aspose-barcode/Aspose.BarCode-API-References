...
description: فئة لتشفير وفك تشفير النص المضمن في رمز Royal Mailmark رباعي الحالة.
type: docs
weight: 24
url: /ar/androidjava/com.aspose.barcode.complexbarcode/mailmarkcodetext/
---
**Inheritance:**
java.lang.Object
...
فئة لتشفير وفك تشفير النص المضمن في رمز Royal Mailmark رباعي الحالة.
## Constructors
