...
description: واجهة عامة لتشفير حقل معلومات العميل (Customer Information Field) المستخدمة في ترميز AustraliaPost.
type: docs
weight: 50
url: /ar/androidjava/com.aspose.barcode.barcoderecognition/australiapostcustomerinformationdecoder/
---```
