...
description: معلمات فك ترميز BarCode الرئيسية.
type: docs
weight: 20
url: /ar/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | تمكين التحقق من مجموع الاختبار أثناء التعرف على الباركود أحادي الأبعاد والبريدية. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | تمكين التحقق من مجموع الاختبار أثناء التعرف على الباركود أحادي الأبعاد والبريدية. |
...
| Parameter | Type | الوصف |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | تمكين التحقق من مجموع الاختبار أثناء التعرف على الباركود أحادي الأبعاد والبريدية. |
...
| Parameter | Type | الوصف |
| --- | --- | --- |
| القيمة | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
