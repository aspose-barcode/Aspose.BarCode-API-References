...
description: الفئة الأساسية للمعلمات الموسعة لتخزين الباركود المعترف به
type: docs
weight: 24
url: /ar/androidjava/com.aspose.barcode.barcoderecognition/baseextendedparameters/
---
**Inheritance:**
java.lang.Object
```
...
الفئة الأساسية للمعلمات الموسعة لتخزين الباركود المعترف به
## Methods
