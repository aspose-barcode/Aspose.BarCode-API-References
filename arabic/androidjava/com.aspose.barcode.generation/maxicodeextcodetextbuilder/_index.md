...
description: مولد نص الترميز الموسع لباركودات MaxiCode لوضع ExtendedCodetext في MaxiCodeEncodeMode. استخدم خاصية TwoDDisplayText في BarcodeGenerator لتعيين النص الظاهر وإزالة الأحرف الإدارية.
type: docs
weight: 55
url: /ar/androidjava/com.aspose.barcode.generation/maxicodeextcodetextbuilder/
---
**Inheritance:**
...
مولد النص الموسع لباركودات MaxiCode لوضعية ExtendedCodetext في MaxiCodeEncodeMode. استخدم خاصية TwoDDisplayText في BarcodeGenerator لتعيين النص المرئي وإزالة الأحرف الإدارية. يوضح هذا المثال كيفية استخدام MaxiCodeExtCodetextBuilder في الوضعية الموسعة.
