...
type: docs
weight: 56
url: /ar/androidjava/com.aspose.barcode.generation/maxicodemode/
---
**Inheritance:**
...
وضع الترميز لباركودات MaxiCode. يوضح هذا المثال كيفية إنشاء باركودات MaxiCode باستخدام ComplexBarcodeGenerator
...
| [MODE_2](#MODE-2) | الوضع 2 يشفّر المعلومات البريدية في الرسالة الأولى والبيانات في الرسالة الثانية. |
| [MODE_3](#MODE-3) | الوضع 3 يشفّر المعلومات البريدية في الرسالة الأولى والبيانات في الرسالة الثانية. |
| [MODE_4](#MODE-4) | الوضع 4 يشفّر البيانات في الرسالة الأولى والثانية، مع تصحيح ECC قصير. |
| [MODE_5](#MODE-5) | الوضع 5 يشفّر البيانات في الرسالة الأولى والثانية، مع تصحيح ECC طويل. |
| [MODE_6](#MODE-6) | الوضع 6 يشفّر البيانات في الرسالة الأولى والثانية، مع تصحيح ECC قصير. |
## Methods
...
الوضع 2 يشفّر المعلومات البريدية في الرسالة الأولى والبيانات في الرسالة الثانية. يحتوي على رمز بريدي مكوّن من 9 أرقام (يُستخدم فقط في الولايات المتحدة).
...
الوضع 3 يشفّر المعلومات البريدية في الرسالة الأولى والبيانات في الرسالة الثانية. يحتوي على رمز بريدي مكوّن من 6 أحرف أبجدية رقمية، يُستخدم عالميًا.
...
الوضع 4 يشفّر البيانات في الرسالة الأولى والثانية، مع تصحيح ECC قصير.
...
الوضع 5 يشفّر البيانات في الرسالة الأولى والثانية، مع تصحيح ECC طويل.
...
الوضع 6 يشفّر البيانات في الرسالة الأولى والثانية، مع تصحيح ECC قصير. يُستخدم لتشفير الجهاز.
