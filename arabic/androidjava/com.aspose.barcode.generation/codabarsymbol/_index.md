...
description: يحدد رمز البداية أو النهاية لمواصفة الباركود Codabar.
type: docs
weight: 23
url: /ar/androidjava/com.aspose.barcode.generation/codabarsymbol/
---
**Inheritance:**
...
يحدد رمز البداية أو النهاية لمواصفة الباركود Codabar.
## الحقول

| حقل | الوصف |
| --- | --- |
| [A](#A) | يحدد الحرف A كرمز بداية أو نهاية لمواصفات الباركود Codabar. |
| [B](#B) | يحدد الحرف B كرمز بداية أو نهاية لمواصفات الباركود Codabar. |
| [C](#C) | يحدد الحرف C كرمز بداية أو نهاية لمواصفات الباركود Codabar. |
| [D](#D) | يحدد الحرف D كرمز بداية أو نهاية لمواصفات الباركود Codabar. |
...
يحدد الحرف A كرمز بداية أو نهاية لمواصفات الباركود Codabar.
...
يحدد الحرف B كرمز بداية أو نهاية لمواصفات الباركود Codabar.
...
يحدد الحرف C كرمز بداية أو نهاية لمواصفات الباركود Codabar.
...
يحدد الحرف D كرمز بداية أو نهاية لمواصفات الباركود Codabar.
