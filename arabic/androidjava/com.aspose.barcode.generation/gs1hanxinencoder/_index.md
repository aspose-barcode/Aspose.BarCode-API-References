...
description: يحتوي على وظائف لتشفير GS1HanXin
type: docs
weight: 47
url: /ar/androidjava/com.aspose.barcode.generation/gs1hanxinencoder/
---
**Inheritance:**
...
يحتوي على وظائف لتشفير GS1HanXin
## Constructors

| Constructor | الوصف |
| --- | --- |
| [GS1HanXinEncoder(HanXinEncoderParameters parameters)](#GS1HanXinEncoder-com.aspose.barcode.generation.renderers.barcoderenderers.encoders.parameters.HanXinEncoderParameters-) | يجب أن تحتوي بيانات الإدخال على أقواس () فقط كفاصل للأوضاع، مثال: (01)12345678901231(21)ASPOSE(30)9876 وفقًا لمواصفات GS1، يجب أن تتبع جميع سلاسل بيانات GS1 ذات الطول المحدد مسبقًا جميع سلاسل بيانات GS1 ذات الطول غير المحدد مسبقًا. |
## Methods
...
يجب أن تحتوي بيانات الإدخال على أقواس () فقط كفاصل للأوضاع، مثال: (01)12345678901231(21)ASPOSE(30)9876 وفقًا لمواصفات GS1، يجب أن تتبع جميع سلاسل بيانات GS1 ذات الطول المحدد مسبقًا جميع سلاسل بيانات GS1 ذات الطول غير المحدد مسبقًا.

**Parameters:**
| Parameter | Type | الوصف |
| --- | --- | --- |
| معلمات | com.aspose.barcode.generation.renderers.barcoderenderers.encoders.parameters.HanXinEncoderParameters |  |
