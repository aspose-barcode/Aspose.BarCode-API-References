...
type: docs
weight: 35
url: /ar/androidjava/com.aspose.barcode.generation/dotcodeextcodetextbuilder/
---
**Inheritance:**
...
مولد النص الموسع لباركودات DotCode ثنائية الأبعاد لوضع ExtendedCodetext في DotCodeEncodeMode.
...
| [addFNC1FormatIdentifier()](#addFNC1FormatIdentifier--) | يضيف معرف تنسيق FNC1 إلى عناصر النص الموسع. |
| [addFNC3ReaderInitialization()](#addFNC3ReaderInitialization--) | يضيف تهيئة القارئ FNC3 إلى عناصر النص الموسع. |
| [addFNC3SymbolSeparator()](#addFNC3SymbolSeparator--) | يضيف فاصل الرمز FNC3 إلى عناصر النص الموسع. |
| [addPlainCodetext(String codetext)](#addPlainCodetext-java.lang.String-) | Adds plain codetext to the extended codetext items |
| [addStructuredAppendMode(int barcodeId, int barcodesCount)](#addStructuredAppendMode-int-int-) | يضيف وضع الإلحاق المُنظم إلى عناصر النص الموسع. |
...
يضيف معرف تنسيق FNC1 إلى عناصر النص الموسع.
...
يضيف تهيئة القارئ FNC3 إلى عناصر النص الموسع.
...
يضيف فاصل الرمز FNC3 إلى عناصر النص الموسع.
...
يضيف وضع الإلحاق المُنظم إلى عناصر النص الموسع.

**Parameters:**
| Parameter | Type | الوصف |
| --- | --- | --- |
| barcodeId | int | معرّف الباركود |
| barcodesCount | int | عدد الباركودات |
