...
description: الداخلية تحتوي على واجهة المستخدم التي تم عرضها أثناء عملية التعرف
type: docs
weight: 26
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessingfragment/
---
**Inheritance:**
...
الداخلية تحتوي على واجهة المستخدم التي تم عرضها أثناء عملية التعرف
## Constructors
