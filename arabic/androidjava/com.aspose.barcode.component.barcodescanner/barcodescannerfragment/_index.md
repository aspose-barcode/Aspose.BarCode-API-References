...
description: Fragment للتعرف على الباركود.
type: docs
weight: 14
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerfragment/
---
**Inheritance:**
...
Fragment للتعرف على الباركود. يمكن وضع هذا الـ Fragment داخل Activity مخصص أو داخل FragmentContainerView ويُستخدم للمسح الضوئي والتعرف على الباركود.
...
// تهيئة BarcodeScannerFragment // يمكنه الاستخدام من ملف الموارد أو برمجيًا/ BarcodeScannerFragment barcodeScannerFragment = new BarcodeScannerFragment();

// إرفاق BarcodeScannerFragment إلى تخطيط مخصص // سيأخذ حجم الحاوية الأصلية requireActivity().getSupportFragmentManager().beginTransaction().add(R.id.barcodeScannerFragmentContainerView, barcodeReaderFragment).commit(); // يجب تهيئة تفضيلات BarcodeRecognitionSettings بعد إرفاق BarcodeScannerFragment إلى النشاط الأصل. // سيتم استدعاء BarcodeScannerFragmentPreferencesHandler بعد طريقة BarcodeScannerFragment.onCreate() طريقة barcodeScannerFragment.setBarcodePreferencesHandler(new BarcodeScannerFragmentPreferencesHandler() \{
## Constructors

| Constructor | الوصف |
| --- | --- |
| [BarcodeScannerFragment()](#BarcodeScannerFragment--) | المُنشئ الافتراضي |
## Methods
...
| [getBarcodeRecognitionSettings()](#getBarcodeRecognitionSettings--) | يضبط BarcodeScannerFragmentPreferencesHandler الذي يمكن استدعاؤه بعد طريقة BarcodeScannerFragment.onViewCreated() |
...
| [isResumed()](#isResumed--) |  |
| [isShowPreferencesButton()](#isShowPreferencesButton--) | TODO داخلي؟ هل زر إظهار التفضيلات، ل BarcodeScanner دائمًا false |
...
| [setPreferencesFragment(BarcodeScannerPreferencesFragment preferencesFragment)](#setPreferencesFragment-com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment-) | يضبط تنفيذًا مخصصًا لـ PreferencesFragment. |
...
| [setShowPreferencesButton(boolean showPreferencesButton)](#setShowPreferencesButton-boolean-) | يضبط زر إظهار التفضيلات، ل BarcodeScanner دائمًا false |
...
يضبط BarcodeScannerFragmentPreferencesHandler الذي يمكن استدعاؤه بعد طريقة BarcodeScannerFragment.onViewCreated()
...
TODO داخلي؟ هل زر إظهار التفضيلات، ل BarcodeScanner دائمًا false
...
يضبط تنفيذًا مخصصًا لـ PreferencesFragment.

**Parameters:**
| Parameter | Type | الوصف |
| --- | --- | --- |
| preferencesFragment | com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferencesFragment | يمكن استدعاؤه قبل بدء عملية التعرف في BarcodeScannerFragment. |
...
يضبط زر إظهار التفضيلات، ل BarcodeScanner دائمًا false
