...
description: يمكن استخدام PreferencesFragment لتخصيص عملية التعرف على الباركود باستخدام واجهة مستخدم مخصصة.
type: docs
weight: 17
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
يمكن استخدام PreferencesFragment لتخصيص عملية التعرف على الباركود باستخدام واجهة مستخدم مخصصة. يمكن تنفيذ PreferencesFragment كفئة مخصصة ويمكن إرفاقها بـ BarcodeScannerFragment باستخدام طريقة BarcodeRecognitionSettings.setPreferencesFragment().
## Constructors
