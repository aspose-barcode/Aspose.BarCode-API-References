...
description: يمثل خلفية الصورة التي سيتم عرضها أثناء عملية التعرف
type: docs
weight: 23
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/recognitionprocessfragmentbitmapbackground/
---
**Inheritance:**
...
يمثل خلفية الصورة التي سيتم عرضها أثناء عملية التعرف
## Constructors
...
| --- | --- | --- |
| backgroundBitmap | android.graphics.Bitmap | خلفية الصورة التي سيتم عرضها أثناء عملية التعرف |
