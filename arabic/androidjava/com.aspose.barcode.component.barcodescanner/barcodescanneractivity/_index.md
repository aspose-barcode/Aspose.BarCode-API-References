...
description: النشاط الذي يحتوي على BarcodeScannerFragment هو فئة داخلية ولا يجب على العميل استدعاء هذه الفئة ولكن يجب على العميل تسجيل BarcodeScannerActivity في AndroidManifest.xml
type: docs
weight: 13
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
النشاط الذي يحتوي على BarcodeScannerFragment هو فئة داخلية ولا يجب على العميل استدعاؤها، لكن يجب على العميل تسجيل BarcodeScannerActivity في AndroidManifest.xml
## Constructors
