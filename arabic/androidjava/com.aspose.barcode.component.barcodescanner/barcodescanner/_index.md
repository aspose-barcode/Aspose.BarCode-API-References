...
description: يحتوي BarcodeScanner على الوظائف المتعلقة بالتعرف على الباركود من كاميرا جهاز Android.
type: docs
weight: 12
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanner/
---
**Inheritance:**
java.lang.Object
```
...
يحتوي BarcodeScanner على الوظائف المتعلقة بالتعرف على الباركود من كاميرا جهاز Android.
...
| Constructor | الوصف |
| --- | --- |
| [BarcodeScanner(ComponentActivity parentActivity)](#BarcodeScanner-androidx.activity.ComponentActivity-) | يقوم بإنشاء نسخة جديدة من فئة BarcodeScanner. |
## Methods
...
| [hashCode()](#hashCode--) |  |
| [launchBarcodeScanner(BarcodeRecognitionResultsHandlerParcelable barcodeRecognitionResultsHandler)](#launchBarcodeScanner-com.aspose.barcode.component.barcodescanner.BarcodeRecognitionResultsHandlerParcelable-) | تشغيل عرض الكاميرا وإدارة عملية التعرف |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setOnBarcodeScannerCompletedCallback(OnBarcodeScannerCompletedCallback onBarcodeScannerCompletedCallback)](#setOnBarcodeScannerCompletedCallback-com.aspose.barcode.component.barcodescanner.OnBarcodeScannerCompletedCallback-) | مستمع انتهاء التعرف |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يقوم بإنشاء نسخة جديدة من فئة BarcodeScanner.

**Parameters:**
| Parameter | Type | الوصف |
| --- | --- | --- |
| parentActivity | androidx.activity.ComponentActivity | النشاط الذي تم استدعاء BarcodeScanner منه. يجب تهيئته قبل إنشاء عرض النشاط الأب |
...
**Returns:**
com.aspose.barcode.component.barcodescanner.BarcodeScannerPreferences - تفضيلات ماسح الباركود
### hashCode() {#hashCode--}
```
...
تشغيل عرض الكاميرا وإدارة عملية التعرف

**Parameters:**
| Parameter | Type | الوصف |
| --- | --- | --- |
| barcodeRecognitionResultsHandler | com.aspose.barcode.component.barcodescanner.BarcodeRecognitionResultsHandlerParcelable | مثيل مخصص من الفئة المجردة OnScannerRecognitionFinishedListener التي تعالج نتيجة التعرف |
...
| Parameter | Type | الوصف |
| --- | --- | --- |
| onBarcodeScannerCompletedCallback | com.aspose.barcode.component.barcodescanner.OnBarcodeScannerCompletedCallback | مستمع |
