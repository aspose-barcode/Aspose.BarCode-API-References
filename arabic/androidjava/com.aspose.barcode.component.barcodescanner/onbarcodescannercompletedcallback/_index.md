...
description: تعريف الواجهة لاستدعاء رد الاتصال عند الانتهاء من عملية المسح.
type: docs
weight: 30
url: /ar/androidjava/com.aspose.barcode.component.barcodescanner/onbarcodescannercompletedcallback/
---```
