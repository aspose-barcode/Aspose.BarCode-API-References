...
description: Les principaux paramètres de décodage BarCode.
type: docs
weight: 20
url: /fr/androidjava/com.aspose.barcode.barcoderecognition/barcodesettings/
---
**Inheritance:**
java.lang.Object
```
...
| [getChecksumValidation()](#getChecksumValidation--) | Active la validation du checksum pendant la reconnaissance des codes-barres 1D et postaux. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setChecksumValidation(ChecksumValidation value)](#setChecksumValidation-com.aspose.barcode.barcoderecognition.ChecksumValidation-) | Active la validation du checksum pendant la reconnaissance des codes-barres 1D et postaux. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [ChecksumValidation](../../com.aspose.barcode.barcoderecognition/checksumvalidation) | Active la validation du checksum pendant la reconnaissance des codes-barres 1D et postaux. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Strip FNC1, FNC2, FNC3 characters from codetext. Default value is false. |
