...
description: Classe pour encoder et décoder le texte intégré dans le code MaxiCode pour le mode 3.
type: docs
weight: 27
url: /fr/androidjava/com.aspose.barcode.complexbarcode/maxicodecodetextmode3/
---
**Inheritance:**
...
Classe pour l'encodage et le décodage du texte intégré dans le code MaxiCode pour les modes 3. Cet exemple montre comment encoder et décoder le codetext MaxiCode pour le mode 3.
