...
description: Activité qui contient BarcodeScannerFragment Il s'agit d'une classe interne et le client ne doit pas appeler cette classe mais le client doit enregistrer BarcodeScannerActivity dans AndroidManifest.xml
type: docs
weight: 13
url: /fr/androidjava/com.aspose.barcode.component.barcodescanner/barcodescanneractivity/
---
**Inheritance:**
...
Activité qui contient BarcodeScannerFragment. C'est une classe interne et le client ne doit pas appeler cette classe, mais le client doit enregistrer BarcodeScannerActivity dans AndroidManifest.xml
## Constructeurs
