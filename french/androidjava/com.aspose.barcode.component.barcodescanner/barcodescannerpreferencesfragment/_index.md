...
description: PreferencesFragment peut être utilisé pour personnaliser le processus de reconnaissance de codes-barres à l'aide d'une interface graphique personnalisée.
type: docs
weight: 17
url: /fr/androidjava/com.aspose.barcode.component.barcodescanner/barcodescannerpreferencesfragment/
---
**Inheritance:**
...
PreferencesFragment peut être utilisé pour personnaliser le processus de reconnaissance de code-barres en utilisant une interface graphique personnalisée. PreferencesFragment peut être implémenté en tant que classe personnalisée et peut être attaché à BarcodeScannerFragment en utilisant la méthode BarcodeRecognitionSettings.setPreferencesFragment().
## Constructeurs
