...
description: Définition d'interface pour un rappel qui sera invoqué lorsqu'un processus de numérisation est terminé.
type: docs
weight: 30
url: /fr/androidjava/com.aspose.barcode.component.barcodescanner/onbarcodescannercompletedcallback/
---```
